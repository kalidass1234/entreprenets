...
<div id="page-content" class="no-sidebar-layout main"><div class="container"><div id="the-content" >
 ...
 <div class="span5">
<div class="row eternity-form abs-form">

<form id="login" method="post" action="login_check.php" onSubmit="return formSubmit();" class="sky-form">
              ...
              <fieldset>
                ...
                <section>
                  <label class="input"> <i class="icon-append icon-user"></i>
                    <input type="text" placeholder="User Name" id="username" autofocus required name="username">
...
<!--<ul id="cbp-bislideshow" class="cbp-bislideshow">
			<li><img src="images/img6.jpg" alt="image06"/></li>
				...
				<!--<ul id="cbp-bislideshow" class="cbp-bislideshow">
					<li style="background-image: url(http://tympanus.net/Blueprints/BackgroundSlideshow/images/1.jpg); opacity: 0;"><img src="images/1.jpg" alt="image01"></li>
					<li style="background-image: url(http://tympanus.net/Blueprints/BackgroundSlideshow/images/2.jpg); opacity: 0;"><img src="images/2.jpg" alt="image02"></li>
					<li style="background-image: url(http://tympanus.net/Blueprints/BackgroundSlideshow/images/3.jpg); opacity: 0;"><img src="images/3.jpg" alt="image03"></li>
					<li style="background-image: url(http://tympanus.net/Blueprints/BackgroundSlideshow/images/4.jpg); opacity: 0;"><img src="images/4.jpg" alt="image04"></li>
					<li style="background-image: url(http://tympanus.net/Blueprints/BackgroundSlideshow/images/5.jpg); opacity: 0;"><img src="images/5.jpg" alt="image05"></li>
					<li style="background-image: url(http://tympanus.net/Blueprints/BackgroundSlideshow/images/6.jpg); opacity: 1;"><img src="images/6.jpg" alt="image06"></li>
				</ul>-->
