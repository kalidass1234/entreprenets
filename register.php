...
function checktcode()  
{
 if(document.contactform.trans_pin.value!='')
 {
   var data = document.getElementById("trans_pin");
	...
	{  
		...
		{
			document.getElementById("showtc1").innerHTML='Please enter a 4-digit TAC';
			document.contactform.trans_pin.focus();
			return false;	
		}
	}  
	else  
	{  
		document.getElementById("showtc1").innerHTML='Please fill only Integer Value';
		document.contactform.trans_pin.focus();
		return false;
	}
...
<form action="confirm.php" name="contactform" id="contactform" class="sky-form" required method="post" onSubmit="return formSubmit_reg();">
    ...
    <div id="ajax_username" style="font-size:16px; color:red; font-weight:bold;"></div> 
                ...
                <section>
                  ...
                  <label class="select"  >
                    ...
                    <option value="0" selected="" disabled="" >Account Type</option>
                        ...
                        <option value="Offline Business" >Offline Business</option>
                ...
                <section> 
                  <label class="input"> <i class="icon-append icon-lock"></i>
                    <input type="password" placeholder="Transaction Authorization code" name="trans_pin" id="trans_pin" onblur="checktcode();" required>
                    <div id="showtc1" style="font-size:16px; color:red; font-weight:bold; text-align:center;text-transform:capitalize;"></div>
                    <b class="tooltip tooltip-bottom-right">Only latin characters and numbers</b> </label>
                </section>
              </fieldset>
              <fieldset>
