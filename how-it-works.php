...
<div  class="ui--space clearfix" data-responsive="{&quot;css&quot;:{&quot;height&quot;:{&quot;phone&quot;:null,&quot;tablet&quot;:null,&quot;widescreen&quot;:null}}}"></div><div  id="section-gsy1k" class="fullwidth-container ui--section clearfix inner-shadow-3 section-gsy1k color--dark" style="margin-top: 12px;"><div class="container"><div class="ui-row row">
<h3 class="wht-txt">4 Steps to BMC Success</h3>
 <div   class="ui-column span6"><div  class="ui--tagline-box-wrapper ui--animation clearfix"><div  id="tagline-1" class="ui--tagline-box ui-row clearfix ui--tagline-box-custom-color radius-3px"><div class="ui-row row">
 <div   class="ui-column span3"><div class="hidden-phone "></div></div> 

 <div   class="ui-column span9"><div  class="ui--animation-in make--fx--appear ui--pass clearfix" data-fx="fx--appear" data-delay="400" data-start-delay="0">
<em style="position: absolute;padding: 10px 12px;color: #fff;background: #060;font-size: 28px; top: -18px;border-radius: 54px;font-weight: bold;right: -10px;">1</em>
 <h3 class="ui--animation" style="text-align: right; color: #333333 !important; margin-bottom: 0px; "><strong>Choose a </strong> Subscription Plan </h3><div class="auto-format ui--animation"><p class="text-right" style="color: #333;">Nullam id sodales lacus. Nam cursus urna nec imperdiet suscipit. Duis nec odio nibh. Mauris ultricies, velit sit amet semper aliquam.</p>
</div><div class="text-right ui--animation"><a class="btn btn-normal btn-icon-right with-icon button-hover btn-primary" href="#" style="margin-bottom: 0px;">Read More<span class="button-icon"><i class="ui--icon ui--icon btn-icon icon-normal fontawesome-caret-right"></i></span></a> </div><div class="ui--image-wrap clearfix hidden-phone "><img  id="ui--image-4" class="ui--image ui--animation" src="images/icon1.png" alt="" title="" data-at2x="" width="220" height="220" style="position: absolute; bottom: -15px; left: -50px; max-width: 0px;"/></div></div></div> 
 ...
 <div   class="ui-column span6"><div  class="ui--tagline-box-wrapper ui--animation clearfix"><div  id="tagline-2" class="ui--tagline-box ui-row clearfix ui--tagline-box-custom-color radius-3px"><div class="ui-row row">
 <div   class="ui-column span9"><div  class="ui--animation-in make--fx--appear ui--pass clearfix" data-fx="fx--appear" data-delay="400" data-start-delay="400">
 <em style="position: absolute;padding: 10px 12px;color: #fff;background: #060;font-size: 28px; top: -18px;border-radius: 54px;font-weight: bold;right: -10px;">2</em>
 <h3 class="ui--animation " style="color: #333333 !important; margin-bottom: 0px; ">Select a<strong> Business Category</strong> </h3><div class="auto-format ui--animation"><p class="text-left" style="color: #333;">Aenean a molestie magna, ac tincidunt elit. Duis turpis libero, facilisis venenatis elementum sed. Nullam felis ante, faucibus at turpis non.</p>
</div><a class="btn btn-normal btn-icon-right with-icon button-hover btn-yellow ui--animation" href="#" style="margin-bottom: 0px;">Read More<span class="button-icon"><i class="ui--icon ui--icon btn-icon icon-normal fontawesome-caret-right"></i></span></a> <div class="ui--image-wrap clearfix hidden-phone "><img  id="ui--image-5" class="ui--image ui--animation" src="images/icon2.png" alt="" title="" data-at2x="" width="200" height="200" style="position: absolute; bottom: -0px; right: -20px; max-width: 0px;"/></div></div></div> 
...
<div class="ui-row row">
 <div   class="ui-column span6"><div  class="ui--tagline-box-wrapper ui--animation clearfix"><div  id="tagline-3" class="ui--tagline-box ui-row clearfix ui--tagline-box-custom-color radius-3px"><div class="ui-row row">
 <div   class="ui-column span3"><div class="hidden-phone "></div></div> 

 <div   class="ui-column span9"><div class="ui--animation-in make--fx--appear ui--pass clearfix" data-fx="fx--appear" data-delay="400" data-start-delay="0">
 <em style="position: absolute;padding: 10px 12px;color: #fff;background: #060;font-size: 28px; top: -18px;border-radius: 54px;font-weight: bold;right: -10px;">4</em>
 
 <h3 class="ui--animation " style="text-align: right; color: #333333 !important; margin-bottom: 0px; "><strong>Launch Your Online Business</strong> </h3><div class="auto-format ui--animation"><p class="text-right" style="color: #333;">Nullam id sodales lacus. Nam cursus urna nec imperdiet suscipit. Duis nec odio nibh. Mauris ultricies, velit sit amet semper aliquam.</p>
</div><div class="text-right ui--animation"><a class="btn btn-normal btn-icon-right with-icon button-hover btn-primary" href="#" style="margin-bottom: 0px;">Read More<span class="button-icon"><i class="ui--icon ui--icon btn-icon icon-normal fontawesome-caret-right"></i></span></a> </div><div class="ui--image-wrap clearfix hidden-phone "><img  id="ui--image-6" class="ui--image ui--animation" src="images/icon3.png" alt="" title="" data-at2x="" width="200" height="200" style="position: absolute; bottom: 0; left: -40px; max-width: 0px;"/></div></div></div> 
 ...
 <div   class="ui-column span6"><div  class="ui--tagline-box-wrapper ui--animation clearfix"><div  id="tagline-4" class="ui--tagline-box ui-row clearfix ui--tagline-box-custom-color radius-3px"><div class="ui-row row">
 <div   class="ui-column span9"><div  class="ui--animation-in make--fx--appear ui--pass clearfix" data-fx="fx--appear" data-delay="400" data-start-delay="400">
 <em style="position: absolute;padding: 10px 12px;color: #fff;background: #060;font-size: 28px; top: -18px;border-radius: 54px;font-weight: bold;right: -10px;">3</em>
 
 <h3 class="ui--animation " style="color: #ffffff !important; margin-bottom: 0px; ">Complete your<strong> 24 BMCS</strong> </h3><div class="auto-format ui--animation"><p class="text-left" style="color: #ffffff;">Aenean a molestie magna, ac tincidunt elit. Duis turpis libero, facilisis venenatis elementum sed. Nullam felis ante, faucibus at turpis non.</p>
</div><a class="btn btn-normal btn-icon-right with-icon button-hover btn-yellow ui--animation" href="#" style="margin-bottom: 0px;">Read More<span class="button-icon"><i class="ui--icon ui--icon btn-icon icon-normal fontawesome-caret-right"></i></span></a> <div class="ui--image-wrap clearfix hidden-phone "><img  id="ui--image-7" class="ui--image ui--animation" src="images/icon4.png" alt="" title="" data-at2x="" width="220" height="220" style="position: absolute; bottom: -0px; right: -20px; max-width: 0px;"/></div></div></div> 
...
</div></div><!-- /.fullwidth-container --><div class="ui--space clearfix" data-responsive="{&quot;css&quot;:{&quot;height&quot;:{&quot;phone&quot;:null,&quot;tablet&quot;:null,&quot;widescreen&quot;:null}}}"></div>

<div class="ui--title  ui--title-bordered text-left"><div class="ui--title-holder"><h3 class="ui--title-text">Getting Your <strong>Referrers</strong> </h3><div class="ui--title-borders ui--title-border-left"></div><div class="ui--title-borders ui--title-border-right"></div></div></div>

<?php
echo stripslashes($getInfoByTableNameAndIDs['third_desc']);
?>
 
<div  class="ui--space clearfix" data-responsive="{&quot;css&quot;:{&quot;height&quot;:{&quot;phone&quot;:null,&quot;tablet&quot;:null,&quot;widescreen&quot;:null}}}"></div><div class="ui--title  ui--title-bordered text-left"><div class="ui--title-holder"><h3 class="ui--title-text">What our <strong>cilents say?</strong> <a class="btn btn-small btn-icon-left btn-secondary " href="#" style="margin-left: 10px;  margin-right: 0px;  margin-bottom: 0px;">all testimonails</a> </h3><div class="ui--title-borders ui--title-border-left"></div><div class="ui--title-borders ui--title-border-right"></div></div></div><div  class="-in make--fx--fadein-ttb ui--pass clearfix" data-fx="fx--fadein-ttb" data-delay="400" data-start-delay="400">
