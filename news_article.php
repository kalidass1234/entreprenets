      ...
      <div class="vw-post-loop vw-post-loop-slider vw-post-loop-slider-large">
        <ul class="vw-post-slides">
			...
			foreach($getInfoByTableName as $records)
			{
				...
				$date =date('d', $records['added_date']); 
                $month =date('F', $records['added_date']);
				$year = date('Y', $records['added_date']);

			?>
          <li>
            <div class="vw-post-box vw-post-style-slide vw-post-style-slide-large vw-post-format-gallery"><a class="vw-post-box-thumbnail" href="#" rel="bookmark"> <img width="1263" height="560" src="admin/news_image/<?=$records['image']?>" class="attachment-vw_full_width_thumbnail wp-post-image" alt="Photo copyright text here"/> </a>
              <div class="vw-post-box-inner container">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="vw-post-categories">
                    <a class=" vw-category-link vw-cat-id-3" href="#" title="View all posts in Cuisine" rel="category"><?=$records['cat_id']?></a>
<!--                    <a class=" vw-category-link vw-cat-id-3 vw-category-link vw-cat-id-9" href="#" title="View all posts in Reviews" rel="category">Reviews</a>
                    <a class=" vw-category-link vw-cat-id-3 vw-category-link vw-cat-id-9 vw-category-link vw-cat-id-10" href="#" title="View all posts in Teaser" rel="category">Teaser</a>-->
                    </div>
                    
                    <h3 class="vw-post-box-title"><a href="#" title="Permalink to Cum sociis natoque penatibus et magnis dis parturient" rel="bookmark"><?=$records['news_title']?></a></h3>
                    <div class="vw-post-meta"> <a class="author-name author" href="#" title="View all posts by Johny Doevrak" rel="author"><?=$records['member_name']?></a> <span class="vw-post-meta-separator">&mdash;</span> <a href="#" class="vw-post-date updated" title="Permalink to Cum sociis natoque penatibus et magnis dis parturient" rel="bookmark">
					<?=$month." ".$date.",". $year?></a></div>
                  </div>
                </div>
              </div>
            </div>
...
<div class="ui--title ui--animation ui--title-bordered text-left"><div class="ui--title-holder"><h3 class="ui--title-text"><strong>LATEST POSTS</strong></h3> 
...
$getInfoByTableName = getInfoByTableNameNL("manage_news", $limit);
foreach($getInfoByTableName as $records)
{
...
<h3 class="vw-post-box-title"> <a href="#" title="Permalink to Integer accumsan ut imperdiet vestibulum malesuada" rel="bookmark"><?=$records['news_title'];?></a></h3>
...
<?php 
        ...
        $query = "SELECT * FROM manage_news WHERE news_status='1'";
...
<ul class="vw-widget-category-list">
			...
			{
			?>
<li> <a class="vw-widget-category-title vw-header-font" href="category.php?cat_id=<?=$records['id'];?>" title="View posts in Architecture" rel="bookmark"> <?=$records['title'];?><div class="vw-widget-category-post-count">07</div> </a><div class="vw-widget-category-description"><?=$records['cat_desc'];?></div></li>
...
<div class="vwspc-section vwspc-section-full-page-link" id="vwspc-section-3" style="position: relative; z-index: 0; background-image: none; background-position: initial initial; background-repeat: initial initial;"><div class="vw-full-page-link-header"><h3 class="vw-full-page-link-title"> <a href="#">Full Page Link Section</a></h3><p class="vw-full-page-link-subtitle"> <a href="#">Aenean semper, tellus ac viverra pretium, est mi auctor massa</a></p> <a class="vw-button" href="#" rel="bookmark">Browse More</a><img class="vw-full-page-link-background hidden" src="images/big-img.jpg" alt="Full Page Link Section"></div><div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 350px; width:100% ; z-index: -999998; position: absolute;"><img src="images/big-img.jpg" style="position: absolute; margin: 0px; padding: 0px; border: none; width: 100%; height: 599.0182106096595px; max-height: none; max-width: none; z-index: -999999; left: 0px; top: -99.50910530482975px;"></div></div>

<div class="clear"></div>
<div class="container">
<div class="ui--title ui--animation ui--title-bordered text-left"><div class="ui--title-holder"><h3 class="ui--title-text"><strong>Latest Reveiws</strong></h3> 
  <div class="ui--title-borders ui--title-border-left" style="display: block; left: -2000px;"></div>
 <div class="ui--title-borders ui--title-border-right" style="display: block; left: 295px;"></div>
 </div>
...
<div class="vwspc-section vwspc-section-post-box vwspc-post-box-layout-slider-carousel" id="vwspc-section-4"><div class="container"><div class="row"><div class="col-sm-12 vwspc-section-content"><div class="vw-post-loop vw-post-loop-slider vw-post-loop-slider-carousel"><ul class="vw-post-slides1"><li><div class="vw-post-box vw-post-style-slide vw-post-format-standard"><a class="vw-post-box-thumbnail" href="#" rel="bookmark"> <img width="360" height="240" src="images/btm-img1.jpg" class="attachment-vw_one_third_thumbnail wp-post-image" alt="4223301478_60747fb227_o"/> </a><div class="vw-post-box-inner"><div class="vw-post-categories"><a class=" vw-category-link vw-cat-id-9" href="#" title="View all posts in Reviews" rel="category">Reviews</a><a class=" vw-category-link vw-cat-id-9 vw-category-link vw-cat-id-4" href="#" title="View all posts in Voyage" rel="category">Voyage</a></div><h3 class="vw-post-box-title"><a href="#" title="Permalink to Proin eu sapien id sodales dui pellentesque ac est risus" rel="bookmark">Proin eu sapien id sodales dui pellentesque ac est risus</a></h3></div></div></li><li><div class="vw-post-box vw-post-style-slide vw-post-format-video"><a class="vw-post-box-thumbnail" href="#" rel="bookmark"> <img width="360" height="240" src="images/btm-img1.jpg" class="attachment-vw_one_third_thumbnail wp-post-image" alt="8135233532_98d65c52e8_o"/> </a><div class="vw-post-box-inner"><div class="vw-post-categories"><a class=" vw-category-link vw-cat-id-9" href="#" title="View all posts in Reviews" rel="category">Reviews</a><a class=" vw-category-link vw-cat-id-9 vw-category-link vw-cat-id-10" href="#" title="View all posts in Teaser" rel="category">Teaser</a><a class=" vw-category-link vw-cat-id-9 vw-category-link vw-cat-id-10 vw-category-link vw-cat-id-4" href="#" title="View all posts in Voyage" rel="category">Voyage</a></div><h3 class="vw-post-box-title"><a href="#" title="Permalink to Duis mollis magna porta ipsum eget feugiat" rel="bookmark">Duis mollis magna porta ipsum eget feugiat</a></h3></div></div></li><li><div class="vw-post-box vw-post-style-slide vw-post-format-gallery"><a class="vw-post-box-thumbnail" href="#" rel="bookmark"> <img width="360" height="240" src="images/btm-img1.jpg" class="attachment-vw_one_third_thumbnail wp-post-image" alt="Photo copyright text here"/> </a><div class="vw-post-box-inner"><div class="vw-post-categories"><a class=" vw-category-link vw-cat-id-3" href="#" title="View all posts in Cuisine" rel="category">Cuisine</a><a class=" vw-category-link vw-cat-id-3 vw-category-link vw-cat-id-9" href="#" title="View all posts in Reviews" rel="category">Reviews</a><a class=" vw-category-link vw-cat-id-3 vw-category-link vw-cat-id-9 vw-category-link vw-cat-id-10" href="#" title="View all posts in Teaser" rel="category">Teaser</a></div><h3 class="vw-post-box-title"><a href="#" title="Permalink to Cum sociis natoque penatibus et magnis dis parturient" rel="bookmark">Cum sociis natoque penatibus et magnis dis parturient</a></h3></div></div></li><li><div class="vw-post-box vw-post-style-slide vw-post-format-standard"><a class="vw-post-box-thumbnail" href="#" rel="bookmark"> <img width="360" height="240" src="images/btm-img1.jpg" class="attachment-vw_one_third_thumbnail wp-post-image" alt="Photo copyright text here"/> </a><div class="vw-post-box-inner"><div class="vw-post-categories"><a class=" vw-category-link vw-cat-id-3" href="#" title="View all posts in Cuisine" rel="category">Cuisine</a><a class=" vw-category-link vw-cat-id-3 vw-category-link vw-cat-id-9" href="#" title="View all posts in Reviews" rel="category">Reviews</a></div><h3 class="vw-post-box-title"><a href="#" title="Permalink to Quisque vel sollicitudin porta ipsum eget feugiat" rel="bookmark">Quisque vel sollicitudin porta ipsum eget feugiat</a></h3></div></div></li><li><div class="vw-post-box vw-post-style-slide vw-post-format-standard"><a class="vw-post-box-thumbnail" href="#" rel="bookmark"> <img width="360" height="240" src="images/btm-img1.jpg" class="attachment-vw_one_third_thumbnail wp-post-image" alt="Photo copyright text here"/> </a><div class="vw-post-box-inner"><div class="vw-post-categories"><a class=" vw-category-link vw-cat-id-3" href="http://envirra.com/themes/blackmag/?cat=3" title="View all posts in Cuisine" rel="category">Cuisine</a><a class=" vw-category-link vw-cat-id-3 vw-category-link vw-cat-id-9" href="#" title="View all posts in Reviews" rel="category">Reviews</a></div><h3 class="vw-post-box-title"><a href="#" title="Permalink to Vestibulum arcu malesuada nec ut leo pharetra commodo" rel="bookmark">Vestibulum arcu malesuada nec ut leo pharetra commodo</a></h3></div></div></li></ul></div></div></div></div></div>
