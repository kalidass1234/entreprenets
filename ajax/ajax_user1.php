...
$selectuser=mysql_query("select user_name, first_name, last_name from registration where (user_id='$id' or user_name='$id') AND id!='".$idds."'");
$fetchuser=mysql_fetch_array($selectuser);
//echo "select user_name from registration where user_name='$id'";
$selectuser1=mysql_query("select user_name from registration where user_name='$id'  AND id!='".$idds."'");
$fetchuser1=mysql_fetch_array($selectuser1);

$selectuser3=mysql_query("select email from registration where email='$id'  AND id!='".$idds."'");
