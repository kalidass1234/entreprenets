  ...
  <div class="mainbar"> 
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Status Maintenance And Achievement Bonus Points List</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends --> 
    <!-- Matter -->
...
-->      
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Status Maintenance And Achievement Points Bonus Lists</div>
            ...
            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr>
                  <th>S.no.</th>
                  <th>Category Name </th>
                  <th>Personal Enrollment / Builders</th>
                  <th>Personal CV</th>
                  <th>Personal GV</th>
                   <th>Last Modify</th>
                  <th>Actions</th>
              ...
              <tbody>
             <?php
             $args_members = $mxDb->get_information('status_maintenance', '*',"",false, 'array');
			  if($args_members):
			  	$s_no = 1;
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $member['personal_enroll']; ?> / <?php echo $member['personal_builder']; ?></td>
                                   <th><?php echo $member['personal_cv']?></th>
                                   <th><?php echo $member['personal_group_cv']?></th>
                                        <th><?php echo $member['last_modify']?></th>
                  <td>&nbsp;
				  <span style="margin-left:5px;"><a href="status-points.php?id=<?php echo $member['id'];?>" title="View Detail"><img src="../images/edit.png" /></a></span>
