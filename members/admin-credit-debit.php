          ...
          <div class="widget-content">
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <?php
						...
						$ii=0; $s_no=1;
								$reso1=mysql_query("select * from user_registration where user_status='0' and user_id!='123456'");
								while($reso=mysql_fetch_array($reso1))
						{
						 $userid=$reso['user_id'];
					
						$sqll2=mysql_query("select * from admin_fund_deduction where (user_id='$userid' || receiver_id='$userid') order by id desc");
						...
						$sqll=mysql_query("select * from admin_fund_deduction where $filter='$userid' order by id desc"); 
						$is=0;
