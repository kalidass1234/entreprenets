            ...
            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th>Page Name </th>
                  <th>Details</th>
                  <th>Last Modify On</th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
             <?php
             $args_members = $mxDb->get_information('contactdetail', '*',"",false, 'array');
			  if($args_members):
			  	$s_no = 1;
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $member['page_name']; ?></td>
                  <td><?php echo $member['description']; ?></td>
                                   <th><?php echo $member['posted_date'];?></th>
                  <td>&nbsp;
				  <span style="margin-left:5px;"><a href="contact-detail-update.php?id=<?php echo $member['id'];?>" title="View Detail"><img src="../images/edit.png" /></a></span>
