...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <!-- Page heading -->
    <div class="page-head">
      <h2 class="pull-left">Contact Users</h2>
      <div class="clearfix"></div>
      <!-- Breadcrumb -->
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Contacted User List</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends --> 
    <!-- Matter -->
...
-->      
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Contact User Lists</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
             <?php
             $args_members = $mxDb->get_information('contact_us', '*',"",false, 'array');
			  if($args_members):
			  	$s_no = 1;
                ...
                <tr>
                  ...
                  <td><?php echo $member['email']; ?></td>
                      <td><?php echo $member['number']; ?></td>
                                   <th><?php echo $member['read_status'];?></th>
                  <td>&nbsp;
				  <span style="margin-left:5px;"><a href="contact-manage-edit.php?id=<?php echo $member['id'];?>" title="View Detail"><img src="../images/edit.png" /></a></span>
