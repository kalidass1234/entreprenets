...
$point_id=$_GET['id'];
$point = $mxDb->get_information('status_maintenance','*',"where id='$point_id'",true,'array');
...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <!-- Page heading -->
    <div class="page-head">
      <h2 class="pull-left">Status Maintenance And Achievement</h2>
      <div class="clearfix"></div>
      <!-- Breadcrumb -->
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Points</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends --> 
    <!-- Matter -->
          ...
          <?php
            ...
            <div class="widget">
              <div class="widget-head">
                <div class="pull-left">Status Maintenance And Achievement Point</div>
              ...
              <div class="widget-content">
                <div class="padd">
                  ...
                  <input type="hidden" name="action" value="updatestatusPoint"/>
                  ...
                  <input type="hidden" name="id" value="<?php echo $point_id;?>"/>
                    ...
                    <fieldset>
                      <div class="form-group">
                         ...
                         <div class="left-box">
                          <label for="name"> Personal Enrollment</label>
                          <input type="text" class="validate[required] form-control placeholder" name="point1" id="point" placeholder="Point" data-bind="value: name" value="<?php if(isset($point['personal_enroll'])): echo $point['personal_enroll']; endif;?>" />
                        </div>
                        
                        
                        
                         <div class="left-box">
                          <label for="name"> Pesonal Builder</label>
                          <input type="text" class="validate[required] form-control placeholder" name="point2" id="point" placeholder="Point" data-bind="value: name" value="<?php if(isset($point['personal_builder'])): echo $point['personal_builder']; endif;?>" />
                        </div>
                        
                         <div class="left-box">
                          <label for="name"> Personal CV</label>
                          <input type="text" class="validate[required] form-control placeholder" name="point3" id="point" placeholder="Point" data-bind="value: name" value="<?php if(isset($point['personal_cv'])): echo $point['personal_cv']; endif;?>" />
                        </div>
                        
                         <div class="left-box">
                          <label for="name"> Personal GV</label>
                          <input type="text" class="validate[required] form-control placeholder" name="point4" id="point" placeholder="Point" data-bind="value: name" value="<?php if(isset($point['personal_group_cv'])): echo $point['personal_group_cv']; endif;?>" />
                        </div>
