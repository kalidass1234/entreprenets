...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <!-- Page heading -->
    <div class="page-head">
      <h2 class="pull-left">Weekly Retail Profit Bonus</h2>
      <div class="clearfix"></div>
      <!-- Breadcrumb -->
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Weekly Retail Profit Bonus</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends --> 
    <!-- Matter -->
    <div class="matter">
      <div class="container"> 
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Weekly Retail Profit Bonus</div>
            <div class="widget-icons pull-right"> <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> <a href="#" class="wsettings"><i class="fa fa-wrench"></i></a> <a href="#" class="wclose"><i class="fa fa-times"></i></a> </div>
            <div class="clearfix"></div>
          </div>
          <div class="widget-content">
            ...
            <table class="table table-striped table-bordered table-hover">
			   ...
			   if(isset($_POST['show']))
			 {
				 ...
				 $end_date=$_POST['end_date'];
				  ...
				  $args_banners_week = $mxDb->get_information('level_income_retail', '*', "where 1=1 and (date between '$start_date' and '$end_date') order by l_id asc ",false, 'assoc');
			 }
			 else
			 {
			 // get best offer banners 
			  $args_banners_week = $mxDb->get_information('level_income_retail', '*', "where 1=1 order by l_id asc ",false, 'assoc');
			 }
              ...
              ?>
                <tr>
                  ...
                  <td> <?php echo $banners['income_id']; ?></td>
                   ...
                   <td><?php echo $banners['invoice_bv']; ?></td>
                    <td>$ <?php echo $banners['commission']; ?></td>
                 ...
                 <?php @$total_amount=$total_amount+$banners['commission'];?>
				...
				?>
                <tr><td  colspan="13">Total Retail Profit Commission $ <?php echo @$total_amount;?></td></tr>
