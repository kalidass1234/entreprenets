...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <!-- Page heading -->
    <div class="page-head">
      <h2 class="pull-left">Change Admin Login Password</h2>
      <div class="clearfix"></div>
      <!-- Breadcrumb -->
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Change Password</a> 
        <!-- Divider --> 
            ...
            <div class="widget">
              ...
              <div class="widget-content">
                <div class="padd">
                  ...
                  <input type="hidden" name="action" value="EditAdminPasswordSection">
