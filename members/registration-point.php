...
$point_id=$_GET['id'];
$point = $mxDb->get_information('registration_points','*',"where id='$point_id'",true,'array');
          ...
          <?php
            ...
            <div class="widget">
              <div class="widget-head">
                <div class="pull-left">Registration Free Point</div>
                    ...
                    <fieldset>
                      <div class="form-group">
                         ...
                         <div class="left-box">
                          ...
                          <input type="text" class="validate[required] form-control placeholder" name="point" id="point" placeholder="Point" data-bind="value: name" value="<?php if(isset($point['point'])): echo $point['point']; endif;?>" />
                        </div>
