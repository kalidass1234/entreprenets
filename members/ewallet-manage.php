            ...
            <table class="table table-striped table-bordered table-hover">
			 ...
			 // store query
			  $query = '';
			   ...
			   // set url
			  $url = SITE_URL.'admin/members/ewallet-manage.php?';
              ...
              ?>
                <tr>
                  ...
                  <th><?php echo @$status[$member['user_status']]; ?></th>
                    ...
                    <th>$ <?php $mxDb->get_field_information('final_e_wallet','amount', "where user_id=".$member['user_id'],'assoc', true); ?></th>
                  
                  <td>&nbsp;
				  <span style="margin-left:5px;"><a href="<?php echo SITE_URL; ?>admin/members/view-ewallet.php?user_id=<?php echo $member['user_id'];?>" title="View History">View History</a></span></td><td>
                  <span style="margin-left:5px;"><a href="<?php echo SITE_URL; ?>admin/members/fund-manage.php?user_id=<?php echo $member['user_id'];?>" title="Fund Manage">Fund Manage</a></span>
                  </span>
