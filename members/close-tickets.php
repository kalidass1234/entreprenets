  ...
  <div class="mainbar"> 
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> <a href="index.html"><i class="fa fa-home"></i> Support System</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Close Tickets</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends --> 
    <!-- Matter -->
...
-->      
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Close Tickets</div>
            <div class="widget-icons pull-right"> <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> <a href="#" class="wsettings"><i class="fa fa-wrench"></i></a> <a href="#" class="wclose"><i class="fa fa-times"></i></a> </div>
            <div class="clearfix"></div>
          </div>
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
			 ...
			 // store query
			  $query = '';
			   ...
			   // set url
			  $url = SITE_URL.'admin/members/close-tickets.php?';
              ...
              ?>
                <tr>
                  ...
                  <th><?php echo $member['t_date']; ?></th>
                   <th><?php echo $member['c_t_date']; ?></th>
                   <th><?php echo "Resonded"; ?></th>
                  <td>&nbsp;
				  <span style="margin-left:5px;"><a href="<?php echo SITE_URL; ?>admin/members/close-tickets-response.php?<?php echo http_build_query($member);?>" title="View Detail"><img src="../images/edit.png" /></a></span>
                  <span style="margin-left:5px;"><a href="javascript:void(0)" onclick="delete_item('../action_control/get-action.php?rand=<?php echo $_SESSION['rand']; ?>&id=<?php echo $member['id'];?>&tbl=tickets&return=members/close-tickets.php&field=id&action=DeleteRecord&delete=true')" title="Delete"><img src="../images/Trashcan.png" /></a></span>
