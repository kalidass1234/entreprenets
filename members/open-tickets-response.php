  ...
  <div class="mainbar"> 
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> <a href="index.html"><i class="fa fa-home"></i> Support System</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Open Ticket Response</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends --> 
    <!-- Matter -->
...
<div class="clearfix"></div>
                        ...
                        <div class="left-box" id="show_sub_sub_category">
                          ...
                          <div id="sub_sub_category">
                            <textarea class="validate[required] form-control placeholder" name="response" style="width:950px;height:150px;" id="response" data-bind="value: name" /><?php if(isset($args_member['response'])): echo $args_member['response']; endif;?></textarea>
                          </div>
                        </div>
