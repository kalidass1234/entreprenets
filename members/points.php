  ...
  <div class="mainbar"> 
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Bonus Points List</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends --> 
    <!-- Matter -->
...
-->      
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Points Bonus Lists</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
             <?php
             $args_members = $mxDb->get_information('registration_points', '*',"",false, 'array');
			  if($args_members):
			  	$s_no = 1;
              ...
              ?>
                <tr>
                  ...
                  <td>&nbsp;
				  <span style="margin-left:5px;"><a href="registration-point.php?id=<?php echo $member['id'];?>" title="View Detail"><img src="../images/edit.png" /></a></span>
