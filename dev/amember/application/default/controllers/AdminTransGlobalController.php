...
(function($){
    $(function() {
        $(document).on('change','form.filter select#trans-mode', function() {
            $(this).parents('form').get(0).submit();
        })
    })

    var changedNum = 0;
    $(document).on('focus',".text-edit", function(event) {
    ...
    $(document).on('change',".text-edit", function(event) {
        ...
        var aCancel = $('<a href="javascript:;" class="local">$cancel_title</a>').click(function(){
