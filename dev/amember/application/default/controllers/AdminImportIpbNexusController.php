...
class AdminImportIpbNexusController extends Am_Controller
{
...
EOL
    ...
    function cleanUpData($value)
    {
       ...
       $this->redirectHtml(REL_ROOT_URL . '/admin-import-ipb-nexus', 'Records removed');
    }
            ...
            $form->addStatic()
                ...
                ->setContent(
                    sprintf(___('Use this %slink%s to delete data from aMember v4 database and use clean database for import'),
                        '<a href="'.REL_ROOT_URL.'/admin-import-ipb-nexus/clean">', '</a>'));
        }
