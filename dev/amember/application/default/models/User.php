...
class User extends Am_Record_WithData
{
    ...
    function update()
    {
        ...
        if ($this->getDi()->hook->have(array(
            ...
            if (!$oldU)
                $oldU = new self; // avoid errors here
    ...
    function generateLogin()
    {
        ...
        $e = new Am_Event(Am_Event::GENERATE_LOGIN, array('user' => $this));
        $e->setReturn($try);
        ...
        /// let's go
        do {
            $pass = $this->getDi()->app->generateRandomString(rand($min_length, $max_length), "qwertyuiopasdfghjklzxcvbnm");
        }
    ...
    function getRebill($productIdOrIds = array())
    {
        ...
        return $this->getDi()->db->selectCell("SELECT
            ...
            {AND a.product_id IN (?a)}", $this->pk(), sqlDate('now'), $productIdOrIds ? $productIdOrIds : DBSIMPLE_SKIP
        );
    }
