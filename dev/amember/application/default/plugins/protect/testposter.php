 ...
 * @type Other..
 */
class Am_Protect_testposter extends Am_Protect_Databased
{
    ...
    {
        $table = new Am_Protect_Table_testposter($this, $this->getDb(), '?_users', 'id');
...
class Am_Protect_Table_testposter extends Am_Protect_Table
{
