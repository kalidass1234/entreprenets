    ...
    <div id="page-wrap">
      <header id="page-header" class="clearfix">
        <div id="top-bar" class="clearfix">
          <div id="top-bar-background">
            <div class="container relative">
              <div id="top-bar-text" class="top-bar-sides abs-left"> <a href="tel:(1)13546897"><i class="ui--icon fontawesome-phone icon-inline-block" style="font-size: 14px;  width: 18px;  height: 18px;  margin-right: 5px;"></i> (1) 13 546 897</a>
        ...
        <div id="header-container" class="header-type-1 no-stuck clearfix"  data-responsive="{&quot;css&quot;:{&quot;padding-bottom&quot;:{&quot;phone&quot;:20,&quot;tablet&quot;:20,&quot;widescreen&quot;:0}}}">
          ...
          <div class="container relative">
            <div id="logo" class="pull-left"> <a href="index.html"> <img  id="logo-desktop" class="visible-desktop " src="images/logo.png" data-at2x="images/logo@2x-2.png" alt="Envision" style="margin-top: 10px;  margin-bottom: 10px;"/><img  id="logo-tablet" class="visible-tablet " src="images/logo.png" data-at2x="images/logo@2x-2.png" alt="Envision" style="margin-top: 10px;  margin-bottom: 10px;"/><img  id="logo-phone" class="visible-phone " src="images/logo.png" data-at2x="images/logo@2x-2.png" alt="Envision" style="margin-top: 20px;  margin-bottom: 20px;"/> </a> </div>
            <!-- /#logo -->
            <nav id="navigation" class="pull-right">
              <div id="woocommerce-nav-cart" class="pull-right visible-desktop "> <a href="#" class="ui--side-panel" data-target="ui--side-cart-widget"><i class="ui--icon icomoon-cart icon-inline-block" style="font-size: 18px;  width: 22px;  height: 22px;"></i> <span class="cart-money"><span class="amount">&#36;0</span></span></a> </div>
              ...
              <ul id="header-navigation" class="sf-menu clearfix unstyled-all">
                <li id="menu-item-1279" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="index.html">Home </a>
                </li>
                
                <li id="menu-item-1278" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="wht-bmc-network.html">What is BMC Network? <i class="ui--caret fontawesome-angle-down px18"></i></a>

                <ul class="sub-menu">
                    <li id="menu-item-1427" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children level-1 sub-level-item has-child to-right"><a href="intro.html">- Introduction</a>
                      
                    </li>
                    
                    <li id="menu-item-1427" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children level-1 sub-level-item has-child to-right"><a href="global-con.html">- Global Concerns</a>
                      
                    </li>
                    
                    <li id="menu-item-1428" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children level-1 sub-level-item has-child to-right"><a href="dreams-vision.html">- Your Dreams & Vision</a>
                      
                    </li>
                    
                    <li id="menu-item-1429" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children level-1 sub-level-item has-child to-right"><a href="#">- Online Business Trends</a>
                ...
                <li id="menu-item-1278" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="how-it-works.html">How it works? <i class="ui--caret fontawesome-angle-down px18"></i></a>
                
                <ul class="sub-menu">
                    <li id="menu-item-1427" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children level-1 sub-level-item has-child to-right"><a href="compensation-plan.html">- Compensation Plan </a>
                ...
                <li id="menu-item-1118" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="business.html">Businesses<i class="ui--caret fontawesome-angle-down px18"></i></a>
                  <ul class="sub-menu">
                    <li id="menu-item-1427" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children level-1 sub-level-item has-child to-right"><a href="offline-businesses.html">- Offline Businesses </a>
                      
                    </li>
                    <li id="menu-item-14" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children level-1 sub-level-item has-child to-right"><a href="online-business.html">- Online Businesses </a>

                    </li>
                  </ul>
                </li>
                
                <li id="menu-item-1280" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="subscription-pack.html">Packages </a>                </li>
                
                <li id="menu-item-1281" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="about-us.html">About Us </a>
                </li>
                <li id="menu-item-1282" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="blog.html">Blog </a>
                </li>
                
                <li id="menu-item-1283" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children level-0 top-level-item has-child fallout to-right"><a href="contact-us.html">Support </a>
                </li>
...
<div id="titlebar" class="titlebar-w5dmc cover">
			<div class="container relative">
				<div id="titlebar-text">
									...
									<div id="titlebar-breadcrumb"><div id="breadcrumb" class="ui--box-alias centerVertical"><div class="ui-bc ui-breadcrumbs breadcrumbs" itemprop="breadcrumb"><span class="ui-bc-first"><a href="#" title="Envision" rel="home" class="ui-bc-first">Home</a></span> <span class="ui-bc-seperator"> <i class="ui--caret fontawesome-angle-right px18"></i> </span> <span class="ui-bc-last">Blog Medium</span></div></div></div>
							</div>
		</div><!-- /#titlebar -->

	<div id="page-content" class="sidebar-layout ui-row sidebar-right"><div class="container"><div id="the-content" >
	<div id="blog-1" class="ui--blog ui--blog-wrapper ui--pass" data-layout="standard" data-columns="1"><div class="post-36 post type-post status-publish format-standard hentry category-featured category-uncategorized instock ui--blog-item clearfix layout--medium"><div class="ui--blog-media"><a class="ui--blog-link" href="#"><img  class="ui--blog-image" src="images/social-media-960x720.jpg" alt=""/></a></div><div class="ui--blog-side ui--blog-date ui--accent-gradient-hover-parent ui--box"><h3><span class="ui--blog-date-day ui--accent-gradient-hover">21</span></h3><h6 class="ui--blog-date-month ui--gradient ui--gradient-grey"><span>Jul</span><span>2013</span></h6></div><div class="ui--blog-content-wrapper"><div class="ui--blog-header"><h3 class="ui--blog-title clearfix"><a class="ui--blog-link" href="http://envision.wptation.com/social-media-composer-post/">Social Media &#8211; Composer Post</a><span class="ui--badge ui--badge-sticky"><span class="btn btn-mini btn-yellow radius-6px pull-right">Sticky Post</span></span></h3><div class="ui--blog-metas clearfix"><div class="ui--blog-metas-right pull-right"><span class="ui--meta-comment"><a href="#"><i class="fontawesome-comment px14"></i> 8</a></span> <span class="ui--blog-separator">&nbsp;</span> <span class="ui--meta-like"><a href="#" class="ui--likes" title="Like this" data-post-id="36" data-options="{&quot;zero&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;,&quot;one&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;,&quot;more&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;}"><span class="ui--likes-count"><i class="fontawesome-heart px14"></i> 253</span></a></span></div><div class="ui--blog-metas-left"><span class="datetime">July 21, 2013</span></div></div></div><div class="ui--blog-content">Maecenas tincidunt mi id elementum imperdiet. Ut consequat turpis dui, bibendum sollicitudin nisl iaculis vitae. Fusce pulvinar ornare nulla, id ... <span class="more-link"><a class="btn btn-small btn-grey" href="http://envision.wptation.com/social-media-composer-post/" title="Continue reading this entry">Read More</a></span>
</div></div></div><div class="post-26 post type-post status-publish format-image hentry category-featured category-image tag-image-2 instock ui--blog-item clearfix layout--medium"><div class="ui--blog-media"><a class="ui--blog-link" href="http://envision.wptation.com/image-post-format/"><img  class="ui--blog-image" src="images/21-960x720.jpg" alt=""/></a></div><div class="ui--blog-side ui--blog-date ui--accent-gradient-hover-parent ui--box"><h3><span class="ui--blog-date-day ui--accent-gradient-hover">21</span></h3><h6 class="ui--blog-date-month ui--gradient ui--gradient-grey"><span>Jul</span><span>2013</span></h6></div><div class="ui--blog-content-wrapper"><div class="ui--blog-header"><h3 class="ui--blog-title clearfix"><a class="ui--blog-link" href="http://envision.wptation.com/image-post-format/">Image Post Format</a></h3><div class="ui--blog-metas clearfix"><div class="ui--blog-metas-right pull-right"><span class="ui--meta-comment"><a href="#"><i class="fontawesome-comment px14"></i> 3</a></span> <span class="ui--blog-separator">&nbsp;</span> <span class="ui--meta-like"><a href="#" class="ui--likes" title="Like this" data-post-id="26" data-options="{&quot;zero&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;,&quot;one&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;,&quot;more&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;}"><span class="ui--likes-count"><i class="fontawesome-heart px14"></i> 139</span></a></span></div><div class="ui--blog-metas-left"><span class="datetime">July 21, 2013</span></div></div></div><div class="ui--blog-content">Quisque erat ligula, vehicula quis sollicitudin a, tempus at ligula. Donec vehicula ante ac tortor viverra sodales. Praesent lectus leo, ... <span class="more-link"><a class="btn btn-small btn-grey" href="http://envision.wptation.com/image-post-format/" title="Continue reading this entry">Read More</a></span>
</div></div></div><div class="post-23 post type-post status-publish format-video hentry category-featured category-music category-video tag-music-2 tag-theme tag-video-2 instock ui--blog-item clearfix layout--medium"><div class="ui--blog-media"><div class="ui--blog-video clearfix"><div class="cloudfw-fatal-error"><strong>Error</strong>: The video (http://vimeo.com/66297975) couldn't be embedded.</div></div></div><div class="ui--blog-side ui--blog-date ui--accent-gradient-hover-parent ui--box"><h3><span class="ui--blog-date-day ui--accent-gradient-hover">21</span></h3><h6 class="ui--blog-date-month ui--gradient ui--gradient-grey"><span>Jul</span><span>2013</span></h6></div><div class="ui--blog-content-wrapper"><div class="ui--blog-header"><h3 class="ui--blog-title clearfix"><a class="ui--blog-link" href="#">Etta Bond: Under The Knife</a></h3><div class="ui--blog-metas clearfix"><div class="ui--blog-metas-right pull-right"><span class="ui--meta-comment"><a href="#"><i class="fontawesome-comment px14"></i> 2</a></span> <span class="ui--blog-separator">&nbsp;</span> <span class="ui--meta-like"><a href="#" class="ui--likes" title="Like this" data-post-id="23" data-options="{&quot;zero&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quuuot;,&quot;one&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;,&quot;more&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;}"><span class="ui--likes-count"><i class="fontawesome-heart px14"></i> 61</span></a></span></div><div class="ui--blog-metas-left"><span class="datetime">July 21, 2013</span></div></div></div><div class="ui--blog-content">Quisque ligula ipsum, euismod a vulputate a, ultricies et elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, ... <span class="more-link"><a class="btn btn-small btn-grey" href="#" title="Continue reading this entry">Read More</a></span>
</div></div></div><div class="post-15 post type-post status-publish format-gallery hentry category-featured category-gallery instock ui--blog-item clearfix layout--medium last-item"><div class="ui--blog-media"><div class="ui--blog-gallery" data-options="{&quot;effect&quot;:&quot;fade&quot;,&quot;auto_rotate&quot;:false,&quot;rotate_time&quot;:false}"><div class="slides"><div class="ui--blog-gallery-item ui--blog-gallery-item-1"><a href="#"><img  class="ui--blog-gallery-image" src="images/1-960x720.jpg" alt=""/></a></div><div class="ui--blog-gallery-item ui--blog-gallery-item-2"><a href="#"><img  class="ui--blog-gallery-image" src="images/2-960x720.jpg" alt=""/></a></div></div></div></div><div class="ui--blog-side ui--blog-date ui--accent-gradient-hover-parent ui--box"><h3><span class="ui--blog-date-day ui--accent-gradient-hover">21</span></h3><h6 class="ui--blog-date-month ui--gradient ui--gradient-grey"><span>Jul</span><span>2013</span></h6></div><div class="ui--blog-content-wrapper"><div class="ui--blog-header"><h3 class="ui--blog-title clearfix"><a class="ui--blog-link" href="#">Gallery Post #1</a></h3><div class="ui--blog-metas clearfix"><div class="ui--blog-metas-right pull-right"><span class="ui--meta-comment"><a href="#"><i class="fontawesome-comment px14"></i> 1</a></span> <span class="ui--blog-separator">&nbsp;</span> <span class="ui--meta-like"><a href="#" class="ui--likes" title="Like this" data-post-id="15" data-options="{&quot;zero&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;,&quot;one&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;,&quot;more&quot;:&quot;&lt;i class=\&quot;fontawesome-heart px14\&quot;&gt;&lt;\/i&gt; %d&quot;}"><span class="ui--likes-count"><i class="fontawesome-heart px14"></i> 85</span></a></span></div><div class="ui--blog-metas-left"><span class="datetime">July 21, 2013</span></div></div></div><div class="ui--blog-content">Suspendisse interdum ac nulla quis faucibus. Mauris ac quam eleifend, lacinia mi id, ullamcorper est. Aliquam quis bibendum turpis, id ... <span class="more-link"><a class="btn btn-small btn-grey" href="#" title="Continue reading this entry">Read More</a></span>
</div></div></div><div class="ui--pagination-wrapper clearfix"><ul class="ui--pagination unstyled clearfix"><li class='ui--box ui--gradient ui--gradient-grey ui--pagination-previous-link inactive'><span class='sprite previous-link '>Previous</span></li><li class='ui--box ui--gradient ui--gradient-grey ui--pagination-current-item'><span class=''>1</span></li><li class='ui--box ui--gradient ui--gradient-grey'><a href='#' class=''>2</a></li><li class='ui--box ui--gradient ui--gradient-grey ui--pagination-next-link'><a href='http://envision.wptation.com/blog-medium/page/2/' class='sprite next-link '>Next</a></li></ul></div></div>

	</div>
	<aside id="sidebars" class="widget-area  custom-widget-blog-widget-area">
			<div id="search-3" class="widget widget_search"><h4 class="sidebar-widget-title ui--widget-title"><span>Search</span></h4><form class="searchform" action="#" method="get">
	<input type="text" name="s" value="" placeholder="Search" />
	<button type="submit" class="btn btn-primary btn-small">Search</button>
</form></div><div id="calendar-3" class="widget widget_calendar"><h4 class="sidebar-widget-title ui--widget-title"><span>Calendar</span></h4><div id="calendar_wrap"><table id="wp-calendar">
	...
	</table></div></div><div id="categories-3" class="widget widget_categories"><h4 class="sidebar-widget-title ui--widget-title"><span>Categories</span></h4>		<ul>
	<li class="cat-item cat-item-22"><a href="#" title="View all posts filed under Featured">Featured</a> (6)
</li>
	<li class="cat-item cat-item-10"><a href="#" title="View all posts filed under Gallery">Gallery</a> (2)
</li>
	<li class="cat-item cat-item-17"><a href="#" title="View all posts filed under Image">Image</a> (2)
</li>
	<li class="cat-item cat-item-13"><a href="#" title="View all posts filed under Music">Music</a> (1)
</li>
	<li class="cat-item cat-item-1"><a href="#" title="View all posts filed under Uncategorized">Uncategorized</a> (3)
</li>
	<li class="cat-item cat-item-12"><a href="#" title="View all posts filed under Video">Video</a> (1)
</li>
		</ul>
</div><div id="tag_cloud-3" class="widget widget_tag_cloud"><h4 class="sidebar-widget-title ui--widget-title"><span>Tags</span></h4><div class="tagcloud"><a href='#' class='tag-link-4' title='1 topic' style='font-size: 7pt;'>high resolution</a>
...
<a href='#' class='tag-link-16' title='1 topic' style='font-size: 7pt;'>video</a></div>
</div>		<div id="recent-posts-3" class="widget widget_recent_entries">		<h4 class="sidebar-widget-title ui--widget-title"><span>Recent Posts</span></h4>		<ul>
					<li>
				<a href="#">Social Media &#8211; Composer Post</a>
						</li>
					<li>
				<a href="#">Image Post Format</a>
						</li>
					<li>
				<a href="#">Etta Bond: Under The Knife</a>
						</li>
					<li>
				<a href="#">Gallery Post #1</a>
						</li>
					<li>
				<a href="#">Standard Post Format</a>
						</li>
				</ul>
		</div><div id="widget_cloudfw_twitter-2" class="widget widget_cloudfw_twitter"><h4 class="sidebar-widget-title ui--widget-title"><span>Latest Tweets</span></h4></div>	<div id="sidebar-shadow"><div id="sidebar-shadow-top"></div><div id="sidebar-shadow-bottom"></div></div>
                  ...
                  <div id="nav_menu-4" class="widget widget-footer widget_nav_menu">
                    ...
                    <div class="menu-pages-menu-container">
                      <ul id="menu-pages-menu" class="menu">
                        ...
                        <li id="menu-item-1208" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1208"><a href="index.html">Home</a></li>
                        <li id="menu-item-1209" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1209"><a href="#"> What is BMC?</a></li>
      ...
      <div id="login-form-container" class="ui--custom-login login-form-container">
        <form method="post" class="login-form form-horizontal ui-row">
          ...
          <div class="form-actions clearfix">
            ...
            <p class="control-group"> <span class="ui--animation"> <a class="lost_password btn btn-block  btn-secondary" href="register.html">Register New User</a> </span> </p>
          </div>
        </form>
      </div>
    </div>
