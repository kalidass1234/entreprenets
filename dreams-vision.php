...
<div id="titlebar" class="titlebar-hautq cover">
			<div class="container relative">
				<div id="titlebar-text">
											<h2 id="titlebar-title"><strong>Your Dreams & Vision</strong></h2>
									...
									<div id="titlebar-breadcrumb"><div id="breadcrumb" class="ui--box-alias centerVertical"><div class="ui-bc ui-breadcrumbs breadcrumbs" itemprop="breadcrumb"><span class="ui-bc-first"><a href="#" title="Envision" rel="home" class="ui-bc-first">Home</a></span> <span class="ui-bc-seperator"> <i class="ui--caret fontawesome-angle-right px18"></i> </span> <span class="ui-bc-last">Your Dreams & Vision</span></div></div></div>
							</div>
		</div><!-- /#titlebar -->
 ...
 <div class="ui-column span6"><div class="ui--animation-in make--fx--caption-left ui--pass clearfix" data-fx="fx--caption-left" data-delay="150" data-start-delay="400"><div class="ui--image-wrap clearfix" style="margin-bottom: 0px;"><img id="ui--image-3" class="ui--image fx--caption-left ui--animation-fire" src="images/7.png" alt="" title="" data-at2x="" delay="400"></div></div></div> 

 <div class="ui-column span6"><div class="ui--animation-in make--fx--caption-right ui--pass clearfix" data-fx="fx--caption-right" data-delay="400" data-start-delay="400"><h3 class="fx--caption-right ui--animation-fire" style="" delay="400"><strong>Our Vision</strong></h3><div class="auto-format fx--caption-right ui--animation-fire" delay="800"><p>Sed tempor magna non ipsum mattis aliquam. Sed euismod magna eu nisl ultrices condimentum. Cras nibh nibh, fermentum vel tempor vitae, dapibus at magna. </p>
<p>Donec adipiscing nunc in ante volutpat scelerisque. Fusce vel adipiscing justo. Maecenas vulputate malesuada lorem, sed pellentesque risus ullamcorper sit amet. Mauris auctor, justo vestibulum tristique sodales, nisl ligula congue justo, vitae ornare ligula eros non dolor. Suspendisse quis diam dolor. Nullam sed commodo dui.</p>
<p>Maecenas eu iaculis turpis. In placerat porttitor dui, vel cursus diam condimentum eget. Pellentesque tempor turpis id orci mattis, sit amet molestie augue sagittis. Vivamus ac.</p>
...
<h3 class="fx--caption-right ui--animation-fire" style="" delay="400"><strong>Our Dreams</strong></h3><div class="auto-format fx--caption-right ui--animation-fire" delay="800"><p>Sed tempor magna non ipsum mattis aliquam. Sed euismod magna eu nisl ultrices condimentum. Cras nibh nibh, fermentum vel tempor vitae, dapibus at magna. </p>
<p>Donec adipiscing nunc in ante volutpat scelerisque. Fusce vel adipiscing justo. Maecenas vulputate malesuada lorem, sed pellentesque risus ullamcorper sit amet. Mauris auctor, justo vestibulum tristique sodales, nisl ligula congue justo, vitae ornare ligula eros non dolor. Suspendisse quis diam dolor. Nullam sed commodo dui.</p>
<p>Maecenas eu iaculis turpis. In placerat porttitor dui, vel cursus diam condimentum eget. Pellentesque tempor turpis id orci mattis, sit amet molestie augue sagittis. Vivamus ac.</p>
</div>
...
<div class="ui-row row">
 ...
 <div   class="ui-column span4"><div class="ui--carousel-item ui--twitter-style-default ui--twitter-timeline-wrap ui--animation clearfix">
	...
	</div></div></div><!-- /.container --></div><!-- /#page-content -->
