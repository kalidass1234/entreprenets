...
<div id="titlebar" class="titlebar-hautq cover">
			<div class="container relative">
				<div id="titlebar-text">
											<h2 id="titlebar-title"><strong>Pricing Page</strong> - Feature List Style</h2>
					
											<div class="titlebar-text-content"><p>Duis blandit nunc eget ipsum dignissim elementum. Etiam et dignissim mi, vitae fringilla diam. Suspendisse a augue nibh. Integer tincidunt luctus nulla quis pellentesque. In tempus ligula sit amet nunc rutrum, vitae ultricies nibh tempor. Aenean et erat volutpat, congue nunc ut, cursus justo. Donec fringilla, elit luctus malesuada blandit, nulla quam aliquet massa, a tempor risus velit eu risus.</p>
</div>
									</div>
									<div id="titlebar-breadcrumb"><div id="breadcrumb" class="ui--box-alias centerVertical"><div class="ui-bc ui-breadcrumbs breadcrumbs" itemprop="breadcrumb"><span class="ui-bc-first"><a href="http://envision.wptation.com" title="Envision" rel="home" class="ui-bc-first">Home</a></span> <span class="ui-bc-seperator"> <i class="ui--caret fontawesome-angle-right px18"></i> </span> <span class="ui-bc-last">Pricing Page</span></div></div></div>
							</div>
		</div><!-- /#titlebar -->
	...
	<div  class="ui--animation-in make--fx--appear ui--pass clearfix" data-fx="fx--appear" data-delay="150" data-start-delay="0"><div class="ui--pricing-table-wrap clearfix style2"><ul id="price_table_1" class="ui--pricing-table unstyled clearfix columns-3" style="margin-top: 20px;"><li class="ui--pricing-table-column ui--animation"><div class="ui--shadow-top inset ui--box"><div class="ui--pricing-table-item-title-wrap ui--gradient ui--gradient-grey">
						<h1 class="ui--pricing-table-item-title " style="font-size: 28px !important; "><strong>BMC1 </strong></h1></div><div class="ui--pricing-table-before-html clearfix"><h2 class="ui--pricing-table-item-price" style="font-size: 22px !important; "><strong>$19</strong><small style="font-size:60% !important;">/month</small></h2><div class="caption"><p>Best for corparete teams</p>
		...
		</li><li class="ui--pricing-table-column ui--animation featured"><div class="ui--shadow-top inset ui--box"><div class="ui--pricing-table-item-title-wrap ui--gradient ui--accent-gradient ui--accent-color">
						<h1 class="ui--pricing-table-item-title ui--accent-color-forced" style="font-size: 30px !important; ">BMC2</h1></div><div class="ui--pricing-table-before-html clearfix"><h2 class="ui--pricing-table-item-price" style="font-size: 22px !important; "><strong>$49</strong><small style="font-size:60% !important;">/month</small></h2><div class="caption"><p>Most popular plan</p>
		...
		</li><li class="ui--pricing-table-column ui--animation"><div class="ui--shadow-top inset ui--box"><div class="ui--pricing-table-item-title-wrap ui--gradient ui--gradient-grey">
						<h1 class="ui--pricing-table-item-title " style="font-size: 28px !important; "><strong> BMC3</strong></h1></div><div class="ui--pricing-table-before-html clearfix"><h2 class="ui--pricing-table-item-price" style="font-size: 28px !important; "><strong>$99</strong><small style="font-size:60% !important;">/month</small></h2><div class="caption"><p>Best for corparete teams</p>
		...
		</li></ul></div></div><div  class="ui--tabs ui--tabs-mini ui--tabs-mini-horizontal clearfix text-left"><div class="ui--tabs-header clearfix"><div class="ui--tabs-header-holder"><div class="ui--tabs-border-before"></div><div class="ui--tabs-border-after"></div><ul class="ui--tabs-titles clearfix unstyled"><li class=""><h5><a href="#presale">Pre-Sale</a></h5></li><li class=""><h5><a href="#purchasing">Purchasing</a></h5></li></ul></div></div><div class="clearfix"></div><ul class="ui--tabs-contents text-left clearfix"><li class="hidden"> <div class="auto-format ui--animation"><p>Fames etiam sit enim fermentum etiam quam eros velit aptent netus faucibus duis lectus integer malesuada, mattis tempus commodoiam molestie taciti eleifend donec fames platea molestie donec, bibendum vehicula nam turpis faucibus, Tncidunt quisqes. Voluptas sadips ipsums amet untras.Sollicitudin eros sapien, ultrices primis. This is Emphasized text volutpat tempor tur duis mattis dapibus, felis amet faucibus. fames etiam sit enim fermentum etiam quam eros velit aptent netus faucibus duis lectus integer malesuada, mattis tempus commodoiam molestie taciti eleifend donec fames platea molestie donec, bibendum vehicula nam turpis faucibus.</p>
 ...
 <div   class="ui-column span9"><div  class="ui--animation-in make--fx--fadein-ltr ui--pass clearfix" data-fx="fx--fadein-ltr" data-delay="400" data-start-delay="0"><h3 class="ui--animation " style="color: #333333 !important; margin-bottom: 0px; ">Envision is incredibly <strong>responsive</strong>, with a <strong>refreshingly</strong> clean design</h3><div class="auto-format ui--animation"><p>Harums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets.</p>
</div></div></div> 
