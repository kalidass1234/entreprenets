...
<?php
$cond = " id='".$news_id."'";
$getInfoByTableNameAndID = getInfoByTableNameAndID("manage_news",$cond);
?>
<div id="titlebar" class="titlebar-hautq cover">
			<div class="container relative">
				<div id="titlebar-text">
											<h2 id="titlebar-title"><strong><?=$getInfoByTableNameAndID['news_title'];?></strong></h2>
									...
									<div id="titlebar-breadcrumb"><div id="breadcrumb" class="ui--box-alias centerVertical"><div class="ui-bc ui-breadcrumbs breadcrumbs" itemprop="breadcrumb"><span class="ui-bc-first"><a href="http://envision.wptation.com" title="Envision" rel="home" class="ui-bc-first">Home</a></span> <span class="ui-bc-seperator"> <i class="ui--caret fontawesome-angle-right px18"></i> </span> <span class="ui-bc-last">Product Wholesale & Retailing</span></div></div></div>
							</div>
		</div><!-- /#titlebar -->
...
<div class="ui--masonry ui--row row clearfix ui--done isotope" style="visibility: visible; overflow: hidden; position: relative; height: auto;">
...
<div class="ui-row row">
	<div class="ui-column span12 filter-app ui--isotope-item isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); opacity: 1;">
		<div class="ui--block ui--content-item ui--pass fx--caption-bottom ui--animation-fire" delay="0">
			<div class="ui--content-box ui--box ui-row" data-ligthbox="{&quot;src&quot;:[&quot;http:\/\/envision.wptation.com\/wp-content\/uploads\/2013\/07\/plugin.jpg&quot;,&quot;http:\/\/envision.wptation.com\/wp-content\/uploads\/2013\/07\/metro_style_Content.jpg&quot;,&quot;http:\/\/envision.wptation.com\/wp-content\/uploads\/2013\/07\/wallpaper1920x1440-1.jpg&quot;],&quot;desc&quot;:[&quot;Thumbnail Gallery&quot;,&quot;Thumbnail Gallery&quot;,&quot;Thumbnail Gallery&quot;]}">
				<div class="ui--content-box-header"><div class="ui--content-box-media effect--fade type--default clearfix" style="padding-bottom: 56.25%;">
					<div class="ui--content-box-gallery" data-options="{&quot;effect&quot;:&quot;fade&quot;,&quot;auto_rotate&quot;:&quot;1&quot;,&quot;rotate_time&quot;:5000}" style="height: 207px;">				
						
						<div class="mini-slides">
						        <?php
								$i=1;
								$cond = " news_id='".$news_id."'";
								$getInfoByTableName = getInfoByTableNameID("manage_news_slider",$cond);
								foreach($getInfoByTableName as $records)
								{
					
								?>
							<div class="ui--content-box-gallery-item ui--content-box-gallery-item-<?=$i?>" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;"><img class="ui--content-box-gallery-image" src="admin/news_slider/<?=$records['image'];?>" alt="" draggable="false"></div>
...
<div class="ui-row row">
<div class="ui-column span12"><div  class="ui--animation-in make--fx--fadein-ltr ui--pass clearfix" data-fx="fx--fadein-ltr" data-delay="400" data-start-delay="0"><h3 class="ui--animation " style=""><strong><?=$getInfoByTableNameAndID['news_title'];?></strong></h3>
<?=$getInfoByTableNameAndID['news_desc'];?>
</div></div> 
...
<div class="ui--tabs ui--tabs-mega clearfix text-left ui--done" style="margin-top: -29px;  margin-bottom: 0px;"><div class="ui--tabs-header ui--accent-gradient ui--accent-color fullwidth-container clearfix"><div class="container"><ul class="ui--tabs-titles clearfix unstyled">

    <li class="first-item active"><h5><a href="#technology">Technology</a></h5></li>
        <li class=""><h5><a href="#mobile-apps">Mobile apps</a></h5></li>
            <li class=""><h5><a href="#monetization">Monetization</a></h5></li>
    <li class="last-item"><h5><a href="#bus-manage">Business Management</a></h5></li>
    </ul></div></div><div class="clearfix"></div>

    <ul class="ui--tabs-contents text-left clearfix"><li class="first-item active"> <div class="ui-row row">
 <div class="ui-column span3"><div class="ui--icon-box position--top"><span class="ui--icon-box-icon ui--animation"><img class="ui--icon" src="images/app.png" alt="" data-at2x="" data-retina-auto="1"></span><div class="ui--icon-box-content ui--animation"><h4 class="ui--icon-box-title ui--animation text-center" data-fx="fx--no-effect"><span> <strong>Sign Up a Subscription Plan</strong></span></h4><div class="ui--animation ui--icon-box-text text-justify" data-fx="fx--no-effect"><p>The content composer will save you tons of time working on the site content. </p>
</div></div></div></div> 


 <div class="ui-column span3"><div class="ui--icon-box position--top"><span class="ui--icon-box-icon ui--animation"><img class="ui--icon" src="images/cog.png" alt="" data-at2x="" data-retina-auto="1"></span><div class="ui--icon-box-content ui--animation"><h4 class="ui--icon-box-title ui--animation text-center" data-fx="fx--no-effect"><span><strong>Select your Dream Online Business</strong></span></h4><div class="ui--animation ui--icon-box-text text-justify" data-fx="fx--no-effect"><p>You can build professional and modern websites with this theme. Control every pixel of the theme. </p>
</div></div></div></div> 

 <div class="ui-column span3"><div class="ui--icon-box position--top"><span class="ui--icon-box-icon ui--animation"><img class="ui--icon" src="images/rulo.png" alt="" data-at2x="" data-retina-auto="1"></span><div class="ui--icon-box-content ui--animation"><h4 class="ui--icon-box-title ui--animation text-center" data-fx="fx--no-effect"><span><strong>Complete your 24 BMC</strong></span></h4><div class="ui--animation ui--icon-box-text text-justify" data-fx="fx--no-effect"><p>Create unlimited visual sets with our new control panel. </p>
</div></div></div></div> 

 <div class="ui-column span3"><div class="ui--icon-box position--top"><span class="ui--icon-box-icon ui--animation"><img class="ui--icon" src="images/resize.png" alt="" data-at2x="" data-retina-auto="1"></span><div class="ui--icon-box-content ui--animation"><h4 class="ui--icon-box-title ui--animation text-center" data-fx="fx--no-effect"><span><strong>Launch Your Online Business</strong></span></h4><div class="ui--animation ui--icon-box-text text-justify" data-fx="fx--no-effect"><p>Envision can automatically adapt to many screen sizes thanks to its responsive capabilities. </p>
</div></div></div></div> 

</div> 
 </li><li class="last-item hidden"> <div class="ui-row row">
