...
<div id="titlebar" class="titlebar-hautq cover">
			<div class="container relative">
				<div id="titlebar-text">
											<h2 id="titlebar-title"><strong>Businesses</strong></h2>
					
											<div class="titlebar-text-content"><p>Features of our ready made online business.</p>
</div>
									</div>
									<div id="titlebar-breadcrumb"><div id="breadcrumb" class="ui--box-alias centerVertical"><div class="ui-bc ui-breadcrumbs breadcrumbs" itemprop="breadcrumb"><span class="ui-bc-first"><a href="http://envision.wptation.com" title="Envision" rel="home" class="ui-bc-first">Home</a></span> <span class="ui-bc-seperator"> <i class="ui--caret fontawesome-angle-right px18"></i> </span> <span class="ui-bc-last">Business</span></div></div></div>
							</div>
		</div><!-- /#titlebar -->
...
<div class="ui-column span5"><div class="ui--image-wrap clearfix" style="margin-top: 40px;  margin-left: -20px;"><img id="ui--image-3" class="ui--image ui--animation" src="images/businesses1.jpg" alt="" title="" data-at2x=""></div></div>
 <div class="ui-column span7">
<h3> Online Businesses</h3>
 <p>HnB-Websites provides completely set up newbie friendly online businesses , these websites are completely out of the box and require absolutely no extra work to run , everything from supplier's to illustrated guides on how to set it up is provided , all our start up businesses are fully online , no offline work from your side is required to run your business</p>
<p><a class="btn btn-large btn-icon-left btn-orange fx--caption-right ui--animation-fire" href="online-business.html" style="" delay="4000">See our online businesses</a></p>
</div> 
...
<div class="ui-row row">
 ...
 <div class="ui-column span7">
<h3> Ready Made Business Websites</h3>
<p>These businesses require no previous experience , technical expertise or web knowledge to run , fully illustrated guides on how to set up the websites and online businesses and how to run them are provided , the websites come fully ready with content , shopping carts and products etc installed</p>
<p><a class="btn btn-large btn-icon-left btn-orange fx--caption-right ui--animation-fire" href="#" style="" delay="4000">View our online business websites</a>

</p>
</div> 

<div class="ui-column span5"><div class="ui--image-wrap clearfix" style="margin-top: 40px;  margin-left: -20px;"><img id="ui--image-3" class="ui--image ui--animation" src="images/ready.png" alt="" title="" data-at2x=""></div></div>
...
<h4>We invite to see the whole list of amazing features&#8230;</h4>

<div class="ui-row row">
 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="400"><i class="ui--icon icomoon-screen-3 icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="600"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>Completely </strong>automatic </span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200">
 <p>No work required , no packaging , shipping , posting etc , all businesses are specially planned to have only online work</p>
</div></div></div></div> 

 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="800"><i class="ui--icon icomoon-cube icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="1000"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>SEO </strong> ready</span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p>We really care about that our pages to be search engine friendly, that is why the template is fully optimized</p>
</div></div></div></div> 

 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="1200"><i class="ui--icon icomoon-mouse icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="1400"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong> Custom header </strong> &amp; logo etc</span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p>
All our business websites have a fully customizable logo and header images(s) , and many more customizable options like colour etc
</p>
</div></div></div></div> 
...
<div class="ui-row row">
 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="400"><i class="ui--icon icomoon-screen-3 icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="600"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>Full setup illustrated </strong> documentation</span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p><h5></h5>
We have created illustrated guides and tutorials to set up a website fully , from the basics to the advanced tutorials
</p>
</div></div></div></div> 

 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="800"><i class="ui--icon icomoon-cube icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="1000"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>asy to</strong> Customize</span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p> 
We put great emphasis on ease of setup and customization , you can find plenty of options in the admin panel aswell as the tutorials
 ...
 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="1200"><i class="ui--icon icomoon-mouse icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="1400"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>Clean and </strong> Modern design</span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p> <h5></h5>
Our online businesses are professionally designed and created to the best quality , clean design is one of our main priorities
</p>
</div></div></div></div> 
...
<div class="ui-row row">
 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="400"><i class="ui--icon icomoon-screen-3 icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="600"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>Out of the box</strong></span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p>
We provide fully ready , monetized online businesses , only requiring customers and marketing , for which we provide info on our blog
 ...
 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="800"><i class="ui--icon icomoon-cube icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="1000"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>Professional designs</strong> </span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p> 
Professional premium design websites , high quality and uniquely created only for the work from home businesses
</p>
</div></div></div></div> 

 <div class="ui-column span4"><div class="ui--icon-box position--left"><span class="ui--icon-box-icon fx--fadein-btt ui--animation-fire" delay="1200"><i class="ui--icon icomoon-mouse icon-inline-block icon-with-background radius-circle" style="font-size: 48px;  width: 52px;  height: 52px;  border-width: 3px;  border-style: solid;"></i></span><div class="ui--icon-box-content fx--fadein-btt ui--animation-fire" delay="1400"><h3 class="ui--icon-box-title text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="0"><span><strong>Healthy profit margins</strong> </span></h3><div class="ui--icon-box-text text-left fx--no-effect ui--animation-fire" data-fx="fx--no-effect" delay="200"><p> We only sell websites which will give you a good return profit , with full business plans documented for you from before !
</p>
</div></div></div></div> 
...
<div class="ui-column span5"><div class="ui--image-wrap clearfix" style="margin-top: 40px;  margin-left: -20px;"><img id="ui--image-3" class="ui--image ui--animation" src="images/monetization-methods.png" alt="" title="" data-at2x=""></div></div>
 <div class="ui-column span7">
<h3> Multiple Monetization Methods</h3>
<p>A number of monetization methods are implemented on our custom made websites to make money , some websites are affiliate based , meaning you will make money for every sale or lead occured through your website , others are service resellers along with dropshipping websites etc</p>
<p><a class="btn btn-large btn-icon-left btn-orange fx--caption-right ui--animation-fire" href="#" style="" delay="4000">See How You Can Make Money</a></p>
</div> 
...
<div class="ui-row row">
 ...
 <div class="ui-column span7">
<h3>Variety Of Niches To Choose From</h3>
<p>Websites and businesses range from iphone unlocking to hotel booking search engines , we have a wide variety of niches available and new ones being tapped into on a regular basis , Flight booking , Car rentals , Hotel search engines , iphone unlocking are just some of the ready made businesses we supply for you to make money from</p>
<p><a class="btn btn-large btn-icon-left btn-orange fx--caption-right ui--animation-fire" href="#" style="" delay="4000">Pick Your Preferred Niche</a></p>
</div> 

<div class="ui-column span5"><div class="ui--image-wrap clearfix" style="margin-top: 40px;  margin-left: -20px;"><img id="ui--image-3" class="ui--image ui--animation" src="images/niches1.png" alt="" title="" data-at2x=""></div></div>
...
<div class="ui-column span5"><div class="ui--image-wrap clearfix" style="margin-top: 40px;  margin-left: -20px;"><img id="ui--image-3" class="ui--image ui--animation" src="images/platforms.png" alt="" title="" data-at2x=""></div></div>

 <div class="ui-column span7">
<h3>Multiple Platforms Used</h3>
<p>Our websites are based on a number of platforms , including the most user friendly and easy to manage WordPress platform , other&#8217;s include static HTML/CSS aswell as Joomla CMS and Magento ot OSCommerce for the e-commerce niche</p>
<p><a class="btn btn-large btn-icon-left btn-orange fx--caption-right ui--animation-fire" href="#" style="" delay="4000">Browse Businesses On Your Favourite Platform</a></p>
</div> 
