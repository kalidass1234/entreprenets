...
font-family: Arial, Helvetica, sans-serif;
				...
				<h5 class="post-title cufon_headings">Upgrade Membership Level 3</h5>
...
{
?>
    <tr class="odd" <?php if($category_two && $row_subs2['months']==1){?>style="background-color:#999900"<?php }?>>
        <td><nobr>Vision Team Network Monthly Membership</nobr></td>
        <td>$29.99</td>
        <td><nobr><strong>$84.98</strong>per Month</nobr></td>		
        <td><p><strong>12 payments</strong> total.<nobr>Membership expires after 1 year.</nobr></p></td>
        <td ><a href="set_amt_duration_upgrade_account.php?amount=29.99&duration=1&category=2" class="link-select">Select</a></td>
    </tr>
    <tr class="even" <?php if($category_two && $row_subs2['months']==3){?>style="background-color:#999900"<?php }?>>
        <td><nobr>Vision Team Network Membership - 3 month option</nobr></td>
        <td>&nbsp;</td>
        <td><nobr><strong>$254.94</strong>every 3 Months</nobr></td>		
        <td><p><strong>12 payments</strong> total.
        <nobr>Membership expires after 1 year.</nobr></p></td>
        <td><a href="set_amt_duration_upgrade_account.php?amount=254.94&duration=3&category=2" class="link-select">Select</a></td>
    </tr>
    <tr class="odd" <?php if($category_two && $row_subs2['months']==6){?>style="background-color:#999900"<?php }?>>
        <td><nobr>Vision Team Network Membership - 6 month option</nobr></td>
        <td>&nbsp;</td>
        <td><nobr><strong>$509.88</strong>every 6 Months</nobr></td>		
        <td><p><strong>12 payments</strong> total.<nobr>Membership expires after 1 year.</nobr></p></td>
        <td><a href="set_amt_duration_upgrade_account.php?amount=509.88&duration=6&category=2" class="link-select">Select</a></td>
    </tr>
    <tr class="even" <?php if($category_two && $row_subs2['months']==12){?>style="background-color:#999900"<?php }?>>
        <td><nobr>Vision Team Network Membership - 12 month option</nobr></td>
        <td>&nbsp;</td>
        <td><nobr><strong>$1,019.76</strong>every 12 Months</nobr></td>		
        <td><p><strong>12 payments</strong> total.<nobr>Membership expires after 1 year.</nobr></p></td>
        <td><a href="set_amt_duration_upgrade_account.php?amount=1019.76&duration=12&category=2" class="link-select">Select</a></td>
    </tr>
 <?php
 }
 else if($category==3)
 ...
 <tr class="odd" <?php if($category_three && $row_subs3['months']==12){?>style="background-color:#999900"<?php }?>>
        ...
        <td><p><strong>12 payments</strong> total.<nobr>Membership expires after 1 year.</nobr></p></td>
        <td ><a href="set_amt_duration_upgrade_account.php?amount=150.00&duration=12&category=3" class="link-select">Select</a></td>
    </tr>
 <?php
 }
 else if($category==1)
