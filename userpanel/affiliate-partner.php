...
<div id="container">
	...
	<div id="content">
		...
		$useridd=$res_user['user_id'];
                ...
                if(($res_user['category_two'] && $count_subs) || $res_user['category_one'])
				{
				?>
         <p align="center"> <br><img src="backend-images/affilate-partner.png" alt="" border="0" /></p>
			<div class="grid_12 full_block">
             ...
             <?php
				...
				{
				?>
                <p>you  are not authorize to access this section.</p>
                <?php
				}
				?>
		</div>
