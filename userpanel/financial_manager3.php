		...
		<div class="grid_12 full_block">
				...
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								<li><a href="#tab1" class="active_tab">TP Wallet History</a></li>
								<li><a href="financial_manager2.php" class="">TP Wallet</a></li>
							</ul>
						</div>
					</div>
					<div class="widget_content">
						...
						<div id="tab1" style="display: none;">
							<div class="oilhold">
   							<form action="match_password.php?tp_history=1" method="post" class="form_container left_label">
							<ul>
								<li>
					 ...
					 <div align="center" style="padding-top:20px;">
					  <input name="raise_ticket" class="btn" type="button"  value="Raise Ticket" onClick="window.location.href='raise-ticket.php'"/>
						...
						<div id="tab2" style="display: none;">
							<div class="oilhold">
   							<form action="match_password.php?tp=1" method="post" class="form_container left_label">
							<ul>
							<li>
								<div class="form_grid_12">
