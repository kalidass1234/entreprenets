...
else
{
	...
	$sqll=mysql_query("select * from final_tfs_history where user_id='$id' and (`receive_date` between '$from_date' and '$end_date') order by id desc");
	$sqql=mysql_query("select * from final_tfs where user_id='$id'");
			...
			<div class="grid_12 full_block">
				<div class="widget_wrap">
					<div class="widget_top">
                        ...
                        <div id="widget_tab">
							<ul>
								<li><a href="#" class="active_tab">TFS Wallet History</a></li>
								<li><a href="financial_manager4.php" >TFS Wallet</a></li>
				...
				<ul id="search_box">
					...
					<div class="widget_content">
						...
						<tfoot>
						<tr>
                        	<td colspan="5" align="center"><strong>Final Balance:<?php echo $final_amount;?>TP</strong></td>
                        </tr>
						</tfoot>
						</table>
					</div>
