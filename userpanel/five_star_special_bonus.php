		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>5 Star Special Bonus Record
                       ...
                       <img src="../images/print.png"  onClick="printDiv('example');">
						...
						$heading.="<td>Date</td><td>Invoice No</td><td>Purchaser Id</td><td>Total Purchased BV</td><td>Commission(%)</td><td>Bonus(BV)</td><td>Bonus(USD)</td><td>TDS(%)</td><td>TDS Amount</td><td>Miscellaneous(%)</td><td>Miscellaneous Amount</td><td>Final Bonus(USD)</td></tr>";
						
						$heading3="Date,Invoice No,Purchaser Id,Total Purchased BV,Commission(%),Bonus(BV),Bonus(USD),TDS(%),TDS Amount,Miscellaneous(%),Miscellaneous Amount,Final Bonus(USD)";
						
						$record = "date,invoice_no,purcheser_id,invoice_bv,com_percent,commission_bv,commission,tds_percent,tds_amount,miscellaneous_percent,miscellaneous_amount,final_amount";
						$table="five_star_special_bonus";
...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
					...
					<div class="widget_content" id="example">
						...
						$sql="SELECT invoice_amt,invoice_no, commission, purcheser_id, remark, level, invoice_amt,status , paid_status, ts,date,user_level,payout_date,com_percent,invoice_bv,commission_bv,tds_percent,tds_amount,miscellaneous_percent,miscellaneous_amount,final_amount FROM `five_star_special_bonus`
