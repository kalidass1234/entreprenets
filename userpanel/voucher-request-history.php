				...
				<div class="grid_12 full_block">
					...
					<div class="widget_wrap tabby">
						<div class="widget_top">
							...
							<h6>Request E-vouchers History</h6>
						...
						<div class="widget_content">
                          ...
                          <?php
                            ...
                            $sql_ref = "select * from pin_request where user_id='$id'";
                            $res_ref = mysql_query ( $sql_ref );
                           
							while ( $direct = mysql_fetch_array ( $res_ref ) ) {
							
							$used_status = array('Pending','Accept');	
						  ?>
						  
							 <tr>
								<td class="center"><?php echo $j;?></td>
								<td class="center">N <?php echo number_format($direct['amount'],2);?></td>
								<td class="center"><?php echo $direct['no_of_pin'];?></td>
								<td class="center"><?php echo date("d-m-Y H:i:s",strtotime($direct['ts']));?></td>
								<td class="center"><a href="userimages/<?php echo $direct['payment_slip'];?>" target="blank">View Slip</a></td>
								
								<td class="center"><?php echo $used_status[$direct['status']];?></td>
								<td class="center"><?php if($direct['status'] == 1): echo date("d-m-Y",strtotime($direct['payment_date'])); else:?> &nbsp; <?php endif; ?> </td>
