		...
		<div class="grid_container">
			<div class="grid_12 full_block">
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								...
								<li><a href="#tab3"  class="active_tab">Sent (<?php echo $count_sent;?>)</a></li>
					...
					$sql_subs="select * from registration where user_id='$user_id' ";
					...
					<div class="widget_content">
						...
						<?php
						  ...
						  $i=1;
						  while($x1=mysql_fetch_array($res_sent))
						  {
						...
						<tr>
							...
							<td class="center tr_select ">
								<a  href="view-message.php?sent=sent&id=<?=$x1['id']?>" title="View"><?=$x1['reciever_name']?> </a>
							</td>
							<td class=" center" >
								<a  href="view-message.php?sent=sent&id=<?=$x1['id']?>" title="View"> <?=$x1['subject']?></a>
							</td>
							<td class="center" style="border-right:none;"><a  href="view-message.php?sent=sent&id=<?=$x1['id']?>" title="View"><?php echo substr($x1['message'],0,20);?></a></td>
							<td class="center">&nbsp;</td>
							<td class="center sdate">
								 <span class=" "><a  href="view-message.php?sent=sent&id=<?=$x1['id']?>" title="View"><?php
								 $curdate=date('Y-m-d');
							...
							<td class="center">
								<span><a class="action-icons c-approve" href="view-message.php?sent=sent&id=<?=$x1['id']?>" title="View">View</a></span>
							</td>
						</tr>
						<?php $i++; } ?>
