...
if(isset($_SESSION) && $_SESSION['adid'])
{
	...
	$package_amount=140.00;
	 ...
	 $str="select * from board_status where upper_id='$id' and package_id = '$package_amount' AND board_number= '$boardN' ORDER BY cell_no ASC LIMIT 1,1 ";
	$res=mysql_query($str);
...
<td align="center" valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
	...
	$quer2="select * from board_status where upper_id='$id' and package_id = '35.00' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 0,1";
...
<td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="text-align:center;">
	...
	$quer2="select * from board_status where upper_id='$id' and package_id = '35.00' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 1,4";
	$data2=mysql_query($quer2);
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   { 
					...
					$quer3="select * from board_status where board_owner_id='".$id."' and package_id = '35.00' AND board_number= '$stage' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 3,6";
    ...
    <span>
          ...
          <tr style="color:#3399FF;">
              <?php
			   for($i=1;$i<=3;$i++)
			   {
				   ...
				   {
					   $userid=$arr3[$i-1][3];
					   $sql_stat="select * from registration where user_id='$userid' and package_amount = '35.00'";
					   $res_stat=mysql_query($sql_stat);
					   $row_stat=mysql_fetch_assoc($res_stat);
	  ...
	  <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="text-align:center;">
			   ...
			   { 
					...
					$quer4="select * from board_status where board_owner_id='".$id."' and package_id = '35.00' AND board_number= '$stage' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 6,9";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   { 
					...
					$quer5="select * from board_status where board_owner_id='".$id."' and package_id = '35.00' AND board_number= '$stage' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 9,12";
