...
<div id="container">
	...
	<div class="grid_12 full_block">
				<div class="widget_wrap">
					...
					<div id="widget_tab">
							<ul>
								<li><a href="financial_manager5.php" >TFS Wallet History</a></li>
								<li><a href="financial_manager4.php" class="active_tab" >TFS Wallet</a></li>
								<!--<li><a href="#tab1" class="active_tab">Available TFS</a></li>-->
					...
					<div class="widget_content">
						...
						<tbody>
						<?php
						    $s="select * from final_tfs where user_id='{$id}'";
							$q_r=mysql_query($s);
			 			 ...
			 			 ?>
							...
							<td>
                                  ...
                                  <td align="center" class="ptext"><?= $x. ' TFS'?></td>
                                </tr>
						</tbody>
						<tfoot>
						</tfoot>
