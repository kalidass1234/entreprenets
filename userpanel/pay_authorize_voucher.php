...
$_SESSION['evoucher']=$_POST['evoucher'];
...
function meberins()
	 {
	  ...
	  $checkid=mysql_query("select order_no from pin_history where order_no='$pre_userid'");
...
$post_values = array(
	...
	"x_amount"			=> $x_amount,
	"x_description"		=> "Purchase Voucher",
...
if($response_array[0]==1)
{
	...
	//echo $insert;exit;
	mysql_query($insert);
	header("Location:create_pin_func_card.php");
