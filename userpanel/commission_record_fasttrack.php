		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					...
					<div class="widget_content">
						...
						$sql="SELECT invoice_amt, commission, purcheser_id, remark, level, invoice_amt,status , paid_status, ts,date,user_level FROM `level_income_faststart`
