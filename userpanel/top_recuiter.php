			...
			<div class="grid_12 full_block">
				...
				<div class="widget_wrap tabby">
					...
					<div class="widget_content">
						...
						<thead>
							...
							<th >Personal PV</th>				  
                              ...
                              <th>Referral PV</th>
                               ...
                               <th >Total No. of Member(Recuit)</th>
                               <th>Join Date</th>
						  ...
						  $str11=mysql_query("select reg_date,concat(first_name,' ',mid_name,' ',last_name) as name,user_name,user_id,(select count(id) from registration where ref_id=r.user_id) as count from registration as r $con_user  order by count desc limit 10");
							$j=1;
							while($direct=mysql_fetch_array($str11))
							{
								$idd=$direct['user_id'];
								$username=$direct['user_name'];
								$count=$direct['count'];
								if($count>0)
								{
							?>
							 <tr>
                              ...
                              <td class="center"><?php echo $direct['name'];?></td>
							<td class="center"><span><?php   $rank = _get_member_rank($username);
						if($rank=='Below Rank')
						{
							echo "Customer";
						}
						...
						?></span></td>  
                  			<td class="center"><?php  echo _get_personal_volume($idd)." PV";?></td>
                              <td class="center"><?php echo _get_referral_volume($idd)." PV";?></td>
                              <td class="center"><?php echo $direct['count'];?></td>
