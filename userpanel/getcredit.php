			...
			<div class="grid_12 full_block">
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								<li><a href="#tab1" class="active_tab">Get Credit</a></li>
								<!--<li><a href="#tab2" class="">Shop Deal Share Bank</a></li>-->
					...
					<div class="widget_content">
						<div id="tab1" style="display: none;">
							<div class="oilhold">
   							<form action="get_credit_pv.php" method="post" class="form_container left_label">
							<ul>
								<li>
