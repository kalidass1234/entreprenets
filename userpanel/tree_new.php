...
$ee=$_REQUEST['id'];
$name=$x1['first_name']." ".$x1['mid_name']." ".$x1['last_name'];

$uid=trim($_REQUEST['id']);

$str="select * from registration where user_id='$uid' and package_amount = '35.00'";
$res=mysql_query($str);
$x=mysql_fetch_array($res);
$uname=$x['user_name'];
$name=$x['first_name']." ".$x['mid_name']." ".$x['last_name'];
...
//echo "select * from registration where user_id='$uid' or user_name='$uid'";
$sql_search=mysql_query("select * from registration where user_id='$uid' or user_name='$uid' and package_amount = '35.00'");

$fetch_search=mysql_fetch_array($sql_search);
$uid=$fetch_search['user_id'];

$data_dwn=array();
showMemX_new($id);

	array_unshift($data_dwn,$id);

$r=count($data_dwn);
//print_r($data_dwn);exit;
if (in_array($uid, $data_dwn))
{
$quer2="select user_id,user_name,plan_name from registration where nom_id='$uid'  and package_amount = '35.00' order by id";
...
<!--                    <tr>
  ...
  if($i<=$ro2){
$d=$arr2[$i-1][0];
$str2="select * from registration where user_id='$d' and package_amount = '35.00'";
...
<a href="tree_new.php?id=<?=$arr2[$i-1][0]?>" class="tooltip1">
        ...
        <strong>
          ...
          <tr style="color:#3399FF;">
			  ...
			  // print_r($arr2[$i-1]);
			   ...
			   $userid=$arr2[$i-1][0];
			   $sql_stat="select mem_status,package_amount from registration where user_id='$userid' and package_amount = '35.00'";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer3="select user_id,user_name,plan_name from registration where nom_id='".$arr2[0][0]."' and package_amount = '35.00' order by id";
...
$ro3=mysql_num_rows($data3);
  ...
  if($i<=$ro3){
$d=$arr3[$i-1][0];
$str3="select * from registration where user_id='$d' and package_amount = '35.00'";
...
if($count_subs1)
{
  ...
  ?>  <td>
<a href="tree_new.php?id=<?=$arr3[$i-1][0]?>" class="tooltip1">
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer4="select user_id,user_name,plan_name from registration where nom_id='".$arr2[1][0]."' and package_amount = '35.00' order by id";
...
$ro4=mysql_num_rows($data4);
  ...
  if($i<=$ro4){
$d=$arr4[$i-1][0];
$str4="select * from registration where user_id='$d' and package_amount = '35.00'";
...
<a href="tree_new.php?id=<?=$arr4[$i-1][0]?>" class="tooltip1">
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer5="select user_id,user_name,plan_name from registration where nom_id='".$arr2[2][0]."' and package_amount = '35.00' order by id";
...
$ro5=mysql_num_rows($data5);
  ...
  if($i<=$ro5){
$d=$arr5[$i-1][0];
$str5="select * from registration where user_id='$d' and package_amount = '35.00'";
...
<a href="tree_new.php?id=<?=$arr5[$i-1][0]?>" class="tooltip1">
...
alert('User Id Not Exist in downline of <?=$id?>');
location.href='matrix_genealogy.php';
</script>
