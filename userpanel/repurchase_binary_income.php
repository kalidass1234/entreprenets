		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Repurchase Binary Income Record
                       ...
                       <img src="../images/print.png"  onClick="printDiv('example');">
						...
						$heading.="<td>Date</td><td>Left Carry Forword</td><td>Right Carry Forword</td><td>Left Match</td><td>Right Match</td><td>Cycle</td><td>Bonus(BV)</td><td>Bonus($)</td><td>TDS(%)</td><td>TDS Amount</td><td>Miscellaneous(%)</td><td>Miscellaneous Amount</td><td>Final Bonus(USD)</td></tr>";
...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
					...
					<div class="widget_content" id="example">
						...
						$sql="SELECT * FROM `repurchase_binary_income`
...
$totc=$totc+$row['final_amount'];
						...
						<td class="center">
								<?php echo date('m/d/Y',strtotime($row['b_date']));?>
						</td>
						
						<td class="center">
								<?php echo $row['carry_fwd_left'];?> 
						</td>
                        <td class="center">
								<?php echo $row['carry_fwd_right'];?> 
						</td>
                        <td class="center">
								<?php echo $row['match_left'];?> 
						</td>
                        <td class="center">
								<?php echo $row['match_right'];?> 
						</td>
                        <td class="center">
								<?php echo $row['income_pair'];?> 
						</td>
                        <td class="center"><?php echo $row['loss_pair'];?></td>
						<!--<td class="center">
								<?php //echo wordwrap($row['remark'],25,"<br>\n");?>
						</td>-->
						<td class="center"><?php echo $row['commission_bv'];?></td>
                        ...
                        <td class="center"><?php if($row['status']==2) echo "Lost"; elseif($row['status']==1) echo "Paid"; else echo "Unpaid";?></td>
						</tr>
						<?php
						$ii++;
						}
