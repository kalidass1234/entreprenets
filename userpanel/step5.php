...
$sql_sel=mysql_query("SELECT * FROM cms_seven WHERE category=5");
		...
		if($answer2==$answer12)
		{
			if($answer3==$answer13)
			{
				if($answer4==$answer14)
				{
					if($answer5==$answer15)
					{
							echo "<script language='javascript'>alert('Congrates You Are Move to Sixth Step.');window.location.href='step6.php';</script>";exit;
					}
					else
					{
						echo "<script language='javascript'>alert('Fifth Answer is wrong.');window.location.href='step5.php';</script>";exit;
					}
				}
				else
				{
					echo "<script language='javascript'>alert('Fourth Answer is wrong.');window.location.href='step5.php';</script>";exit;
				}
			}
			else
			{
				echo "<script language='javascript'>alert('Third Answer is wrong.');window.location.href='step5.php';</script>";exit;
			}
		}
		else
		{
			echo "<script language='javascript'>alert('Second Answer is wrong.');window.location.href='step5.php';</script>";exit;
		}
	}
	else
	{
		echo "<script language='javascript'>alert('First Answer is wrong.');window.location.href='step5.php';</script>";exit;
	}
}
?>
<!DOCTYPE HTML>
