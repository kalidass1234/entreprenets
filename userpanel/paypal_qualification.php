...
<form name="paypal" id="paypal" method="post" action="<?php echo $action_url;?>"><!--https://www.sandbox.paypal.com/cgi-bin/websc-->
    ...
    <input type="hidden" name="item_name_1" value="Qualification MOnthly Subscription"> 
    ...
    <input type="hidden" name="return" value="<?php echo $host_name;?>userpanel/qualification_submit.php?pay_mode=paypal&paypal=1&invoice=<?=$_SESSION['orderno'];?>&userupgrade=true&Session_id=<?php echo $_SESSION['Session_Rand_No'];?>">
