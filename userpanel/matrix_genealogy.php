...
function changehistorys(val){
	...
	if(val!='' && val!='<?=$_SESSION['changehistoryval'];?>'){
	  var con=confirm("Do you want to change Stage?"); 
	  if(con==true){
		document.location.href='matrix_genealogy.php?stage='+val;;
		return true;
	  } else {
		return false;
	  }
...
<div id="container">
    ...
    <?php
		...
		$sql_ref="select * from registration where user_id='$ref_id' and package_amount = '$package_amount'";
