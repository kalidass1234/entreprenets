...
//echo "select * from credit_debit where user_id='$id' and (`receive_date` between '$from_date' and '$end_date') order by id desc";
	$sqll=mysql_query("select * from credit_debit where user_id='$id' and (`receive_date` between '$from_date' and '$end_date') order by id desc");
			...
			<div class="grid_12 full_block">
				<div class="widget_wrap">
					<div class="widget_top">
                        ...
                        <div id="widget_tab">
							<ul>
								<li><a href="#" class="active_tab">Transaction History</a></li>
								<li><a href="financial_manager.php" >Cash Wallet</a></li>
				...
				<ul id="search_box">
					...
					<div class="widget_content">
						...
						<th>
                            ...
                            <th>
								 Amount withdraw or Transferred
							</th>
							<!--<th>
								 BALANCE</th>-->
						 ...
						 ?>
							<tr>
								<td align="center" class="ptext"><?=$ii;?></td>
								  ...
								  <td align="center" class="ptext"><?=$fetch[TranDescription];?></td>
						...
						<tfoot>
						<tr>
                        	<td colspan="5" align="center"><strong>Final Balance:$ <?php echo round($final_amount,2);?></strong></td>
                        </tr>
						</tfoot>
						</table>
					</div>
