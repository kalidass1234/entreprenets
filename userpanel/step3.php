...
$sql_sel=mysql_query("SELECT * FROM cms_seven WHERE category=3");
		...
		if($answer2==$answer12)
		{
			if($answer3==$answer13)
			{
				if($answer4==$answer14)
				{
					if($answer5==$answer15)
					{
							echo "<script language='javascript'>alert('Congrates You Are Move to Fourth Step.');window.location.href='step4.php';</script>";exit;
					}
					else
					{
						echo "<script language='javascript'>alert('Fifth Answer is wrong.');window.location.href='step3.php';</script>";exit;
					}
				}
				else
				{
					echo "<script language='javascript'>alert('Fourth Answer is wrong.');window.location.href='step3.php';</script>";exit;
				}
			}
			else
			{
				echo "<script language='javascript'>alert('Third Answer is wrong.');window.location.href='step3.php';</script>";exit;
			}
		}
		else
		{
			echo "<script language='javascript'>alert('Second Answer is wrong.');window.location.href='step3.php';</script>";exit;
		}
	}
	else
	{
		echo "<script language='javascript'>alert('First Answer is wrong.');window.location.href='step3.php';</script>";exit;
	}
}
?>
<!DOCTYPE HTML>
							...
							<ul>
								...
								<div class="form_grid_12">
									<div class="form_input"><input type="hidden" id="user_id" name="user_id" value="<? echo $id;?>" />
										<button type="button" class="btn_small btn_gray"><span>Next Step</span></button>
									</div>
								</div>
								</li>
							</ul>
