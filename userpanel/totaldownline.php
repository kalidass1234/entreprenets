...
$dir=mysql_query("select * from registration where nom_id='$id' AND package_amount = '35.00' order by id");
...
<div id="container">
    ...
    <?php
		...
		$sql_ref="select * from registration where user_id='$ref_id'  AND package_amount = '35.00'";
						...
						<thead>
                          ...
                          <?php 
							...
							<?php
									...
									{
					$dn=$data_dwn[$i];
		$ss_dn=mysql_query("select * from registration where user_id='$dn' AND package_amount = '35.00' ");
