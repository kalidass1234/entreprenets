...
$sql_user="select * from registration where user_name='$idd'";
			...
			<div class="grid_12 full_block">
				...
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<h6>Request Wallet</h6>
						
					</div>
					<div class="widget_content">
                   	<?php 
					$sql_request="select * from finance_request where user_id='$user_id' and status=0";
					$res_request=mysql_query($sql_request);
					$count_request=mysql_num_rows($res_request);
					if($count_request)
					{
						$row_request=mysql_fetch_assoc($res_request);
						echo "Your Financial Request of the amount :".$row_request['amount']." sent to Admin on Request Date:".$row_request['request_date'];
					}
					else
					{
					?>
						<div id="tab1" >
							<div class="oilhold">
   							<form action="request_wallet_send.php?Session_id=<?php echo $_SESSION['Session_Rand_No'];?>" method="post" class="form_container left_label">
							<ul>
								<li>
								<div class="form_grid_12">
									<label class="field_title">Enter Amount</label>
									<div class="form_input">
										<input name="amount" type="text" tabindex="1" class="" style="width:44%;" />
										<span id="user"></span>
									</div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
									<label class="field_title">Enter Remark</label>
									<div class="form_input">
										<input name="user_remark" type="text" tabindex="1" class="" style="width:44%;" />
										<span id="user"></span>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									<div class="form_input"><input type="hidden" id="user_id" name="user_id" value="<? echo $id;?>" />
										<button type="submit" class="btn_small btn_gray"><span>Send Request</span></button>
									</div>
								</div>
								</li>
							</ul>
