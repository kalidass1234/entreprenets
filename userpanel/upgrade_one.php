...
if(isset($_POST['upgrade_one']) && $_POST['upgrade_one']!='')
{
$arr_one=array('',89.97,179.94,359.88,254.94,509.88,1019.76,150.00);
$arr=explode("_",$_POST['upgrade_one']);
$_SESSION['total_amount_now']=$arr_one[$arr[0]];
$_SESSION['duration']=$arr[1];
$_SESSION['category']=$arr[2];
//print_r($_SESSION); exit;
}
else
{
echo "<script type='text/javascript'>alert('Please Choose A Package'); window.location.href='upgrade_payment_package.php';</script>";
}
function meberins()
{
                  ...
                  <div class="widget_content">
                    <div style="width:85%; margin-left:10%;">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td colspan="6">You Upgrade Your Account </td>
                        ...
                        <tr>
                          ...
                          https://secure.authorize.net/gateway/transact.dll-->
                            ...
                            <input type="hidden" name="x_description" value="Upgrade_One" >
