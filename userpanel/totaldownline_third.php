...
$dir=mysql_query("select * from registration where nom_id='$id' AND package_amount = '140.00' order by id");
						...
						<thead>
                          ...
                          <?php 
							...
							<?php
									...
									{
					$dn=$data_dwn[$i];
		$ss_dn=mysql_query("select * from registration where user_id='$dn'  AND package_amount = '140.00'  ");
