		...
		<div class="grid_12 full_block">
				...
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								<li><a href="financial_manager.php" class="">Transaction History</a></li>
								<li><a href="#tab2" class="active_tab">Cash Wallet</a></li>
					...
					<div class="widget_content">
						...
						<div id="tab1" style="display: none;">
							<div class="oilhold">
   							<form action="tranjaction.php" method="post" class="form_container left_label">
							<ul>
								<li>
					 ...
					 <div align="center" style="padding-top:20px;">
					  <input name="raise_ticket" class="btn" type="button"  value="Raise Ticket" onClick="window.location.href='raise-ticket.php'"/>
						...
						<div id="tab2" style="display: none;">
							<div class="oilhold">
   							<form action="tranjaction_virtual.php" method="post" class="form_container left_label">
							<ul>
							<li>
								<div class="form_grid_12">
