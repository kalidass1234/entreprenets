		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Direct Referrall Bonus Record
...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
					...
					<div class="widget_content" id="example">
						...
						$sql="SELECT invoice_amt,invoice_no, commission, purcheser_id, remark, level, invoice_amt,status , paid_status, ts,date,user_level,payout_date,com_percent,invoice_bv,commission_bv,tds_percent,tds_amount,miscellaneous_percent,miscellaneous_amount,final_amount FROM `direct_referral_bonus`
