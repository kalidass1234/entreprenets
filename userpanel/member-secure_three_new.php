...
function shownext1(path)
{
	...
	if(document.getElementById('other_category1').checked==true)
	{
		var other_category=document.getElementById('other_category1').value;
		//var other_duation=document.getElementById('other_duration').value;
		var other_duation=$('input:radio[name=other_duration]:checked').val();
		post_to_url('total_amount_three.php', {'pin':pin,'return_page':'member-secure_three_new.php','other_category':other_category,'other_duration':other_duation});
	}
	if(document.getElementById('other_category2').checked==true)
	{
		var other_category=document.getElementById('other_category2').value;
		//var other_duation=document.getElementById('other_duration').value;
		var other_duation=$('input:radio[name=other_duration]:checked').val();
		post_to_url('total_amount_three.php', {'pin':pin,'return_page':'member-secure_three_new.php','other_category':other_category,'other_duration':other_duation});
	}
	else
	{
		var other_category='';
		var other_duation='';
		post_to_url(path, {'pin':pin,'return_page':'member-secure_three_new.php','other_category':other_category,'other_duration':other_duation});
	}
		//post_to_url(path, {'pin':pin,'return_page':'member-secure_three_new.php','other_category':other_category});
}
...
var inputtxt=document.getElementById('card_no');
	...
	if(document.getElementById('other_category1').checked==true)
	{
		...
		//var other_duation=document.getElementById('other_duration').value;
		var other_duation=$('input:radio[name=other_duration]:checked').val();
		post_to_url('total_amount_three.php', {'x_first_name':x_first_name,'x_last_name':x_last_name,'exp_year':exp_year,'exp_month':exp_month,'card_type':card_type,'card_no':card_no,'cvv':cvv,'x_address':x_address,'x_city':x_city,'x_state':x_state,'x_zip':x_zip,'x_mobile':x_mobile,'x_email':x_email,'other_category':other_category,'other_duration':other_duation});
	}
	else if(document.getElementById('other_category2').checked==true)
	{
		var other_category=document.getElementById('other_category2').value;
		//var other_duation=document.getElementById('other_duration').value;
		var other_duation=$('input:radio[name=other_duration]:checked').val();
	...
	else
	{
		var other_category='';
		var other_duation='';
		post_to_url(path, {'x_first_name':x_first_name,'x_last_name':x_last_name,'exp_year':exp_year,'exp_month':exp_month,'card_type':card_type,'card_no':card_no,'cvv':cvv,'x_address':x_address,'x_city':x_city,'x_state':x_state,'x_zip':x_zip,'x_mobile':x_mobile,'x_email':x_email,'other_category':other_category,'other_duration':other_duation});
	}
/*post_to_url(path, {'x_first_name':x_first_name,'x_last_name':x_last_name,'exp_year':exp_year,'exp_month':exp_month,'card_type':card_type,'card_no':card_no,'cvv':cvv,'x_address':x_address,'x_city':x_city,'x_state':x_state,'x_zip':x_zip,'x_mobile':x_mobile,'x_email':x_email,'other_category':other_category,'other_duration':other_duation});*/
}
...
<table width="100%" align="center" border="0">
  <tr valign="middle">
   <th height="20" colspan="5" bgcolor="#009395" align="center" class="show_vision_level">MEMBERSHIP LEVEL&nbsp;&nbsp;<a href="payment_option.php"><font size="2" color="#990000" style="float:right;">Change</font></a></th>
  </tr>
  <tr valign="middle">
...
Membership initial registration fee of $150.00 Being a VTN affiliate is great for both you and your visitors. Your visitors get great deals on products from the world's and you get cash for qualifying active pay membership make through your affiliate link! affiliated referral you can have the opportunity to enroll new member and earn a income for referring VTN Services to your friend and family members. This is a referral program only. you will earn a $3.00 dollars each time you refer a friend or family members or anyone else to join and become a active pay member.a membership services provided by the Vision Team Network; and a 24-hour customer service support.
</p>

<p> 
<strong>
The price for membership is $150. every 12 Months. Membership expires after 1 year.
</strong>.  </p>
</td>
    </tr>
...
background: #fff;
color: #777;">
      You can add another membership into your account if you want by clicking on the radio botton</label>
      </td>
    </tr>
    <tr valign="middle">
     <td colspan="5" align="left">&nbsp;</td>
	...
	function checkAll(str)
	{
		...
		if(str==2)
		{
			document.getElementById('other_category1').checked=false;
		}
		
		if(str==1)
		{
			document.getElementById('other_category2').checked=false;
		}
		if ((document.getElementById('other_category1').checked==true) || (document.getElementById('other_category2').checked==true))
			  {
			  document.getElementById('other_category1').disabled=true;
			  document.getElementById('other_category2').disabled=true;
			...
			xmlhttp.onreadystatechange=function()
			  ...
			  if(xmlhttp.readyState==4 && xmlhttp.status==200)
				...
				document.getElementById('other_category1').disabled=false;
			  	document.getElementById('other_category2').disabled=false;
				document.getElementById("show_payment_option").innerHTML=xmlhttp.responseText;
				document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $179.99";
				}
			  }
			xmlhttp.open("GET","ajax_show_payment_option.php?category="+str,true);
			xmlhttp.send();
			  }
			  if((document.getElementById('other_category1').checked==false) && (document.getElementById('other_category2').checked==false))
			  {
			  document.getElementById("show_payment_option").innerHTML='';
			  document.getElementById("show_payment_total").innerHTML="";
			  }
	}
	function showpaymenttotal(drt,cat)
	{
		if(cat==1)
		{
			if(drt==1){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $179.99";}
			if(drt==3){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $239.97";}
			if(drt==6){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $329.94";}
			if(drt==12){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $509.88";}
		}
		if(cat==2)
		{
			if(drt==1){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $179.99";}
			if(drt==3){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $179.99";}
			if(drt==6){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $179.99";}
			if(drt==12){document.getElementById("show_payment_total").innerHTML="Total Amount To Be Paid : $179.99";}
		}
	}
	</script>
     <tr>
...
background: #fff;
color: #777;">
       <input type="checkbox" id="other_category1" name="other_category" onClick="checkAll(this.value)" value="1" />&nbsp;&nbsp; <label for="tos">
       Discount Benifit Members &nbsp;&nbsp;
       <input type="checkbox" id="other_category2" name="other_category" onClick="checkAll(this.value)" value="2" />&nbsp;&nbsp; <label for="tos">
       Discount Benifit Members+Residual Income
       <!--You Can Select Residual Income Registration(Membership Subscription <?php if($_SESSION['duration']==1){?>The price for membership is $29.99 now and then $84.98 per Month for 12 more payments. All Members will be charged  a Administration Fee. Membership expires after 1 year.<?php }?>
<?php if($_SESSION['duration']==3){?>The price for membership is $29.99 now and then $254.94 every 3 Months for 4 more payments. All Member will be charged a Administration Fee. Membership expires after 1 year.<?php }?>
<?php if($_SESSION['duration']==6){?>The price for membership is $29.99 now and then $509.88 every 6 Months for 2 more payments. All Members will be charged a Administration Fee. Membership expires after 1 year.<?php }?>
<?php if($_SESSION['duration']==12){?>The price for membership is $29.99 now and then $1,019.76 every 12 Months. All Members will be charged a Administration Fee. Membership expires after 1 year.<?php }?>)--></label>
      </td>
    </tr>
    <tr valign="middle">
     <td colspan="5" align="left">&nbsp;</td>
     ...
     <tr >
      <td colspan="5" align="center" id="show_payment_option" style="border-left: 1px solid #eee; border-right: 1px solid #eee;
border-bottom: 1px solid #eee;
background: #fff;
color: #777;">
      <!-- <select name="other_duration" id="other_duration">
    ...
    <tr >
      <td colspan="5" align="center" id="show_payment_total" style="border-left: 1px solid #eee; border-right: 1px solid #eee;
border-bottom: 1px solid #eee;
background: #fff;
color: #777;">
...
background: #fff;
color: #777;">
       <!--<input type="radio" id="other_category1" name="other_category" value="1" />&nbsp;&nbsp; <label for="tos">
       Discount Benifit Members-->
       <!--You Can Select Discount Benifit Registration(Membership Subscription <?php if($_SESSION['duration']==1){?>The price for membership is $29.99 per Month for 12 more payments. Membership expires after 1 year.<?php }?>
<?php if($_SESSION['duration']==3){?>The price for membership is $89.97 now and then $89.97 every 3 Months for 3 more payments. Membership expires<?php }?>
...
<?php if($_SESSION['duration']==12){?>The price for membership is $359.88 now and then $359.88 every 12 Months. Membership expires after 1 year.<?php }?>)--></label>
      </td>
    </tr>
    ...
    <tr valign="middle">
     <td colspan="2" align="left"><input type="radio" name="pay_mode" value="credit card" checked onClick="showpayment(this.value)">
       Credit or Debit Card</td>
     <td width="32%">&nbsp;</td>
     <td width="18%" colspan="2" align="left"><input type="radio" name="pay_mode" value="voucher" onClick="showpayment(this.value)">E-Voucher</td>
    </tr>
...
color: #777;">
    ...
    <tr>
      ...
      <td><input type="text" name="x_first_name" id="x_first_name" value="<?php echo $_SESSION['fname'];?>" style="width:50%" /></td>
      
      <td>Last Name<font color="#FF0000">*</font></td>
      <td><input type="text" name="x_last_name" id="x_last_name" value="<?php echo $_SESSION['lname'];?>" /></td>
    </tr>
    
     <tr>
    <td>Address1<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_address" id="x_address" value="<?php echo $_SESSION['address1'];?>" style="width:50%" /></td>
    ...
    <td><input type="text" name="x_city"  style="width:20%;" id="x_city" value="<?php echo $_SESSION['city'];?>" /> <input type="text" name="x_state" id="x_state" value="<?php echo $_SESSION['state'];?>" style="width:15%;" />
     <input type="text" style="width:15%;" name="x_zip" id="x_zip" value="<?php echo $_SESSION['zip'];?>" /></td>
     
    <td>Phone<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_mobile" id="x_mobile" value="<?php echo $_SESSION['mobile'];?>" /></td>
    </tr>
    
    <tr>
    <td>E-mail Address<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_email" id="x_email" style="width:50%" value="<?php echo $_SESSION['email'];?>" /></td>
   
    <td>Confirm E-mail</td>
    <td><input type="text" name="" id="c_x_email" value="<?php echo $_SESSION['email'];?>" /></td>
    </tr>
...
<option value="Discover">Discover</option>
  ...
  <select name="exp_year" id="exp_year" required>
    ...
    <tr>
    <td colspan="4" align="center"><a href="javascript:void(0);" onClick="shownext('pay_authorize_new.php');" class="link-select">Submit & Checkout</a></td>
    </tr>
   </table>
   </div>
...
color: #777; display:none">
    ...
    <tr>
      <td valign="top" colspan="2" align="left"><span>E-Voucher Code<font color="#FF0000">*</font></span></td>
    ...
    <tr>
    <td colspan="4" align="center"><a href="javascript:void(0);" onClick="shownext1('joinnew.php');" class="link-select">Submit & Checkout</a></td>
    </tr>
    </table>
  </div>
  		</div>
