		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Direct Sponsored Bonus Record</h6>
				  </div>
					<div class="widget_content">
						...
						$sql="SELECT invoice_amt, commission, purcheser_id, remark, level, invoice_amt,status , paid_status, ts,date,user_level FROM `level_income_weekly`
WHERE income_id = '$id' and commission_retroactive=0 ORDER BY `ts` DESC";
 //echo $sql;
						$res=mysql_query($sql);
						?>
