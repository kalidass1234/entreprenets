...
<div id="container">
	...
	<div id="content">
		<div class="grid_container">
			<div class="grid_12 full_block">
				<div class="widget_wrap">
					...
					if($res_user['category_one'] || ($res_user['category_two'] && $count_subs) )
					{
					?>
                    <ul id="slideShow"></ul>
        ...
        <script src="vtncard/js/script1.js"></script>	
						<form action="https://visionteamnetwork.benefithub.com/Account/Login?ReturnUrl=%2f" name="addproduct" id="addproduct" method="post" class="form_container left_label" enctype="multipart/form-data">
							<ul>
							
								<li>
<div class="norm_text">
<img class="size-full wp-image-377 alignnone" alt="Benefits Page" src="http://visionteamnetwork.com/Benefits-Page.jpg" width="100%" height="824" />
&nbsp;
<!--<p style="text-align: center;">[button link="https://visionteamnetwork.benefithub.com/Account/Login?ReturnUrl=%2f" text="grey"]Signup Now[/button]</p>-->
								</div>
								</li>
