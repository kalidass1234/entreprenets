...
//echo "SELECT SUM( fuew.amount + flew.amount + fiew.amount ) AS fuew_am FROM funding_e_wallet  fuew INNER JOIN flifejacket_e_wallet flew ON flew.user_id=fuew.user_id INNER JOIN final_e_wallet fiew on fiew.user_id=flew.user_id where fiew.user_id='$userid'";
  ...
  <div id="content">
    ...
    <tr valign="middle">
     <td colspan="5" align="left">You Need to pay amount is $3.99</td>
    </tr>
    <tr valign="middle">
     <td colspan="5" align="left">&nbsp;</td>
    </tr>
     ...
     <td>&nbsp;</td>
     <td colspan="2" align="left"><!--<input type="radio" name="pay_mode" value="final_e_wallet" onClick="showpayment(this.value)">E-Voucher--></td>
    </tr>
...
<option value="Discover">Discover</option>
  ...
  <select name="exp_year" id="exp_year" required>
    ...
    <tr>
    <td colspan="4" align="center"><a href="javascript:void(0);" onClick="shownext('pay_authorize_vtn.php');" class="link-select">Submit & Checkout</a></td>
    </tr>
   </table>
</div>
