...
<table width="100%" align="center" border="0">
  <tr valign="middle">
   <th height="20" colspan="5" bgcolor="#009395" align="center" class="show_vision_level">MEMBERSHIP LEVEL&nbsp;&nbsp;<a href="upgrade_account_category_two.php"><font size="2" color="#990000" style="float:right;">Change</font></a></th>
  </tr>
  <tr valign="middle">
   <td colspan="5" align="center" style="border-right: 1px solid #eee;
border-bottom: 1px solid #eee;
background: #fff;
color: #777; border-left: 1px solid #eee;"><p>You have selected the <strong>Vision Team Network Membership - <?php if($_SESSION['duration']==12){ echo "Yearly Membership Payment";} else if($_SESSION['duration']==1){ echo "Monthly Membership Payment";} else{ echo $_SESSION['duration']." months option Membership level";}?></strong> .</p>
<p>     

<?php if($_SESSION['duration']==1){?>
Membership initial registration fee of $29.99 for access to the full range of membership services provided by the Vision Team Network; including a virtual office, payout, records information services, visa pay-card and 24-hour customer service support. After 30 days, a reoccurring monthly membership fee of $29.99 and $54.99 for your online virtual office a total of 84.98 will be required to maintain and access the full membership services provided by the Vision Team Network online services. 
<?php
}
?>
<?php if($_SESSION['duration']==3){?>
Membership initial registration fee of $29.99 for access to the full range of membership services provided by the Vision Team Network; including a virtual office, payout, records information services, visa pay-card and 24-hour customer service support. After 30 days, a reoccurring quarterly membership fee of $29.99 and $54.99 for your online virtual office a total of $254.94 will be required to maintain and access the full membership services provided by the Vision Team Network online services.
<?php }?>
<?php if($_SESSION['duration']==6){?>
Membership initial registration fee of $29.99 for access to the full range of membership services provided by the Vision Team Network; including a virtual office, payout, records information services, visa pay-card and 24-hour customer service support. After 30 days, a reoccurring six months membership fee of $29.99 and $54.99 for your online virtual office a total of $509.88 will be required to maintain and access the full membership services provided by the Vision Team Network online services.
<?php }?>
<?php if($_SESSION['duration']==12){?>
Membership initial registration fee of $29.99 for access to the full range of membership services provided by the Vision Team Network; including a virtual office, payout, records information services, visa pay-card and 24-hour customer service support. After 30 day's a reoccurring 12 month membership fee of $29.99 and $54.99 for your online virtual office a total of $1,019.76 will be required to maintain and access the full membership services provided by the Vision Team Network online services.
<?php }?>
</p>
...
color: #777;">
   ...
   <?php
   $sql_user="select * from registration where user_name='$_SESSION[SD_User_Name]'";
   $res_user=mysql_query($sql_user);
   $row_user=mysql_fetch_assoc($res_user);
   ?> 
    <tr>
      <td>First Name<font color="#FF0000">*</font></td>
      <td><input type="text" name="x_first_name" id="x_first_name" value="<?php echo $row_user['first_name'];?>" style="width:50%" /></td>
      
      <td>Last Name<font color="#FF0000">*</font></td>
      <td><input type="text" name="x_last_name" id="x_last_name" value="<?php echo $row_user['last_name'];?>" /></td>
    </tr>
    
     <tr>
    <td>Address1<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_address" id="x_address" value="<?php echo $row_user['address1'];?>" style="width:50%" /></td>
    
    <td>Address2<font color="#FF0000">*</font></td>
    <td><input type="text" name="" id="" /></td>
    </tr>
    
    <tr>
    <td>City, State Zip<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_city"  style="width:20%;" id="x_city" value="<?php echo $row_user['city'];?>" /> 
    <input type="text" name="x_state" id="x_state" value="<?php echo $row_user['state'];?>" style="width:15%;" />
     <input type="text" style="width:15%;" name="x_zip" id="x_zip" value="<?php echo $row_user['zip'];?>" /></td>
     
    <td>Phone<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_mobile" id="x_mobile" value="<?php echo $row_user['mobile'];?>" /></td>
    </tr>
    
    <tr>
    <td>E-mail Address<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_email" id="x_email" style="width:50%" value="<?php echo $row_user['email'];?>" /></td>
   
    <td>Confirm E-mail</td>
    <td><input type="text" name="" id="c_x_email" value="<?php echo $row_user['email'];?>" /></td>
    </tr>
...
color: #777; display:none">
    ...
    <tr>
    <td colspan="4" align="center"><a href="javascript:void(0);" onClick="shownext1('check_evoucher_code.php?return_page=member-secure_two_account_upgrade.php');" class="link-select">Submit & Checkout</a></td>
    </tr>
    </table>
  </div>
  		</div>
