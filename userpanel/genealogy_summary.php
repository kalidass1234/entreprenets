			...
			<div class="grid_12 full_block">
				...
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<h6>My Team (Unilevel Team Summary)</h6>
						<!--<div id="widget_tab">
							<ul>
...
<?php 
						...
						$level2=0;
						$level3=0;
                        $sql="select * from registration where ref_id='$id' order by id";
                        $dir=mysql_query($sql);
                        ...
                        while($direct=mysql_fetch_array($dir))
						{
							...
							$level1++;
							$arr[1]=$level1;
							$sql2="select * from registration where ref_id='$direct[user_id]' order by id";
                        	$dir2=mysql_query($sql2);
                        	$dir_count2=mysql_num_rows($dir2);
                        	while($direct2=mysql_fetch_array($dir2))
							{
								$j++;
								$level2++;
								$arr[2]=$level2;
								$sql3="select * from registration where ref_id='$direct2[user_id]' order by id";
								$dir3=mysql_query($sql3);
								$dir_count3=mysql_num_rows($dir3);
								while($direct3=mysql_fetch_array($dir3))
								{
									$j++;
									$level3++;
									$arr[3]=$level3;
...
<tbody>           
        <tr>
          ...
          <td class="center">Total Downlines At Level1</td>
        ...
        <td  class="center">2</td>
          <td class="center">Total Downlines At Level2</td>
        ...
        <td class="center">3</td>
          <td class="center">Total Downlines At Level3</td>
