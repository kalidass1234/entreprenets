...
<div id="container">
	...
	<div class="page_title">
		...
		<h3>Refund To Credit/Debit Card</h3>
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Refund To Credit/Debit Card</h6>
					</div>
					...
					?>
						...
						if($_POST['Show']=='Search')
						{
						$query="SELECT * FROM purchase_cancel where  user_id='$id' and payment_mode='credt_card' and cancel_date BETWEEN '$dt1' and '$dt2' group by invoice_no order by cancel_date desc  ";
						}
						else
						$query=" SELECT * FROM purchase_cancel where  user_id='$id' and payment_mode='credt_card' group by invoice_no order by cancel_date desc    ";
		//echo $query;				
