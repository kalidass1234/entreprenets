...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
				...
				$commission=total_direct_referral_commission($id);
				$commission1=total_upgrade_commission($id);
				$commission2=total_binary_commission($id);
				$commission3=total_five_star_special_commission($id);
				$commission4=total_matching_commission($id);
				$commission5=total_repurchase_commission($id);	
				$commission6=total_repurchase__binary_commission($id);
					
						
						?>
						<table class="display data_tbl" >
                       <?php  $total=$commission+$commission1+$commission2+$commission3+$commission4+$commission5+$commission6; ?>
						<thead>
						<tr>
