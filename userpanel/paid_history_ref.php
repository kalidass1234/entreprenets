          ...
          <strong>UserId:</strong><?php echo $id;?>
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Affiliate Refferal History</h6>
                        <div id="widget_tab">
							<ul>
								<li><a href="paid_history_bonus.php" >Residual/Bonus History</a></li>
								<li><a href="#" class="active_tab">Affiliate History</a></li>
...
else
{
	...
	status , paid_status, ts,date,user_level,payout_date
	FROM `level_income_admin`
	WHERE income_id = '$id'
	AND level <>0 and status=2 and paid_status=2 and (`date` between '$from_date' and '$end_date')
	ORDER BY `ts` DESC";
	//echo $sql;
							$res=mysql_query($sql);
						?>
