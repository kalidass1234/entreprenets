...
$_SESSION['payment_for']="Qualification";
?>
...
<div id="container">
  <div id="header" class="blue_lin">
	...
	<div class="page_title">
		...
		<h3>Qualification Monthly Subscription</h3>
          ...
          <div class="grid_12">
            <div class="widget_wrap tabby">
              <div class="widget_top">
                <h6>Qualification Monthly Subscription</h6>
              </div>
                    ...
                    <div style="width:85%; margin-left:10%;">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       ...
                       <tr>
                        ...
                        <tr>
                          <td colspan="2"><!--<img src="../paymentimage/BANKWIRE.png" style="cursor:pointer" onClick="setLocation('bank_wire_qualification.php?userupgrade=true&Session_id=<?php echo $_SESSION['Session_Rand_No'];?>');">--></td>
                          <td colspan="2"><img src="../paymentimage/payPal.png" style="cursor:pointer" onClick="setLocation('paypal_qualification.php?userupgrade=true&Session_id=<?php echo $_SESSION['Session_Rand_No'];?>');"></td>
                          <td colspan="2"><img src="../paymentimage/sponser.png" style="cursor:pointer" onClick="setLocation('cash_wallet_qualification.php?userupgrade=true&Session_id=<?php echo $_SESSION['Session_Rand_No'];?>');"></td>
                        </tr>
                        <tr>
                          <td colspan="6">&nbsp;</td>
                        </tr>
