...
<div id="container">
    ...
    <?php
		...
		$sql_ref="select * from registration where user_id='$ref_id' and package_amount = '140.00'";
	...
	<div id="content">
        ...
        <tbody>
		 <form action="tree_new_third.php?id=<?=$_POST[id];?>" method="get">
									<tr>
...
$quer2="select user_id,user_name,plan_name from registration where nom_id_140='".$xok['user_id']."' and package_amount = '140.00' order by id";
...
if($count_subs1)
{
  ...
  ?>  <td>
  <a href="tree_new_third.php?id=<?=$arr2[$i-1][0]?>" class="tooltip1">
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer3="select user_id,user_name,plan_name from registration where nom_id_140='".$arr2[0][0]."' and package_amount = '140.00' order by id";
...
if($count_subs1)
{
  ...
  <a href="tree_new_third.php?id=<?=$arr3[$i-1][0]?>" class="tooltip1">
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer4="select user_id,user_name,plan_name from registration where nom_id_140='".$arr2[1][0]."' and package_amount = '140.00' order by id";
...
if($count_subs1)
{
  ...
  <a href="tree_new_third.php?id=<?=$arr4[$i-1][0]?>" class="tooltip1">
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer5="select user_id,user_name,plan_name from registration where nom_id_140='".$arr2[2][0]."' and package_amount = '140.00' order by id";
...
if($count_subs1)
{
  ...
  <a href="tree_new_third.php?id=<?=$arr5[$i-1][0]?>" class="tooltip1">
