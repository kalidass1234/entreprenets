		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					...
					<div class="widget_content">
						...
						$sql="SELECT * FROM `binary_income`
WHERE user_id = '$id' and status in(0,1) ORDER BY `id` DESC";
 //echo $sql;
						$res=mysql_query($sql);
						?>
...
$totc=$totc+$row['commission'];
						...
						<td class="center">TP<?php echo $row['commission'];?></td>
