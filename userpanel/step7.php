...
$sql_sel=mysql_query("SELECT * FROM cms_seven WHERE category=7");
		...
		if($answer2==$answer12)
		{
			if($answer3==$answer13)
			{
				if($answer4==$answer14)
				{
					if($answer5==$answer15)
					{
							echo "<script language='javascript'>alert('Congrates, You Start Again.');window.location.href='step1.php';</script>";exit;
					}
					else
					{
						echo "<script language='javascript'>alert('Fifth Answer is wrong.');window.location.href='step7.php';</script>";exit;
					}
				}
				else
				{
					echo "<script language='javascript'>alert('Fourth Answer is wrong.');window.location.href='step7.php';</script>";exit;
				}
			}
			else
			{
				echo "<script language='javascript'>alert('Third Answer is wrong.');window.location.href='step7.php';</script>";exit;
			}
		}
		else
		{
			echo "<script language='javascript'>alert('Second Answer is wrong.');window.location.href='step7.php';</script>";exit;
		}
	}
	else
	{
		echo "<script language='javascript'>alert('First Answer is wrong.');window.location.href='step7.php';</script>";exit;
	}
}							
?>
<!DOCTYPE HTML>
						...
						<div class="oilhold">
							...
							<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										Finish ............<br><br><button type="submit" name="submit" class="btn_small btn_gray"><span>Start Again</span></button>
									</div>
								</div>
								</li>
							</ul>
