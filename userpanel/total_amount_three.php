...
if($other_category==2)
{
	...
	if($_SESSION['other_duration']==3){/*$_SESSION['other_amount']=254.94;*/$_SESSION['other_amount']=29.99;}
	if($_SESSION['other_duration']==6){/*$_SESSION['other_amount']=509.88;*/$_SESSION['other_amount']=29.99;}
	if($_SESSION['other_duration']==12){/*$_SESSION['other_amount']=1019.76;*/$_SESSION['other_amount']=29.99;}
}
if($other_category==1)
{
	if($_SESSION['other_duration']==1){$_SESSION['other_amount']=29.99;}
        ...
        border-color: gray; width:100%;">
            ...
            border-color: inherit;">
                <tr>
                  ...
                  <th class="show_vision_level">Description Package</th>
            ...
            <tr class="even">
                    <td align="center" colspan="4"><input type="button" name="Back" onClick="javascript:window.location.href='member-secure_three_new.php'" value="Back">&nbsp;&nbsp;<input type="submit" name="submit" value="Proceed"></td>
                </tr>
            </tbody>
