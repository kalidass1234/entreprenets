...
$res_reg=mysql_fetch_array(mysql_query("SELECT email FROM registration WHERE user_name='$add_by'"));
 ...
 {	
		...
		$id=$_POST['id'];
		 ...
		 {
		 	$update="update latest_news set heading='$heading',page_content='$message' where id='$_POST[id]'";
			mysql_query($update);
		 }
		 else
		 {
		 	$insert="insert into latest_news set heading='$heading',page_content='$message',add_date='$add_date',page_name='$user_id'";
			mysql_query($insert);
			$id=mysql_insert_id();
		 }
		if(isset($_FILES['attachment']))
		{
			...
			$update="update latest_news set page_image='$file_name' where id='$id'";
			mysql_query($update);
		}
	}
}
				...
				<div class="widget_wrap">
					...
					<div class="widget_content" >
						<div class="oilhold">
							...
							<?php
                            $sql="select * from latest_news where id='$_REQUEST[id]'";
							$res=mysql_query($sql);
							$row=mysql_fetch_assoc($res);
							?>
								<li >
								<div class="form_grid_12">
									<label class="field_title" >Heading</label>
									<div class="form_input" >
										<input name="heading" type="text" tabindex="4" value="<?php echo $row['heading'];?>" style="width:44%;" />
									</div>
								</div>
								</li>
								<!--<li>
								...
								<li>
									<div class="form_grid_12">
                                        <label class="field_title" >News</label>
                                        <div class="form_input" >
                                ...
                                <li>
									<div class="form_grid_12">
									<label class="field_title" >Logo</label>
									<div class="form_input" >
