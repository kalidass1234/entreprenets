...
<input type="hidden" name="item_name_1" value="Load Cash Wallet"> 
<input type="hidden" name="amount_1" value="<?php echo $_SESSION['amount'];?>">
<input type="hidden" name="item_name_2" value="Admin Charge"> 
<input type="hidden" name="amount_2" value="<?php echo $_SESSION['amount']*5/100;?>">  
<input type="hidden" name="currency_code" value="USD">
<input type="hidden" name="return" value="<?php echo $host_name;?>userpanel/load_wallet.php?pay_mode=paypal&paypal=1&invoice=<?=$_SESSION['orderno'];?>&userupgrade=true&Session_id=<?php echo $_SESSION['Session_Rand_No'];?>">
