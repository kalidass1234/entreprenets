...
color: #777;">
 ...
 <?php
   ...
   ?>   
    ...
    <td><input type="text" name="x_city"  style="width:20%;" id="x_city" value="<?php echo $row_user['city'];?>" /> <input type="text" name="x_state" id="x_state" value="<?php echo $row_user['state'];?>" style="width:15%;" />
     <input type="text" style="width:15%;" name="x_zip" id="x_zip" value="<?php echo $row_user['mobile'];?>" /></td>
     
    <td>Phone<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_mobile" id="x_mobile" value="<?php echo $row_user['email'];?>" /></td>
    </tr>
    
    <tr>
    <td>E-mail Address<font color="#FF0000">*</font></td>
    <td><input type="text" name="x_email" id="x_email" value="<?php echo $row_user['email'];?>" style="width:50%" /></td>
