...
<table width="100%" align="center" border="0">
  <tr valign="middle">
   <th height="20" colspan="5" bgcolor="#009395" align="center" class="show_vision_level">MEMBERSHIP LEVEL&nbsp;&nbsp;<a href="upgrade_package.php?category=<?php echo $_SESSION['category'];?>"><font size="2" color="#990000" style="float:right;">Change</font></a></th>
  </tr>
  <tr valign="middle">
...
<?php if($_SESSION['duration']==3){?>The price for membership is $29.99 now and then $254.94 each 3 Months for 4 more payments. All Member will be charged a Administration Fee. Membership expires after 1 year.<?php }?>
<?php if($_SESSION['duration']==6){?>The price for membership is $29.99 now and then $509.88 each 6 Months for 2 more payments. All Members will be charged a Administration Fee. Membership expires after 1 year.<?php }?>
<?php if($_SESSION['duration']==12){?>The price for membership is $29.99 now and then $1,019.76 each 12 Months. All Members will be charged a Administration Fee. Membership expires after 1 year.<?php }?>
</strong>.  </p>
</td>
    </tr>
...
color: #777;">
    ...
    <tr valign="middle">
     <td colspan="4" align="left"><?php if($penalty){ echo $penalty." Fee for payment decline or late payment.";}?></td>
    </tr>
    ...
    <td><input type="text" name="x_city"  style="width:20%;" id="x_city" /> <input type="text" name="x_state" id="x_state" style="width:15%;" />
     <input type="text" style="width:15%;" name="x_zip" id="x_zip" /></td>
    ...
    <td><input type="text" name="" id="c_x_email" /></td>
    </tr>
...
<option value="Discover">Discover</option>
  ...
  <select name="exp_year" id="exp_year" required>
    ...
    <tr>
    <td colspan="4" align="center"><a href="javascript:void(0);" onClick="shownext('pay_authorize.php');" class="link-select">Submit & Checkout</a></td>
    </tr>
   </table>
   </div>
...
color: #777; display:none">
    ...
    <tr>
    <td colspan="4" align="center"><a href="javascript:void(0);" onClick="shownext1('check_user_evoucher_code.php');" class="link-select">Submit & Checkout</a></td>
    </tr>
    </table>
  </div>
  		</div>
