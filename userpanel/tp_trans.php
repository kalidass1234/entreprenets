				...
				<div class="widget_wrap">
					...
					<div id="widget_tab">
							<ul>
								...
								<li><a href="#tab2" class="active_tab">Transfer To User</a></li>
			 			 ...
			 			 ?>
							...
							<li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <?php
                                    $sql_b="select * from benificiery where user_id='$id' and type='tp_wallet'";
									...
									?>
                                        ...
                                        <select name="loginid" onChange="checkUser(this.value,'fundtransfer');" required style="width:44%; height:22%;">
                                        ...
                                        while($row_b=mysql_fetch_assoc($res_b))
										{
											...
											//$sql_user="select ";
											?>
											<option value="<?php echo $row_b['member_id'];?>"><?php echo showusername($row_b['member_id']);?></option>
											<?php
										}
										?>
                                        </select>
                                        &nbsp;
                                        <a href="add_mem.php?type=tp_wallet">Add Members To Fund Transfer</a>
								...
								<div class="form_grid_12">
									<div class="form_input">
                                    <input type="hidden" name="action" value="tp_tranfer_user">
										<button type="submit" class="btn_small btn_gray"><span>Send</span></button>
