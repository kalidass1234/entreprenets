		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Sponsorship Bonus Details
                        
                         <span style="margin-left:600px; "> <a href="exportSponserShip.php">Export</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void();" onclick="coderHakan()">Print</a>
...
<script>function coderHakan(){var sayfa = window.open('','','width=800,height=800');sayfa.document.open("text/html");sayfa.document.write(document.getElementById('printArea').innerHTML);sayfa.document.close();sayfa.print();
					...
					<div class="widget_content" id="example">
						...
						$sql="SELECT * FROM binary_income WHERE income_id = '$id' AND bonus_name='3' ORDER BY id DESC";
 //echo $sql;
						$res=mysql_query($sql);
						?>
						...
						while($row=mysql_fetch_assoc($res))
						{
							...
							$selects = mysql_fetch_array(mysql_query("SELECT * FROM registration WHERE user_id='".$row['income_id']."'"));
...
$totc=$totc+$row['final_amount'];
                    ...
                    <td><?php echo $selects["user_name"];?></td>
                    <td><?php echo $row['purchaser_id'];?></td>
                    <td><?php echo $select['user_name'];?></td>
                    <td><?php echo $selectP['package_name']."-".$selectP['total_price'];?></td>
                    <td><?php echo $row['commission']*10/100;?></td>
                    <td><?php echo $row['commission']*5/100;?></td>
                    <td><?php echo $row['commission']*5/100;?></td>
