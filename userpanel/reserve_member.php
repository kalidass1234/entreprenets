                          ...
                          <?php 
							...
							?>
							 <tr>
                              ...
                              <td class="center"><?php echo $direct['member_id'];?></td>
							  <td class="center"><?php echo showusername($direct['member_id']);?></td>
							  <td class="center"><?php echo $status;?></td>  
                  			  <td class="center"><?php echo showusername($direct['receiver_id']);?></td>
                              <td class="center"><?php echo showusername($direct['sender_id']);?></td>
                              <td class="center"><?php echo date('m-d-Y',strtotime($direct['add_date']));?></td>
                            </tr>
                            <?php
							$j++;
							}
