                ...
                <div class="grid_12 full_block">
                    <div class="widget_wrap">
                        <div class="widget_top">
                            ...
                            <div id="widget_tab">
                                <ul>
                                    <li><a href="#" class="active_tab">Online business</a></li>
                                    <li><a href="myebusiness-offline.php" >Offline business</a></li>
                        ...
                        <div class="widget_content">
                            <ul id="search_box">
                            <li>
                                <a href="../online-business.php" target="_blank">Click here to select online business</a>
                            </li>
                            </ul>
                        </div>
                        ...
                        <div class="widget_content">
                            ...
                            <table class="display data_tbl">
                                ...
                                <tbody>
                                    <?php
                                    $sqll = mysql_query("SELECT p.* FROM user_project up LEFT JOIN manage_projects p ON p.id=up.project_id WHERE p.project_type=2 AND up.user_id='".$user_id."' AND up.status=1 AND p.display_status=1");
                                    $ii = 0;
