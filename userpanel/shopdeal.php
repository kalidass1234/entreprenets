	...
	<div class="grid_12 full_block">
				<div class="widget_wrap">
					...
					<div id="widget_tab">
							<ul>
							<?php
                            _get_withdraw_config_list('shopdeal.php');
							?>
								...
								<li><a href="#tab5" class="active_tab"> Payout To Paypal</a></li>-->
					...
					<?php
                      if(_get_withdraw_config('shopdeal.php')):
					?>
						<div id="tab5">
							
							<div class="oilhold">
   							<form action="request_func.php?id=shopdeal" method="post" class="form_container left_label">
							<?php
						 ...
						 <?php 
							...
							<li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="shopdeal_name" type="text" tabindex="1" value="<?php echo $rowuser['first_name'].' '.$rowuser['last_name'];?>" style="width:44%;"  />
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title">Paypal Email Address</label>
									<div class="form_input">
										<input name="shopdeal_email" type="text" tabindex="1" value="<?php echo $rowuser['paypal_account'];?>" style="width:44%;" />
