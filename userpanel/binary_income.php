		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Binary Bonus Details 
                        
                         <span style="margin-left:600px; "> <a href="exportBinaryBonus.php">Export</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void();" onclick="coderHakan()">Print</a>
...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
					...
					<div class="widget_content" id="example">
						...
						//$sql="select * from binary_income where income_id='$id' and level<>0 order by id desc";
						$sql="SELECT * FROM binary_income WHERE income_id = '$id' AND bonus_name='1' ORDER BY id DESC";
 //echo $sql;
						$res=mysql_query($sql);
						?>
...
<!--						<td class="center">	<?php echo $row['carry_fwd_left'];?> </td>
                        <td class="center">	<?php echo $row['carry_fwd_right'];?> </td>-->
                        <td class="center"> <?php echo $row['income_pair'];?> </td>
