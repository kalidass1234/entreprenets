		...
		<form id="form1" name="form1" method="get" action="" enctype="multipart/form-data" >
	  	<div class="grid_4">
				<div class="widget_wrap">
					...
					$sql_user=mysql_query("select * from registration where user_id='$user_id'");
					$res_user=mysql_fetch_assoc($sql_user);
					if($res_user['category_two'] || $res_user['category_one'])
					{
					?>
						<h3>
		...
		
		{
			  $sss="select * from product_category p inner join category_shop  c on p.cat_id=c.c_id where p.allow_deal=0 and  p.cat_id='$_GET[cid]' and p.status=0 order by p.p_cat_id desc "; 
                            ...
                            <form method="post" action="cart.php">
                                ...
                                <br>
                                <br>
                                <span style="color:#000; font-size:12px;">&nbsp;<strong>Quantity:</strong><input type="text" name="quantity" required ></span>
                                <br>
                                <br>
