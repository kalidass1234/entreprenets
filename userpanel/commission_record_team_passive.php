		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Team Passive Bonus Record</h6>
				  </div>
					<div class="widget_content">
						...
						$sql="SELECT invoice_amt, commission, purcheser_id, remark, level, invoice_amt,status , paid_status, ts,date,user_level FROM `level_income_team_passive`
WHERE income_id = '$id' ORDER BY `ts` DESC";
 //echo $sql;
						...
						<td class="center"><?php echo $row['commission'];?>&nbsp;USD</td>
