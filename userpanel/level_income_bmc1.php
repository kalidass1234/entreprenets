		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					...
					<div class="widget_content">
						...
						$sql="SELECT * FROM level_income WHERE income_id = '$id' AND package_id='14' ORDER BY l_id DESC";
 //echo $sql;
						$res=mysql_query($sql);
						?>
<div style="width:96%; " id="printArea">
						...
						<td class="center">
								<?php echo date('m/d/Y',strtotime($row['l_date']));?>
						</td>
						<td class="center">
								<?php echo $row['purchaser_id'];?> 
						</td>
						<td class="center">
								<?php echo showusername($row['purchaser_id']);?> 
						</td>
						<td class="center">
						...
						<tfoot>
						<tr>
							<th><a href="exportBMC1.php?userId=<?=$id;?>">Export Record</a></th>
							<th><a href="javascript:void();" onclick="coderHakan()">Print</a></th>
							<th>&nbsp;</th>
							<th>Total</th>
							<th>&nbsp;</th>
							<th><?php echo $totc;?></th>
