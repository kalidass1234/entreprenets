			 			 ...
			 			 ?>
							...
							<li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <?php
                                    $sql_b="select * from benificiery where user_id='$id' and type='cash_wallet'";
									...
									?>
                                        ...
                                        &nbsp;
                                        <a href="add_mem.php?type=cash_wallet">Add Members To Fund Transfer</a>
								...
								<li>
								<div class="form_grid_12">
									<div class="form_input"><input type="hidden" name="action" value="fund_tranfer_user">
