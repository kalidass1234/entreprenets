      ...
      <div class="grid_12 full_block">
        <div class="widget_wrap">
          <div class="widget_top"> <span class="h_icon blocks_images"></span>
                <h6>HISTORY SUMMARY REPORT </h6>
            <div id="widget_tab">
							<ul>
								<li><a href="financial_manager_view.php" >Transaction History</a></li>
								<li><a href="active_reprot.php">Active Status Report</a></li>
                                <li><a href="#"  class="active_tab">History Summary Report</a></li>
...
{
	$sql_affiliate="select * from $table where income_id='$user_id' and status=2 and paid_status=2 and closing='$closing_no'";
...
{
	$sql_affiliate1="select sum(commission) as total_b_com from $table where income_id='$user_id' and status=2 and paid_status=2 and closing='$closing_no'";
...
if(isset($_POST['submit']) && $_POST['year']!='')
{
	$year=$_POST['year'];
	$months=$_POST['months'];
	$closing_date=date("$year-$months-01");
	$closing_date1=date("$year-$months-t");
	$condition=" and closing_date>'$closing_date 00:00:00' and closing_date<'$closing_date1 23:59:59'";
}
else
{
	$closing_date=date("Y-m-01");
	$closing_date1=date("Y-m-t");
	$condition=" and closing_date>'$closing_date 00:00:00' and closing_date<'$closing_date1 23:59:59'";
}


$sql_closing="select * from closing where status=0 $condition order by id desc";
...
<!--<p>
	...
	{
	?>
    <a href="history_summary_report.php?months=<?php echo $i;?>" ><?php echo $arr_months[$i];?></a>&nbsp;&nbsp;&nbsp;&nbsp;
    <?php
	}
	?>
    <br>
...
?>            
              <thead>
                <tr>
                  ...
                  <th>  PAID DATE:
                    <?php  echo date('m/d/Y',strtotime($row_closing['closing_date']));?>
                  </th>
                  <th>&nbsp; </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  <td align="center" class="ptext">$<?php echo $total_r_com;?></td>
                  <td align="center" class="ptext">$<?php echo $total_a_com;?></td>
                  <td align="center" class="ptext">$<?php echo $total_g_com;?></td>
                  <td align="center" class="ptext">$<?php echo $total_r_com+$total_a_com+$total_g_com;?></td>
                </tr>
              </tbody>
              <tfoot>
                <tr>
                  ...
                  <td align="center" class="ptext">&nbsp;</td>
                  <td align="center" class="ptext">&nbsp;</td>
                  <td align="center" class="ptext"><strong>PAID</strong></td>
                </tr>
              </tfoot>
<?php
}
...
<thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center" class="ptext">$<?php echo $total_a_com;?></td>
                  <td align="center" class="ptext">&nbsp;</td>
                  <td align="center" class="ptext">$<?php echo $total_r_com+$total_a_com;?></td>
                </tr>
              </tbody>
              <tfoot>
                <tr>
