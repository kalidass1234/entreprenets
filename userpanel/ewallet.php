...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
					...
					<div class="widget_content" id="example">
						...
						$sql="SELECT * FROM credit_debit WHERE user_id = '$id' ORDER BY id DESC";
 //echo $sql;
						$res=mysql_query($sql);
						?>
						...
						{
							$totc=$totc+$row['credit_amt'];
						?>
						<tr>
							<td class="center">	<?php echo $ii;?> </td>
							<td class="center">	<?php echo date('m/d/Y',strtotime($row['receive_date']));?></td>
							<td class="center"><?php echo $row['credit_amt'];?></td>
                      	</tr>
						<?php
						$ii++;
						}
