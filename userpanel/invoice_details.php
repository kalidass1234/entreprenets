			...
			<html>
				...
				<body>
 						<table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' id='printArea'>
								<tr>
								<td width='457' height='100' valign='top'><img src='$host_name/images/trinity-logo.gif' width='350' height='100' /></td>
								<td width='343' align='left' valign='middle'>
								The Trinity Wealth Vision Group LTD<br />
								145-157 ST JOHN STREET<br />
								LONDON ENGLAND EC1V 4PW.<br>
								Tel : +44 (0) 7450874013 <br />
								email: info@trinityresell.com</td>
								</tr>
								<tr>
								<td colspan='2'></td>
								</tr>
								...
								<tr>
								<td colspan='5' align='right' valign='top'>Shipping</td>
								<td align='right' valign='top'><strong>$totalshipping</strong></td>
								</tr>
								<tr>
								<td colspan='5' align='right' valign='top'>tax</td>
								<td align='right' valign='top'><strong>".round($totaltax,2)."</strong></td>
								</tr>
								
								<tr>
								<td colspan='5' align='right' valign='top'>Discount</td>
								<td align='right' valign='top'><strong>$totaldiscount</strong></td>
								</tr>
								
								<tr>
								<td colspan='5' align='right' valign='top'>Grand Total </td>
								<td align='right' valign='top'><strong>$ ".round(($tot-$totaldiscount+$totalshipping+$totaltax),2)."</strong></td>
								</tr>
								</table></td>
								</tr>";
      ...
      case "9": return "nine";  
								...
								<tr>
								  <td height='80' valign='bottom'><hr align='left' width='300' />
									  <strong>Trinity Sales Group</strong></td>
