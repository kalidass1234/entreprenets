		...
		<div class="grid_container">
			<div class="grid_12 full_block">
				<div class="widget_wrap tabby">
					...
					<?php
						$id=$_GET['id'];
						$sql_sel=mysql_query("SELECT * FROM promo WHERE n_id=$id");
						...
						<div class="oilhold">
							...
							<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<?php echo strip_tags($res_sel['description'], '<p><a><strong><br>'); ?>
									</div>
								</div>
								</li>
                                 ...
                                 <li>
								<div class="form_grid_12">
									<label class="field_title">Posted Date</label>
									<div class="form_input">
										<?= $res_sel[n_date] ?>
									</div>
								</div>
								...
								<div class="form_grid_12">
									<div class="form_input"><input type="hidden" id="user_id" name="user_id" value="<? echo $id;?>" />
										...
										<a href="index.php"><button type="button" class="btn_small btn_gray"><span>Back</span></button></a>
									</div>
								</div>
								</li>
							</ul>
