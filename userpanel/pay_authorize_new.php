...
//$_SESSION['amount']=0.1;
$x_amount=$_SESSION['amount']+$_SESSION['other_amount'];
...
//echo $row_master['username']."___________".$row_master['account']."____".$post_url;exit;
//$post_url = "https://test.authorize.net/gateway/transact.dll";
$post_values = array(
...
if($response_array[0]==1)
{
	...
	$_SESSION['total_price']=$_SESSION['amount']+$_SESSION['other_amount'];
	...
	?>
<script>window.location.href='joinnew.php';</script>
<?php
	//header("Location:joinnew.php");
