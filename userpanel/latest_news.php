			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Latest News</h6>
                        <h6><a href="add_latest_news.php">Add Latest News</a></h6>
					</div>
					...
					?>
						...
						<?
						$sql="select * from latest_news where page_name='$user_id'";
		//echo $query;				
					...
					?>
						<tr>
							...
							<td class="center sdate">
								 <?=substr(strip_tags($noticia['page_content']),0,100);?>
							</td>
							<td class="center">
								<!--<span class="badge_style b_done">--><a href="latest_news_detail.php?id=<?=$noticia[id]; ?>">View Detail</a><!--</span>-->
							</td>
							
							<td class="center">
								<!--<span class="badge_style b_high">--><div class="btn_30_light">
										<a href="add_latest_news.php?id=<?=$noticia[id]; ?>" title="Edit latest_news">Edit</a>
									</div><!--</span>-->
							</td>
						</tr>
