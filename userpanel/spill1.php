...
if(isset($_SESSION) && $_SESSION['SD_User_Name'])
{
	...
	$dir=mysql_query("select * from reserve_member where receiver_id='$id' and status=0 order by id");
...
<div id="container">
	...
	<div id="content">
		<div class="grid_container">
          ...
          <p> <p>Note: you must use your slip over before the end of each month otherwise it will transfer automatic.</p></p>
				<div class="widget_wrap tabby">
					<div class="widget_top">
						<span class="h_icon list"></span>
						<h6>Reserve Member</h6>
					...
					<div class="widget_content">
                        ...
                        <form name="" action="spill1_submit.php" method="post">
                            ...
                            <tr>
                            <th width="6%" >S.No.</th>
                            <th width="4%" ><input type="checkbox" name="checkbox" value="checkbox"></th>
                            <th width="18%" >User ID</th>
                            <th width="20%" >Username</th>
                            <th width="17%" >Status</th>
                            <th width="13%" >Receiver Id</th>				  
                            <th width="11%">Sender Id</th>
                            <th width="11%">Join Date</th>
                            </tr>
							...
							{
							if($direct[status]=='0'){$status='Active';} else{$status='Pending';}
							...
							?>
							 <tr>
                              ...
                              <td class="center" align="center"><input type="checkbox" name="members[]" value="<?php echo $direct['id'];?>"></td>
                  ...
                  <td class="center" align="center"><?php echo showusername($direct['receiver_id']);?></td>
                              ...
                              <td class="center" align="center"><?php echo date('m-d-Y',strtotime($direct['add_date']));?></td>
                            </tr>
                            <?php
							$j++;
							}
                            ...
                            <th >&nbsp;</th>
                            <th >&nbsp;</th>
                            <th align="right">Transfer User Id:</th>
                            <th align="left"><input type="text" name="username" style="height:24px;"></th>
                            <th align="left"><button type="submit" name="submit" class="btn_small btn_blue"><span>SUBMIT</span></button></th>
                            <th >&nbsp;</th>				  
                            <th>&nbsp;</th>
                            <th>&nbsp;</th>
                            </tr>
