...
<div id="container">
	...
	<div id="content">
			...
			<div class="grid_12 full_block">
				...
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								<li><a href="genealogy11.php" class="">Summary</a></li>
								<li><a href="#tab2" class="active_tab">Total Downlines</a></li>
								<li><a href="genealogydoenline.php" class="">Direct Members</a></li>
							</ul>
						</div>
					</div>
						...
						<thead>
                         <tr>
                          ...
                          <?php 
							...
							if(_check_member_status($direct['user_id'])==1)
							{
								$status='Inactive';
							}
							else if(_check_member_status($direct['user_id'])==2)
							{
								$status='Cancel';
							}
							else if(_check_member_status($direct['user_id'])==4)
							{
								$status='Delete';
							}
							...
							if(_check_member_status($direct['user_id'])==1 || _check_member_status($direct['user_id'])==2 || _check_member_status($direct['user_id'])==4)
							{
							}
							else
							{
                  ...
                  <td class="center"><?php echo $direct['ref_id'];?></td>
                              ...
                              <td class="center"><?php echo date('m/d/Y',strtotime($direct['reg_date']));?></td>
                            </tr>
        <?php
		$j++;
		}
		...
		{
		$dn=$data_dwn[$i];
		$ss_dn=mysql_query("select * from registration where user_id='$dn'");
		$ff_dn=mysql_fetch_array($ss_dn);
		$memlevel=$lel[$i];
		if(_check_member_status($dn)==1)
		{
			$status_d='Inactive';
		}
		else if(_check_member_status($dn)==2)
		{
			$status_d='Cancel';
		}
		else if(_check_member_status($dn)==4)
		{
			$status_d='Delete';
		}
else if($ff_dn[mem_status]=='0'){
$status_d='Active';}
...
if(_check_member_status($dn)==1 || _check_member_status($dn)==2 || _check_member_status($dn)==4)
{ 
}
else
{
  ?>                      
                            <tr>
                              ...
                              <td class="center"><?php echo date('m-d-Y',strtotime($ff_dn['reg_date']));?></td>
                            </tr>
                            <?php
							$srl1++;
							}
