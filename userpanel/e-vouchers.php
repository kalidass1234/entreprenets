					...
					<div class="widget_wrap tabby">
						...
						<div class="widget_content">
                          ...
                          <?php
                            ...
                            $sql_ref = "select * from pins where receiver_id='$id'";
						  ...
						  ?>
							 ...
							 <tr>
								...
								<td class="center">
									...
									<?php if(!empty($direct['transfer_to'])):
										
										$sql = "select concat_ws(' ',first_name, last_name)as name from registration where user_id='".$direct['transfer_to']."'";
										$res = mysql_query ( $sql );
										$args_transfer = mysql_fetch_array($res);
										
										echo ucwords($args_transfer['name']);
										echo " (".$direct['transfer_to'].")";
								...
								<td class="center">
									...
									<?php if(!empty($direct['transfer_to'])):?>
										...
										<?php echo date("Y-m-d",strtotime($direct['transfer_date'])); ?>
