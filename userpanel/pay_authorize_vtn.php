...
$_SESSION['vtn_amount']=3.99;
$x_amount=$_SESSION['vtn_amount'];
...
function meberins()
	 {
	  ...
	  $checkid=mysql_query("select order_no from vtn_card where order_no='$pre_userid'");
...
$_SESSION['vtn_orderno']=$invoicem;
$_SESSION['payment_for'] = "vtn_card";
$_SESSION['vtn_paymode']='credit_card';
...
$post_values = array(
	...
	"x_amount"			=> $x_amount,
	"x_description"		=> "Paid For VTN Card",
	"x_invoice_num"		=> $_SESSION['vtn_orderno'],
