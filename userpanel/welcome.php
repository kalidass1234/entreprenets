						...
						<form action="" name="addproduct" id="addproduct" method="post" class="form_container left_label" enctype="multipart/form-data">
							...
							<li>
								<div class="form_grid_12">
									<label class="field_title">Welcome </label>
									<div class="form_input">
										<?=$res_user[first_name].' '.$res_user[mid_name].' '.$res_user[last_name]; ?>
									</div>
								</div>
								</li>
								<li>
								<div class="form_grid_12">
									<label class="field_title">YOUR USER ID: </label>
									<div class="form_input">
										<?=$res_user[user_id] ?>
									</div>
								</div>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title">OUR USER NAME:</label>
									<div class="form_input">
										<?=$res_user[user_name] ?>
									</div>
								</div>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title">YOUR CONTACT NO: </label>
									<div class="form_input">
										<?=$res_user[mobile] ?>
									</div>
								</div>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title">YOUR JOINING DATE:</label>
									<div class="form_input">
										<?=$res_user[reg_date]?>
									</div>
								</div>
