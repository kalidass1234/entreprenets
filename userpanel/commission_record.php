		  ...
		  <div class="grid_12">
			  <div class="widget_wrap">
					...
					<div class="widget_content">
						...
						$sql="SELECT invoice_amt, commission, purcheser_id, remark, level, invoice_amt,
STATUS , paid_status, ts,date
FROM `external_level_income`
UNION ALL
...
ORDER BY `ts` DESC";
						...
						<td class="center sdate">
								 $<?php echo $row['invoice_amt'];?>
						  </td>
							<td class="center">$<?php echo $row['commission'];?></td>
                            <td class="center"><?php if($row['status']==1 && $row['paid_status']==1) echo "Approved"; else if($row['paid_status']==2) echo "Cancel"; else echo "Pending";?></td>
						</tr>
						<?php
						$ii++;
						}
