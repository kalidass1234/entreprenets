...
$sql = "SELECT * FROM binary_income WHERE income_id = '".$rowNomIdCount['user_id']."' AND bonus_name='1' ORDER BY id DESC";
$res = mysql_query($sql);
$totc_unpaid = 0;
$total = 0;
$content = '';
...
while($row=mysql_fetch_assoc($res))
{
	...
	$content .= escape_csv_value($row['income_pair']).",";
...
$title .= "Sr No.,Date, Pair, Commission (Rs),Tds Amount, Trust Amount, Admin Amount, Final Amount (Rs),Status "."\n";
echo $title;
echo $content;
