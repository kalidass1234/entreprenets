...
function shownext1(path)
{
	...
	if(document.getElementById('other_category').checked==true)
	{
		...
		post_to_url('total_amount_one.php', {'pin':pin,'return_page':'member-secure_new.php','other_category':other_category,'other_duartion':'12'});
	}
	else
	{
		var other_category='';
		post_to_url(path, {'pin':pin,'return_page':'member-secure_new.php','other_category':other_category,'other_category':'12'});
	}
...
Membership initial registration fee of $179.94 By signing up for discount membership club with Vision Team Network Inc you will enjoy our discount prices that we have, we had partner with affiliated program and benefit membership club as well as our own products. When you become a member you will pay a fee of 179.94 each 3 months for your discount membership club. that will allow you to enjoy your benefit discount club on every day purchases. access over 100,000 name brands at hundreds of your favorite retailers. You'll also find restaurants,gyms, Group on deals and thousands of other local offers too, as well as tickets to sporting events, concerts, theaters, movies and theme parks. a full range of membership services provided by the Vision Team Network; and a 24-hour customer service support.
<?php }?>
...
color: #777;">
    <table width="98%" >
     <tr valign="middle">
     <th height="20" colspan="4" bgcolor="#009395" align="center" class="show_vision_level">Please enter your credit or debit card billing address if it’s different from the information below
    <tr valign="middle">
    ...
    <td><input type="text" name="x_city"  style="width:20%;" id="x_city" value="<?php echo $_SESSION['city'];?>" /> <input type="text" name="x_state" id="x_state" value="<?php echo $_SESSION['state'];?>" style="width:14%;" />
     <input type="text" style="width:14%;" name="x_zip" id="x_zip" value="<?php echo $_SESSION['zip'];?>" /></td>
