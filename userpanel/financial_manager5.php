		...
		<div class="grid_12 full_block">
				...
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								<li><a href="#tab1" class="active_tab">TFS Wallet History</a></li>
								<li><a href="financial_manager2.php" class="">TFS Wallet</a></li>
							</ul>
						</div>
					</div>
					<div class="widget_content">
						...
						<div id="tab1" style="display: none;">
							<div class="oilhold">
   							<form action="match_password.php?tfs_history=1" method="post" class="form_container left_label">
							<ul>
								<li>
								<div class="form_grid_12">
									<label class="field_title">Transaction Password</label>
									<div class="form_input">
										<input name="password" type="password" tabindex="1" class="" style="width:44%;" />
										<span id="user"></span>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									<div class="form_input"><input type="hidden" id="user_id" name="user_id" value="<? echo $id;?>" />
										<button type="submit" class="btn_small btn_gray"><span>Validate</span></button>
									</div>
								</div>
								</li>
							</ul>
					 ...
					 <div align="center" style="padding-top:20px;">
					  <input name="raise_ticket" class="btn" type="button"  value="Raise Ticket" onClick="window.location.href='raise-ticket.php'"/>
						...
						<div id="tab2" style="display: none;">
							<div class="oilhold">
   							<form action="match_password.php?tfs=1" method="post" class="form_container left_label">
							<ul>
							<li>
								<div class="form_grid_12">
									<label class="field_title"><font color="#FF0000"><?php echo $_GET['msg'];?></font></label>
					 ...
					 <div align="center" style="padding-top:20px;">
					  <input name="raise_ticket" class="btn" type="button"  value="Raise Ticket" onClick="window.location.href='raise-ticket.php'"/>
						...
						<div id="tab3" style="display: none;">
							<div class="oilhold">
   							<form action="tranjaction2.php" method="post" class="form_container left_label">
							<ul>
								<li>
								<div class="form_grid_12">
									<label class="field_title">Transaction Password</label>
