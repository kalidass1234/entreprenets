...
$user_plan='free';
//echo $id;
$shdwn = new showDwonMemFV_new();
//var_dump($shdwn);
$shdwn->shoDwnMemFV_new($id,$id,$user_plan);
		...
		<div class="grid_container">
		  ...
		  <div class="widget_wrap tabby">
					...
					<div class="widget_content">
					  ...
					  $simple=mysql_query("select * from registration where nom_id='$id' ");
					  $count=mysql_num_rows($simple);
					  $srl=1;while($direct=mysql_fetch_array($simple)){
					  if($direct['user_plan']=='free')
						{
			 			 ?>
							<tr>
                                  <td align="center" class="ptext"><?=$srl?></td>
                                  <td align="center" class="ptext"><?= $direct['user_id']?></td>
                                 
                                  <td align="center" class="ptext"><?=ucfirst($direct['first_name']).' '.ucfirst($direct['mid_name']).' '.ucfirst($direct['last_name']);?></td>
                                  <td align="center" class="ptext"><?=$direct['ref_id']?></td>
								 <?php /*?> <td align="center" class="ptext"><?= $direct['sub_for']?></td>
								  <td align="center" class="ptext"><?= $direct['plan_amt']; ?></td><?php */?>
								  <td align="center" class="ptext"><?php echo ucfirst($direct['user_type']);
								  ; ?></td>
							<td class="center"><?php if($direct['mem_status']==0)
								  {
								  print "Active";
								  }
								  if($direct['mem_status']==1)
								  {
								  print "InActive";
								  }
								  ; ?></td>
								  <td align="center" class="ptext"><?= $direct['reg_date']; ?></td>
								  <!--<td align="center" class="ptext"><a href="downline1.php?id=<?php echo $direct['user_id']; ?>" class="head">Detail</a></td>-->
                                </tr>
                            <?
							$srl++;
							}	}
							...
							$p_id=$dn['nom_id'];
							$r_id=$dn['ref_id'];
							$query="select * from registration where user_id='$dn'";
							$q=mysql_query($query);
							$flag=1;
							...
							?>
						<tr>
                                  <td align="center" class="ptext"><?=$count+$i+1?></td>
                                  <td align="center" class="ptext"><?= $row['user_id']?></td>
                                 
                                  <td align="center" class="ptext"><?=ucfirst($row['first_name']).' '.ucfirst($row['mid_name']).' '.ucfirst($row['last_name'])?></td>
                                  <td align="center" class="ptext"><?=$row['ref_id']?></td>
								
								  <td align="center" class="ptext"><?php echo ucfirst($row['user_type']).'=='.$row['plan_name']; ?></td>
							<td class="center"><?php if($row['mem_status']==0)
								  {
								  print "Active";
								  }
								  if($dn['mem_status']==1)
								  ...
								  ; ?></td>
								  <td align="center" class="ptext"><?= $row['reg_date']; ?></td>
								 <!-- <td align="center" class="ptext"><a href="downline1.php?id=<?php echo $row['user_id']; ?>" class="head">Detail</a></td>-->
                                </tr>
								<?php
								$flag++;
								}
