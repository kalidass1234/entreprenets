...
font-family: Arial, Helvetica, sans-serif;
				...
				<h5 class="post-title cufon_headings">Upgrade Membership Level 1</h5>
...
?>
    <tr class="odd" style="background-color:#FFC">
        ...
        <td align="center"><a href="set_amt_duration_upgrade_account.php?amount=29.99&duration=1&category=1" class="link-select">Select</a></td>
    </tr>
    <tr class="even">
        ...
        <td  align="center"><a href="set_amt_duration_upgrade_account.php?amount=89.97&duration=3&category=1" class="link-select">Select</a></td>
    </tr>
    <tr class="odd">
        ...
        <td  align="center"><a href="set_amt_duration_upgrade_account.php?amount=179.94&duration=6&category=1" class="link-select">Select</a></td>
    </tr>
    <tr class="even">
        <td  align="center">Vision Team Network Membership - 12 <br><br>month option</td>
        <td  align="center">$359.88</td>
        <td  align="center"><nobr><strong>$359.88</strong>every 12 <br><br>Months</nobr></td>		
        <td  align="center"><strong>12 payments</strong> total.<br><br>Membership expires after 1 year.</td>
        <td  align="center"><a href="set_amt_duration_upgrade_account.php?amount=359.88&duration=12&category=1" class="link-select">Select</a></td>
    </tr>
 <?php
 }
 ?>
