...
if(isset($_SESSION) && $_SESSION['adid'])
{
	...
	if($stage=='1')
	{
		$quer2="select * from board_status where upper_id='$id' and package_id = '$package_amount' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 0,3";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   { 
					 ...
					 $quer3="select * from board_status where upper_id='".$id."' and package_id = '$package_amount' AND board_number= '$boardN' AND upper_id = '$id' AND level='2' ORDER BY cell_no ASC ";
    ...
    <span>
          ...
          <tr style="color:#3399FF;">
              <?php
			   for($i=1;$i<=3;$i++)
			   {
				   ...
				   {
					   $userid=$arr3[$i-1][3];
					   $sql_stat="select * from registration where user_id='$userid' and package_amount = '$package_amount'";
					   $res_stat=mysql_query($sql_stat);
					   $row_stat=mysql_fetch_assoc($res_stat);
	  ...
	  <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="text-align:center;">
			   ...
			   { 
					...
					$quer4="select * from board_status where upper_id='".$id."' and package_id = '$package_amount' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 6,9";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   { 
					...
					$quer5="select * from board_status where upper_id='".$id."' and package_id = '$package_amount' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 9,12";
