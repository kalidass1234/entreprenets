					...
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								...
								<li><a href="response.php">View Ticket Response <?php $staus=user_ticket_notification($id); if($staus>0) { ?><span class="alert_notify blue">(<?php echo $staus; ?>)</span><?php } ?></a></li>
							</ul>
						</div>
					</div>
