...
if(isset($_SESSION) && $_SESSION['adid'])
{
	...
	{
			mysql_query("INSERT INTO address set user_name='{$_POST['u_name']}', contact='{$_POST['contact']}', name='{$_POST['name']}', address='{$_POST['address']}', user_id='$idd', email='{$_POST['email']}'");
	?>
			<script type="text/javascript">
		...
		<div class="grid_container">
		  ...
		  <div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<h6>My Contacts</h6><h6><a href="address_book.php">Add New Contact</a></h6>
						<!--<div id="widget_tab">
							<ul>
					...
					<div class="widget_content">
						...
						<tr>
							...
							<th style="border-right:none;">Address</th>
						...
						<tbody>
						<?php
						$sql_contacts=mysql_fetch_array(mysql_query("select * from registration where user_id='$idd'"));
						   $str1="select * from address where (user_id='$idd' OR user_name='".$sql_contacts['user_name']."')";
						...
						<tr>
							...
							<td class="center">
								<a href="#" class=""><?=$x1['name'];?> </a>
							</td>
							<td class=" center" >
								 <?=$x1['contact'];?>
							</td>
							<td class="center"><?=$x1['email'];?></td>
							<td class="center" style="border-right:none;"><?=$x1['address'];?></td>
							
							<td class="center sdate"  style="border-right:none;">
								 <span class=" "><a href="address_book.php?id=<?php echo $x1['id'];?>">Edit</a></span>
							</td>
