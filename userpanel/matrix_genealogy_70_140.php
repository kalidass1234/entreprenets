...
<td align="center" valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
	...
	$quer2="select * from board_status where upper_id='$id' and package_id = '70.00' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 0,1";
...
<td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="text-align:center;">
	...
	$quer2="select * from board_status where upper_id='$id' and package_id = '70.00' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 1,4";
	$data2=mysql_query($quer2);
