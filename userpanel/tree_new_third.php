...
$str="select * from registration where user_id='$uid'";
$res=mysql_query($str);
$x=mysql_fetch_array($res);
$uname=$x['user_name'];
$name=$x['first_name']." ".$x['mid_name']." ".$x['last_name'];
...
$sql_search=mysql_query("select * from registration where user_id='$uid' or user_name='$uid'");
...
$quer2="select user_id,user_name,plan_name from registration where nom_id_140='$uid' order by id";
