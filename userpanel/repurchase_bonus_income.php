		  ...
		  <div class="grid_12">
			  ...
			  <div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Repurchase Bonus 1 (Generation Plan)
                       ...
                       <img src="../images/print.png"  onClick="printDiv('example');">
						...
						$heading.="<td>Date</td><td>Invoice No</td><td>User Id</td><td>Total Purchased BV</td><td>Commission(%)</td><td>Bonus(BV)</td><td>Bonus(USD)</td><td>TDS(%)</td><td>TDS Amount</td><td>Miscellaneous(%)</td><td>Miscellaneous Amount</td><td>Final Bonus(USD)</td></tr>";
						
						$heading3="Date,Invoice No,User Id,Total Purchased BV,Commission(%),Bonus(BV),Bonus(USD),TDS(%),TDS Amount,Miscellaneous(%),Miscellaneous Amount,Final Bonus(USD)";
						
						$record = "date,invoice_no,user_id,invoice_bv,com_percent,commission_bv,commission,tds_percent,tds_amount,miscellaneous_percent,miscellaneous_amount,final_amount";
						$table="repurchase_bonus_one";
						$con.="WHERE income_id = ".$id;
						?>
...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
					...
					<div class="widget_content" id="example">
						...
						$sql="SELECT invoice_amt,invoice_no, commission, user_id, remark, level, invoice_amt,status , paid_status, ts,date,user_level,payout_date,com_percent,invoice_bv,commission_bv,tds_percent,tds_amount,miscellaneous_percent,miscellaneous_amount,final_amount FROM `repurchase_bonus_one`
WHERE income_id = '$id' ORDER BY `ts` DESC";
 //echo $sql;
						...
						<td class="center">
								<?php echo showusername($row['user_id']);?> 
						</td>
						<td class="center">
								<?php echo $row['invoice_bv'];?>
						</td>
                        <td class="center">
								<?php echo $row['com_percent'];?>
						</td>
                        <td class="center">
								<?php echo $row['commission_bv']." BV";?>
						</td>
						
						<td class="center"><?php echo "$ ".$row['commission'];?></td>
						<td class="center"><?php echo $row['tds_percent'];?></td>
						<td class="center"><?php echo $row['tds_amount'];?></td>
						<td class="center"><?php echo $row['miscellaneous_percent'];?></td>
						<td class="center"><?php echo $row['miscellaneous_amount'];?></td>
						<td class="center"><?php echo $row['final_amount'];?></td>
                        <td class="center"><?php if($row['paid_status']==1) echo "Paid"; else if($row['paid_status']==0) echo "Unpaid"; else if($row['paid_status']==2) echo "Cancel";?></td>
						</tr>
						<?php
						$ii++;
						}
