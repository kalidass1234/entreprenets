			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						if($_POST['Show']=='Search')
						{
						$query="SELECT *, sum(price*quantity) as oto FROM purchase_detail PUR inner join product_category PRO where PRO.p_cat_id=PUR.p_id and PUR.status=0 and seller_id='$id' and PUR.date BETWEEN '$dt1' and '$dt2' group by invoice_no order by PUR.date desc  ";
						}
						else
						$query=" SELECT *, sum(price*quantity) as oto FROM purchase_detail PUR inner join product_category PRO where PRO.p_cat_id=PUR.p_id and PUR.status=0 and seller_id='$id' group by invoice_no order by PUR.date desc    ";
		//echo $query;				
...
//echo $query;
					...
					?>
						<tr>
							...
							<td class="center">
								<!--<span class="badge_style b_done">--><a href="invoice_sell.php?invoice_no=<?=$noticia[invoice_no]; ?>">View Detail</a><!--</span>-->
							</td>
							
							<td class="center">
								<!--<span class="badge_style b_high">--><div class="btn_30_light">
										<a href="invo_sell_detail_down.php?invoice_no=<?=$noticia[invoice_no]; ?>" title="Download .doc"><span class="icon drive_disk_co"></span></a>
									</div><!--</span>-->
							</td>
						</tr>
