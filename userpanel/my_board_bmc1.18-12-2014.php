...
if($stage=='1')
{
	echo $quer2="select * from board_status where upper_id='$id' and package_id = '$package_amount' AND board_number= '$boardN' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 0,3";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   { 
					...
					$quer3="select * from board_status where upper_id='".$id."' and package_id = '$package_amount' AND board_number= '$stage' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 3,6";
    ...
    <span>
	  ...
	  <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="text-align:center;">
			   ...
			   { 
					...
					$quer4="select * from board_status where upper_id='".$id."' and package_id = '$package_amount' AND board_number= '$stage' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 6,9";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   { 
					...
					$quer5="select * from board_status where upper_id='".$id."' and package_id = '$package_amount' AND board_number= '$stage' AND upper_id = '$id' ORDER BY cell_no ASC LIMIT 9,12";
