...
<div id="titlebar" class="titlebar-hautq cover">
			<div class="container relative">
				<div id="titlebar-text">
											<h2 id="titlebar-title"><strong>Offline Businesses</strong></h2>
					
											<div class="titlebar-text-content"><p>Features of our ready made offline business.</p>
</div>
									</div>
									<div id="titlebar-breadcrumb"><div id="breadcrumb" class="ui--box-alias centerVertical"><div class="ui-bc ui-breadcrumbs breadcrumbs" itemprop="breadcrumb"><span class="ui-bc-first"><a href="http://envision.wptation.com" title="Envision" rel="home" class="ui-bc-first">Home</a></span> <span class="ui-bc-seperator"> <i class="ui--caret fontawesome-angle-right px18"></i> </span> <span class="ui-bc-last">Online Businesses</span></div></div></div>
							</div>
		</div><!-- /#titlebar -->
...
<div id="section-cr4zq" class="ui--section clearfix inner-shadow-2" style="margin-bottom: 0px;  padding-top: 10px;  padding-bottom: 22px;">
   <div class="ui--title ui--animation ui--title-bordered text-left">
      <div class="ui--title-holder">
         <h3 class="ui--title-text"><strong>Offline Businesses</strong>  </h3>
            ...
            <div class="ui--carousel clearfix" data-options="{&quot;effect&quot;:&quot;slide&quot;,&quot;auto_rotate&quot;:&quot;FALSE&quot;,&quot;animation_loop&quot;:&quot;FALSE&quot;,&quot;arrows&quot;:true,&quot;rotate_time&quot;:0,&quot;animate&quot;:true}">
               <div class="slides">
                   <?php
                    ...
                    $proQ = mysql_query("select * from manage_projects WHERE".$catwhere." project_type=1 AND display_status=1");
	...
	<aside id="sidebars" class="widget-area  custom-widget-sidebar-skm7z">
			<div id="cloudfw_subpages-2" class="widget widget_cloudfw_subpages"><h4 class="sidebar-widget-title ui--widget-title"><span>Categories</span></h4><ul class="ui--widget-subpages-smooth ui--box"> 
                    ...
                    while($projC = mysql_fetch_array($proCQ)){
                        $numCQ = mysql_query("select id from manage_projects WHERE project_type=1 AND category_id='".$projC['id']."'");
                        $numC = mysql_num_rows($numCQ);
                    ?>
                        <li class="page_item page-item-951 ui--gradient ui--gradient-grey"><a href="offline-business.php?category=<?=$projC['id']?>"><?=$projC['name']?></a> <em>(<?=$numC;?>)</em></li>            
                    <?php            
                    }
                   ?>
...
<li class="page_item page-item-913 ui--gradient ui--gradient-grey"><a href="#"> Automotive</a> (11)</li>
<li class="page_item page-item-1020 ui--gradient ui--gradient-grey"><a href="#"> Legal & Financial</a> (2)</li>
<li class="page_item page-item-1004 ui--gradient ui--gradient-grey"><a href="#"> Media & Communications</a> (5)</li>
<li class="page_item page-item-971 ui--gradient ui--gradient-grey"><a href="#">Beauty care & Services </a> (9)</li>
<li class="page_item page-item-978 ui--gradient ui--gradient-grey"><a href="#"> Computing & Electronics</a> (15)</li>
<li class="page_item page-item-983 ui--gradient ui--gradient-grey"><a href="#">Real Estate </a> (6)</li>
<li class="page_item page-item-1366 ui--gradient ui--gradient-grey"><a href="#"> Education</a> (8)</li>
