...
{
	$_SESSION['sponsor_idr']=$_POST['refid'];	
	$sponsor_id = $_SESSION['sponsor_idr'];
	
	if(isset($_SESSION['sponsor_idr']))
	{
		$sql_refid=mysql_fetch_array(mysql_query("select user_id from registration where user_id='{$_SESSION['sponsor_idr']}' or user_name='{$_SESSION['sponsor_idr']}'"));
		$_SESSION['ref_id']=$sql_refid['user_id'];
	}
	else 
	{
		$_SESSION['ref_id']='12345';
	}
}
if(isset($_POST['first_name']) && $_POST['first_name'] != '' )
{
	$_SESSION['fnamer']=$_POST['first_name'];	
...
{
	$_SESSION['lnamer']=$_POST['last_name'];	
...
{
	$_SESSION['package_idr']=$_POST['package'];
	

	$sql1=mysql_query("select * from package where package_id='".$_SESSION['package_idr']."' ORDER BY package_id ASC");
	$res=mysql_fetch_array($sql1);

	$_SESSION['package_name']=$res['package_name'];	
	$_SESSION['package_price']=$res['total_price'];	
	$_SESSION['Pprice']=$_SESSION['package_price'];	
	
}
if(isset($_POST['phoner']) && $_POST['phoner'] != '' )
{
	$_SESSION['phonerr']=$_POST['phoner'];	
	$phoner=$_SESSION['phonerr'];
}
if(isset($_POST['mobile']) && $_POST['mobile'] != '' )
{
	$_SESSION['mobiler']=$_POST['mobile'];	
	$mobiler=$_SESSION['mobiler'];
}

if(isset($_POST['zip']) && $_POST['zip'] != '' )
{
	$_SESSION['zipr']=$_POST['zip'];	
	$zipr=$_SESSION['zipr'];
}
if(isset($_POST['trans_pin']) && $_POST['trans_pin'] != '' )
{
	$_SESSION['passr']=$_POST['password1'];	
	$_SESSION['trans_pinr']=$_POST['trans_pin'];	
}
if(isset($_POST['street1']) && $_POST['street1'] != '' )
{
	$_SESSION['street1r']=$_POST['street1'];	
	$street1r=$_SESSION['street1r'];
}
if(isset($_POST['street2']) && $_POST['street2'] != '' )
{
	$_SESSION['street2r']=$_POST['street2'];	
	$street2r=$_SESSION['street2r'];
}
if(isset($_POST['city']) && $_POST['city'] != '' )
{
	$_SESSION['cityr']=$_POST['city'];	
	$cityr=$_SESSION['cityr'];
}
if(isset($_POST['country']) && $_POST['country'] != '' )
{
	$_SESSION['countryr']=$_POST['country'];	
	$countryr=$_SESSION['countryr'];
}
if(isset($_POST['state']) && $_POST['state'] != '' )
{
	$_SESSION['stater']=$_POST['state'];	
	$stater=$_SESSION['stater'];
}
	// For Insert in Registration
	
	$sql_user=mysql_fetch_array(mysql_query("select user_name from registration where user_name='$user_name'"));
	if($sql_user['user_name']!='')
	{
		?>
		<script >
		alert("This replicated website is unavailable. Please choose another name.");
...
<form action="controller/register.php" name="contactform" id="contactform" class="sky-form" required method="post" ><!-- Changes 'payment.php'   controller/register.php-->




              <header>Confirm Details form</header>

              <fieldset>
                            <p>Please check in your information below</p>
                <section class="row">
                    <div class="span4"><label class="input"> 
                    Sponsor Id </label> </div>
                    <div class="span4"><?=$sponsor_id?></div>
                     <div class="clearfix"></div>
                </section>
                
                <section class="row">
                  	<div class="span4"><label class="input">
                    User Name </label> </div> <div class="span4"><?=$user_name?></div>
                    <div class="clearfix"></div>
                </section>
                <section class="row">
                <p class="form-hd" ><strong>Account Details</strong></p>
                  	<div class="span4"><label class="input"> 
                    First Name </label> </div> <div class="span4"><?=$fname?></div>
                    <div class="clearfix"></div>
                </section>
                <section class="row">
                    <div class="span4"><label class="input"> 
                    Last Name </label> </div> <div class="span4"><?=$lname?></div>
                    <div class="clearfix"></div>
                </section >
                <section class="row">
                  	<div class="span4"><label class="input"> 
                    Email </label> </div> <div class="span4"> <?=$email?> </div>
                     <div class="clearfix"></div>
                </section>
                
                <section class="row">
                  	<div class="span4"><label class="input">
					Password </label> </div> <div class="span4">  ******</div>
                     <div class="clearfix"></div>
                </section>

                <section class="row"> 
                  	<div class="span4"><label class="input"> 
                    Transaction Password </label> </div> <div class="span4"> ****** </div>
                     <div class="clearfix"></div>
                </section>
              </fieldset>
              <fieldset>
                   ...
                   <p class="form-hd"><strong>Your Address</strong></p>
            <?php
			$country = getCountrys($_SESSION['countryr']);
			?>

            <?php
			$state = getStates($_SESSION['stater']);
			?>
				<div class="span4"><label class="input">	Country </label> </div> <div class="span4"> <?=$country;?>
				</div>
                  <div class="clearfix"></div>
                </section>
                   ...
                   <section class="row">
                  	<div class="span4"><label class="input">
                    Street Line 1 </label> </div> <div class="span4"> <?=$street1r;?>
                  </div>
                  <div class="clearfix"></div>
                </section>
                ...
                <section class="row">
                  	<div class="span4"><label class="input">
                   Street Line 2 </label> </div> <div class="span4"> <?=$street2r;?>
                  </div>
                  <div class="clearfix"></div>
                </section>
                  ...
                  <section class="row">
                    <div class="span4"><label class="input">
                     City </label> </div> <div class="span4"> <?=$cityr;?>
                  </div>
                  <div class="clearfix"></div>
                  </section>
                  <section class="row">
                   <div class="span4"> <label class="input">
                      Zip/Postal Code </label> </div> <div class="span4"> <?=$zipr;?>
                  </div>
                  <div class="clearfix"></div>
                  </section>
                  </div>
                  <section class="row">
                  <div class="span4"><label class="select" name="state" id="state" >
                    State </label> </div> <div class="span4"> <?=$state;?>
                  </div>
                  <div class="clearfix"></div>
                </section>
                  ...
                  <section class="row">
                    <div class="span4"><label class="input">
                       Mobile Phone </label> </div> <div class="span4"> <?=$phoner;?>
                  </div>
                  <div class="clearfix"></div>
                  </section>
                  <section class="row">
                   <div class="span4"> <label class="input">
					Other Phone </label> </div> <div class="span4"> <?=$mobiler;?>
                  </div>
                  <div class="clearfix"></div>
                  </section>
                ...
                <div class="row">
                  <section>
                  <p class="form-hd"><strong>Order Summary</strong></p>


<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th width="80%" scope="col"> Your Purchase</th>
    <th width="20%" scope="col" style="text-align:center">Below Amount</th>
  </tr>
  <tr>
    <td><?=$_SESSION['package_name']?></td>
    <td style="text-align:center">R<?=$_SESSION['package_price']?></td>
  </tr>
  <tr>
    <td><strong>Total</strong></td>
    <td style="text-align:center"><strong>R<?=$_SESSION['package_price']?></strong></td>
  </tr>
</table>
                  </section>
                </div>
              ...
              <footer style="text-align:center">
                <input type="submit" name="submit" class="btn-dark-red">
              </footer>
            </form>
