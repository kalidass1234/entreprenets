...
In BMC Network, we succeed when we help our members succeed</p>
 ...
 <div class="ui-column span6"><div class="ui--blog-item ui--animation ui--accent-gradient-hover-parent clearfix layout--mini-carousel"><div class="ui--blog-side ui--blog-date ui--accent-gradient-hover-parent ui--box"><h3><span class="ui--blog-date-day ui--accent-gradient-hover">21</span></h3> 
 <h6 class="ui--blog-date-month ui--gradient ui--gradient-grey"> <span>Jul </span> </h6> 
 
 </div><div class="ui--blog-content-wrapper"><div class="ui--blog-header"><h5 class="ui--blog-title"><a class="ui--blog-link" href="#">Image Post Format</a></h5></div><div class="ui--blog-readmore more-link"><a class="btn btn-small btn-secondary muted" href="#">Read More</a></div></div></div></div> 
