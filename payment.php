...
<form method="post" id="register" action="payment.php" class="sky-form">
              <header>Payment Mode form</header>

              <fieldset>
                            <p>Please Choose Payment Mode</p>
                <section>
                  <label class="input"> <a href="eVoucherPins.php"><img src="paymentimage/prepaid.png" alt="" width="250" height="81"></a></label>
                </section>
                <section>
                  <label class="input"> <a href="checkTransAgain.php"><img src="paymentimage/sponser.png" alt="" width="250" height="81"></a></label>
                </section>
              </fieldset>
