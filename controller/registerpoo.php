...
//echo "<br>". $query_reg; exit;
 ...
 <div style='width:800px; margin:0px auto;'>
  ...
  <tr>
    <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
      ...
      <tr>
        <td height='40'>&nbsp;</td>
        <td height='40'><p style='font-family:Calibri; font-size:16pt; font-weight:bold; font-style:italic; color:#CC3300; padding:5px 0px;'>Thank you for Registering with Seancare.</p></td>
        <td height='40'>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><p style='font-family:Calibri; font-size:13pt; color:#CC3300; font-style:italic; padding-top:15px;'>Your login information
</p></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
 ...
 Username : $user_nm
        ...
        <tr>
		  ...
		  <tr>
			<td >Replicated Website URL: <a href='http://www.seancare.com/$user_nm' target='blank'>http://www.seancare.com/$user_nm</a></td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><p style='font-family:Calibri; font-size:16pt; font-weight:bold; font-style:italic; color:#CC3300; padding:10px 0px;'>Thanks in advance and welcome to Seancare,</p></td>
        <td>&nbsp;</td>
      </tr>
      
      <tr>
        <td>&nbsp;</td>
        <td><p style='font-family:Calibri; font-size:13pt; color:color:#CC3300; font-style:italic;'>seancare administratión</p></td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
