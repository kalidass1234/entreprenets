...
//if("manual" == $payment_mode || $package==3){
	...
	*----------------------------------------*/
	...
	$plan_name=$args_package["package_id"];
...
//	echo "select user_id from registration where nom_id='$nom_id'";
	...
	$position=$count_pos+1;
	 $query_reg="insert into registration SET user_id='$user_id', user_name='$user_nm', nom_id='$nom_id', user_pass='$pass', t_code='$t_code', plan_name='$plan_name', pin_no='$pin', ref_id='$ref',mem_status='$mem_status', first_name='$fname', mid_name='$mname', last_name='$lname', email='$email', address1='$address1', address2='$address2', city='$city',state='$state',country='$country',zip='$zipcode', user_type='$user_type', mobile='$mobile', reg_date='$date', package='$package_name', dob='$birth_date', ship_street1='$ShipStreet1', ship_street2='$ShipStreet2', ship_country='$ShipCountry', ship_zip='$ShipPostalCode', ship_city='$ShipCity', ship_state='$ShipState', co_fname='$CoFirstName', co_lname='$CoLastName', co_company='$CoCompany', co_ssn='$CoSSN', co_email='$coemail', company='$company', phoner='$phoner', phoneo='$phoneo', fax='$fax', position_tree='$position',ssn='$ssn',sex='$gender',plan_amt='$plan_amt', rank='$rank', payment_mode='$payment_mode', bank_nm='{$_SESSION['bank_name_s']}',ac_no='{$_SESSION['acc_no_s']}'";
//echo "<br>". $query_reg; exit;
	...
	$sql_pack=mysql_query("select * from package1 where package_id='{$_SESSION['package_s']}'");
	$res_pack=mysql_fetch_array($sql_pack);
	$amount=$res_pack["total_fees"];
  ...
  <table width='100%' border='0' cellspacing='0' cellpadding='0'>
    <tr>
      <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><p style='font-family:Calibri; font-size:13pt; color:#CC3300; font-style:italic; padding-top:15px;'>Your new team members' details are: </p></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><p style='font-family:Calibri; font-size:13pt; color:#000; font-style:italic;'> Your Distributor ID is:  $user_nm </p></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><p style='font-family:Calibri; font-size:13pt; color:#000; font-style:italic;'> Username : $user_nm </p></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td >Your Replicated URL is: <a href='http://www.seancare.com/$user_nm' target='blank'>http://www.seancare.com/$user_nm</a></td>
          </tr>
          <tr>
            <td height='77'>&nbsp;</td>
            <td>&nbsp;</td>
...
//echo $msg;
exit;
	mail($to,' Seancare REGISTRATION',$msg,$headeruser1);
...
exit;
	...
	else if("manual" == $payment_mode)
	{
		...
		$userid=base64_encode($user_id);
		 ...
		 $headeruser="Mime-Version: 1.0". PHP_EOL;
		   $headeruser.= 'Content-type: text/html; charset=iso-8859-1' . PHP_EOL;
			$headeruser1="Mime-Version: 1.0".PHP_EOL;
		   $headeruser1.= 'Content-type: text/html; charset=iso-8859-1' . PHP_EOL;
		   $headeruser1.= "From: info@seancare.com <$from>" . PHP_EOL;
		 $msg= "<html>
<head>
<title></title>
</head>
  ...
  <table width='100%' border='0' cellspacing='0' cellpadding='0'>
    ...
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt;'> Our credit card processor is almost ready to go live, on the mean time in order to permanently place you
          ...
          in the system you need to complete your activation by making the payment manually. </p></td>
    </tr>
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt;'> We made this process simple. </p></td>
    </tr>
    <tr>
      <td >Just go to either GTBANK or UBA and make a deposit into the corporate account.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; '><a href='http://www.seancare.com/manual-payment.php?uid=$userid&paymet=manual'>http://www.seancare.com/manual-payment.php?uid=$userid&paymet=manual</a></p></td>
    </tr>
    <tr>
    ...
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; '>Below is the corporate accounts information to make your deposit:</p></td>
    </tr>
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; font-weight:bold;'>Bank: UBA </p></td>
    </tr>
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; font-weight:bold;'>Account Name:  Seancare Intl Ltd </p></td>
    </tr>
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; font-weight:bold;'>Accout Nunber:  1017842205 </p></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; font-weight:bold;'>Bank: GTBANK  </p></td>
    </tr>
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; font-weight:bold;'>Account Name:  Seancare Intl Ltd </p></td>
    </tr>
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; font-weight:bold;'>Accout Nunber:  0142073336  </p></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
    ...
    <tr>
      <td ><p style='font-family:Calibri; font-size:13pt; font-weight:bold;'>Seancare team</p></td>
		...
		header("Location:../thank-you.php?uid=$userid&msg=thank you");		
	}
...
if($user_nm!=''){
	if($count_check==0)
	{
		if($count_check_cust==0){	
			if(($payment_mode == "voguepay" || $payment_mode == "simplepay4u") && isset($_SESSION['orderno']))
			{
