			  ...
			  $idnoml=$idnom;
				while($idnoml!='cmp'){
					...
					if($date_refl>$date){
						...
						$idnom_mat=$query_levelc['nom_id'];
						 'LEVEL:<br>';
						 "INSERT INTO level_income(income_id , down_id, package, commission, remark,l_date,status, com_type, invoice, percent, price, level) values ('$idnoml', '$id' ,'Product Purchase', '$levelc', 'Dynamic Level Based Residual Commission',CURDATE(),'0', 'r', '$invoice', '$percentl', '$plan_amt', '$il')";
						 '<br>';
						mysql_query("INSERT INTO level_income(income_id , down_id, package, commission, remark,l_date,status, com_type, invoice, percent, price, level) values ('$idnoml', '$id' ,'Product Purchase', '$levelc', 'Dynamic Level Based Residual Commission',CURDATE(),'0', 'r', '$invoice', '$percentl', '$plan_amt', '$il')");
						$il++;
						while($idnom_mat!='cmp'){
							/************* MATCHING BONUS ***********/
							$im=1;
