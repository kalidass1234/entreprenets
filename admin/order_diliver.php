  	...
  	<div class="mainbar">
            ...
            <div class="col-md-12">
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Diliver Order Detail </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=23"  method="post" class="validate" id='form1'>
                      <fieldset>
        ...
        <div class="row">  <div class="printer"><img src="images/printer_icon.png"></div></div>
          <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Diliver Orders</div>
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=23'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=23'.$search_string;
			}
