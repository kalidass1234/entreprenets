          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from cms_recent_post where id='$mid'");
				}
				...
				if($per_page != "all"){
					...
					$limit = " ";
			  $res_products_tol=$obj_query->query("*","cms_recent_post","1=1 ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
			  
                $res_prod=$obj_query->query("*","cms_recent_post","1=1 $limit");
				$sn=1;
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showcmsrecentpostform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
