...
//echo "select * from binary_income b inner join registration r on b.income_id=r.user_id where b.income_id!='cmp' $search_string $con_search order by b.id desc $limit";
              ...
              ?>
				...
				?>
                    ...
                    <div class="export padding-space"><a href="exportTrust.php">Export in excel</a></div>
                    <div class="export padding-space"><a href="javascript:void(0);" onclick="coderHakan()">Print</a></div>
