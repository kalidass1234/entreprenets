            ...
            <div class="col-md-12">
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Binary Bonus Detail </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=49"  method="post" class="validate" id='form1'>
                     <fieldset>
...
<script>function coderHakan(){var sayfa = window.open('','','width=800,height=800');sayfa.document.open("text/html");sayfa.document.write(document.getElementById('printArea').innerHTML);sayfa.document.close();sayfa.print();
          ...
          <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Binary Bonus</div>
...
<!--                      <th>Left Carry Forword</th>
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=49&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=49&'.$search_string;
			}
...
//echo "select * from binary_income b inner join registration r on b.income_id=r.user_id where b.income_id!='cmp' $search_string $con_search order by b.id desc";
			  $res_products_tol=mysql_query("select * from binary_income b inner join registration r on b.income_id=r.user_id where b.income_id!='56789' AND b.bonus_name='1'  $search_string $con_search order by b.id desc");
...
//echo "select * from binary_income b inner join registration r on b.income_id=r.user_id where b.income_id!='cmp' $search_string $con_search order by b.id desc $limit";	 
			  $res_cat=mysql_query("select * from binary_income b inner join registration r on b.income_id=r.user_id where b.income_id!='56789' AND b.bonus_name='1' $search_string $con_search order by b.id desc $limit");
...
<!--                    <td><?php echo $row_cat['carry_fwd_left'];?></td>
                    ...
                    <td><?php echo $row_cat['commission'];?></td>
						...
						<td class="center"><?php echo $row_cat['trust_amount'];?></td>
						<td class="center"><?php echo $row_cat['admin_amount'];?></td>
				...
				?>
                    ...
                    <div class="export padding-space"><a href="exportBinaryBonus.php">Export in excel</a></div>
