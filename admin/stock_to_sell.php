            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=15" class="validate" method="post" id='form1'>
                      <fieldset>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						...
						if(isset($_REQUEST['search']))
						{
							...
							$url='admin_main.php?page_number=15&'.$query_string;
						}
						else
						{
							$url='admin_main.php?page_number=15&'.$search_string;
						}
						//echo $search_string;
						//$url='member_list.php?';
						...
						if(isset($_REQUEST['search']))
						{
                        $res=$obj_query->query("*","registration","bonus=1 and reseller=0 $search_string $limit");
						$res_products_tol=$obj_query->query("id","registration","bonus=1 and reseller=0 $search_string $con_search ");
