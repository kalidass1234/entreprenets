                  ...
                  <div class="modal-body">
                   <div class="form-group">
                      ...
                      <select name="category" class="form-control placeholder">
						...
						$obj_function->_get_cms_home_top_category_dropdown();
						?>
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='cms_home_top.php?'.$query_string;
				}
				else
				{
					$url='cms_home_top.php?1=1'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
				if($per_page != "all"){
					...
					$limit = " ";
			  $res_products_tol=$obj_query->query("*","cms_home_top","1=1 ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
			  
                $res_prod=$obj_query->query("*","cms_home_top","1=1 $limit");
				$sn=1;
                ...
                <tr>
                  <td><?php echo $sn;?></td>
                  <td><?php echo $obj_function->cms_home_top_arr[$row_prod['category']];//$category_name;//?></td>
                  ...
                  <td><a href="cms_home_top.php?delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showcmshometopform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
