            ...
            <div class="col-md-12">
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Five Star Special Bonus Detail </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=50"  method="post" class="validate" id='form1'>
                       <fieldset>
...
function setLocation(url)
{
	window.location.href=url;
                        ...
                        <img src="../images/excel.png" onClick="setLocation('ExportExcelFiveStarBonus.php');" name="getReport" id="getReport" >
                       <img src="../images/word.png" onClick="setLocation('ExportDocFiveStarBonus.php');" name="getReport" id="getReport">
...
function printDiv(divName) {
   ...
   document.body.innerHTML = originalContents;
          ...
          <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Five Star Special Bonus</div>
			...
			if(isset($_REQUEST['search']))
			{
				...
				if(isset($_REQUEST['user_name']) && $_REQUEST['user_name']!='')
				{
					...
					$search_string.=" and f.income_id='$user_id'";
				...
				{
					$search_string.=" and f.date between '".$_REQUEST['from_date']."' and '".$_REQUEST['to_date']."'";
				}
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=50&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=50&'.$search_string;
			}
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=mysql_query("select * from five_star_special_bonus f inner join registration r on f.income_id=r.user_id where f.income_id!='cmp' $country_search $search_string $con_search order by f.l_id desc");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
						 
			  $res_cat=mysql_query("select * from five_star_special_bonus f inner join registration r on f.income_id=r.user_id where f.income_id!='cmp' $country_search $search_string $con_search order by f.l_id desc $limit");
