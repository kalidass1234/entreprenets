...
$heading.="<table border='1'><tr>";
						$heading.="<td>Date</td><td>User Id</td><td>Matching Id</td><td>Percentage(%)</td><td>Level</td><td>Bonus(BV)</td><td>Bonus(USD)</td><td>TDS(%)</td><td>TDS Amount</td><td>Miscellaneous(%)</td><td>Miscellaneous Amount</td><td>Final Bonus(USD)</td></tr>";
