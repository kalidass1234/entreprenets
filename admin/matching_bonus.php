            ...
            <div class="col-md-12">
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Matching Bonus Detail </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=51"  method="post" class="validate" id='form1'>
                     <fieldset>
...
<script>function coderHakan(){var sayfa = window.open('','','width=800,height=800');sayfa.document.open("text/html");sayfa.document.write(document.getElementById('printArea').innerHTML);sayfa.document.close();sayfa.print();
          ...
          <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Matching Bonus</div>
...
<div style="width:96%; " id="printArea">
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=51&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=51&'.$search_string;
			}
...
//echo "select * from binary_income b inner join registration r on b.income_id=r.user_id where b.income_id!='cmp' $search_string $con_search order by b.id desc $limit";	 
              ...
              ?>
                <tr>
                    ...
                    <td><?php echo $row_cat['matching_id'];?></td>
                    <td><?php echo $obj_query->get_field_name("registration","user_name","user_id='$row_cat[matching_id]'");?></td>
				...
				?>
                    ...
                    <div class="export padding-space"><a href="exportMatching.php">Export in excel</a></div>
