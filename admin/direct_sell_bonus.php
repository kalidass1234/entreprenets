            ...
            <div class="col-md-12">
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=47"  method="post" class="validate" id='form1'>
                      <fieldset>
        ...
        <div class="row">  <div class="printer"><img src="images/printer_icon.png"></div></div>
          <div class="widget">
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=47&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=47&'.$search_string;
			}
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=$obj_query->query("l_id","level_income_bonus","income_id!='cmp' $search_string $con_search order by l_id desc ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
						 
			  $res_cat=$obj_query->query("*","level_income_bonus"," income_id!='cmp' $search_string $con_search order by l_id desc $limit");
