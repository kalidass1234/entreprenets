  ...
  <div class="mainbar"> 
    ...
    <div class="matter">
      ...
      <div class="clearfix"></div>
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">New Ticket List</div>
            <div class="widget-icons pull-right"> <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> <a href="#" class="wsettings"><i class="fa fa-wrench"></i></a> <a href="#" class="wclose"><i class="fa fa-times"></i></a> </div>
            <div class="clearfix"></div>
          </div>
          <div class="widget-content">
          ...
          <input type="hidden" name="action" value="Close_Ticket">
            <table class="table table-striped table-bordered table-hover">
              ...
              <?php
			//print_r($_REQUEST); 
									mysql_query("update tickets set notification_status=1 where status=0") or die(mysql_error());
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=41&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=41&'.$search_string;
			}
