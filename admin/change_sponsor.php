        ...
        <div class="row">
          ...
          <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Change Sponsor</div>
			...
			?>
            	<div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Change Sponsor Of <?php echo $user_id;?> </div>
                  <div class="widget-icons pull-right"> <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> <a href="#" class="wsettings"><i class="fa fa-wrench"></i></a> <a href="#" class="wclose"><i class="fa fa-times"></i></a> </div>
                  <div class="clearfix"></div>
                </div>
                <div class="widget-content">
                        ...
                        <div class="form-group">
                          <div class="left-box">
                            <label for="name">Sponsor Id</label>
                     		<input type="text" class="validate[required] form-control placeholder" id="ref_id" name="ref_id" placeholder="Sponsor ID" data-bind="value: name" value="<?php echo $ref_id;?>" />
                        </div>
