...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <div class="matter">
      ...
      <a href="<?php echo SITE_URL; ?>admin/category.php"> <button class="btn btn-danger side"  type="button" id="button" >Add Category</button></a>
        ...
        <div class="widget">
          ...
          <div class="widget-content">
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='category_main.php?'.$query_string;
			}
			else
			{
				$url='category_main.php?1=1'.$search_string;
			}
			...
			while($row_cat=$obj_query->get_all_row($res_cat))
			{
			  ?>
                <tr>
                  ...
                  <td>&nbsp;
                  <span><a href="category.php?category_id=<?php echo $row_cat['c_id'];?>&category_name=<?php echo $row_cat['category_name'];?>" title="Edit"><img src="../images/edit.png" /></a></span>
                  <span style="margin-left:5px;"><a href="category_main.php?delete=1&category_id=<?php echo $row_cat['c_id'];?>" onclick="if(confirm('Do You Want To Delete')){ return true;}else{ return false;}" title="Delete"><img src="../images/Trashcan.png" /></a></span>
                  </td>
                </tr>
                <?php 
					$s_no++;
