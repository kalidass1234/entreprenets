...
if(isset($_REQUEST['search']) || $_REQUEST['user_id'])
{
	...
	$quer2="select user_id,user_name,plan_name from registration where nom_id_140='$id' and package_amount = '140.00' order by id";
...
<td align="center" valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
				...
				$sql_Count="select * from registration where nom_id_140='$id' ";
...
$strok="select * from registration where nom_id_140='$id' and package_amount = '140.00' order by id";
...
<td align="center" valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    <?php
$sql_subs1ss="select * from registration where nom_id_140='$id' and package_amount = '140.00' ";
...
if($count_subs1ss)
{
 ...
 <a href="admin_main.php?page_number=200&user_id=<?=$user_id;?>" class="tooltip1">
<img id="menu" src="<?php 
					  if(_check_member_status($user_id)==1){ ?>tree_new.php_files/retailassociate.png<?php } else if(_check_member_status($user_id)==2){ ?>tree_new.php_files/associate.png<?php } else if(_check_member_status($user_id)==4){ ?>tree_new.php_files/director.png<?php } //else if($x['image']){ echo "userimages/".$x['image'];} else {?>../paymentimage/<?=$img?><?php // }?>" width="32" height="32" />
    <span>
        <img class="callout" src="images/callout.gif" />
        <strong>
...
$quer22="select user_id,user_name,plan_name from registration where nom_id_140='".$xok['user_id']."' and package_amount = '140.00' order by id";
$data22=mysql_query($quer22);
while($x22=mysql_fetch_array($data22))
{
$arr22[]=$x22;
}
//print_r($arr22);
$ro22=mysql_num_rows($data22);
					  
			   for($i=1;$i<=3;$i++)
			   { 
  if($i<=$ro22){
$d=$arr22[$i-1][0];
$str22="select * from registration where user_id='$d' and package_amount = '140.00'";
$res22=mysql_query($str22);
$x22=mysql_fetch_array($res22);
$name22=$x22['first_name']." ".$x22['mid_name']." ".$x22['last_name'];

$package22=$x22['plan_name'];
$useridd=$arr22[$i-1][0];
...
if($count_subs1)
{
	...
	if($x22['package_amount'] == '35.00')
	{
		$img = "35.png";	
	}
	else if($x22['package_amount'] == '70.00')
	{
		$img = "70.png";	
	}
	else if($x22['package_amount'] == '140.00')
	{
		$img = "140.png";
	}
...
<a href="admin_main.php?page_number=200&user_id=<?=$arr22[$i-1][0];?>" class="tooltip1">
<img id="menu<?=$i ?>" src="<?php  if(_check_member_status($arr22[$i-1][0])==1){ ?>tree_new.php_files/retailassociate.png<?php } else if(_check_member_status($arr22[$i-1][0])==2){ ?>tree_new.php_files/associate.png<?php } else if(_check_member_status($arr22[$i-1][0])==4){ ?>tree_new.php_files/director.png<?php } //else if($x2['image']){ echo "userimages/".$x2['image'];} else {?>../paymentimage/<?=$img?><?php //}?>" width="32" height="32" border="0"/>
    <span>
        <img class="callout" src="images/callout.gif" />
        <strong>
                               ...
                               <table width="98%" border="0" cellspacing="1" cellpadding="1">
									  <tr>
										<td align="left">User ID</td>
										<td align="left"><?=$arr22[$i-1][0] ?></td>
									  </tr>
									  <tr>
										<td align="left">Full  Name</td>
										<td align="left"><?=$name22 ?></td>
									  </tr>
									  <tr>
										<td align="left">Mobile</td>
										<td align="left"><?=$x22[mobile]?></td>
									  </tr>
									  <tr>
										<td align="left">Country</td>
										<td align="left"><?=$x22['country'];?></td>
									  </tr>
									  <tr>
										<td align="left">Email</td>
										<td align="left"><?php echo $x22['email']; ?></td>
									  </tr>
									  <tr>
										<td align="left">Sponsor  ID</td>
										<td align="left"><?php echo $x22['ref_id']; ?></td>
									  </tr>
									  <tr>
										<td align="left">Member</td>
										<td align="left"><?=$x22[total_count];?></td>
									  </tr>
									  <tr>
										<td align="left">D.O.J</td>
										<td align="left"><?php echo $date22=date("d-m-y", strtotime($x22[reg_date])); ?></td>
									  </tr>
									</table>
                                        </span>
                                        </a></td>
          ...
          <tr style="color:#3399FF;">
			  ...
			  // print_r($arr2[$i-1]);
			   ...
			   $userid=$arr22[$i-1][0];
			   $sql_stat="select mem_status,package_amount from registration where user_id='$userid' and package_amount = '140.00'";
			   ...
			   $row_stat=mysql_fetch_assoc($res_stat);
				...
				{
			  ?>
          <td width="33%"><? echo $arr22[$i-1][0]."<br>".$arr22[$i-1][1]."<br>"."$".$row_stat['package_amount'];?><br><?php if($row_stat[mem_status]){ echo "<font color='red'>Inactive</font>";}?></td>
              <?
			  }
			  else
			  {
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer3="select user_id,user_name,plan_name from registration where nom_id_140='".$arr22[0][0]."' and package_amount = '140.00' order by id";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer4="select user_id,user_name,plan_name from registration where nom_id_140='".$arr22[1][0]."' and package_amount = '140.00' order by id";
...
if($count_subs1)
{
  ...
  ?>  <td><a href="tree_new_second.php?id=<?=$arr4[$i-1][0]?>" target="_self"><img id="menu<?=$i ?>" src="<?php  if(_check_member_status($arr4[$i-1][0])==1){ ?>tree_new.php_files/retailassociate.png<?php } else if(_check_member_status($arr4[$i-1][0])==2){ ?>tree_new.php_files/associate.png<?php } else if(_check_member_status($arr4[$i-1][0])==4){ ?>tree_new.php_files/director.png<?php } //else if($x2['image']){ echo "userimages/".$x2['image'];} else {?>../paymentimage/<?=$img?><?php //}?>" width="32" height="32" border="0"/></a>
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer5="select user_id,user_name,plan_name from registration where nom_id_140='".$arr22[2][0]."' and package_amount = '140.00' order by id";
...
if($count_subs1)
{
  ...
  ?>  <td><a href="tree_new_second.php?id=<?=$arr5[$i-1][0]?>" target="_self"><img id="menu<?=$i ?>" src="<?php  if(_check_member_status($arr5[$i-1][0])==1){ ?>tree_new.php_files/retailassociate.png<?php } else if(_check_member_status($arr5[$i-1][0])==2){ ?>tree_new.php_files/associate.png<?php } else if(_check_member_status($arr5[$i-1][0])==4){ ?>tree_new.php_files/director.png<?php } //else if($x2['image']){ echo "userimages/".$x2['image'];} else {?>../paymentimage/<?=$img?><?php //}?>" width="32" height="32" border="0"/></a>
					 <div class="flyout<?=$i ?> hidden">
                               <table width="98%" border="0" cellspacing="1" cellpadding="1">
									  <tr>
										<td align="left">User ID</td>
