...
//You can customize the query to filter from particular date and month etc...Which will depends your database structure.
 ...
 if($admin_type=='super_admin')
			 ...
			 $user_query=mysql_query("select * from direct_referral_bonus d inner join registration r on d.income_id=r.user_id where d.income_id!='cmp' $country_search order by d.l_id desc");
