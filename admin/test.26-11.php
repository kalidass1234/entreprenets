...
<!--    <?php
    	// get level 
		//echo $first_id=$_REQUEST['first_id'];
		...
		<ul class="tree">
			<li>
				...
				<ul >
					<li>
                    	<?php 
						$row_left1=showlegid($user_id,'left'); 
						...
						<ul>
							<li>
                            <?php 
							$row_left11=showlegid($row_left1['user_id'],'left'); 
							//echo "<pre>"; print_r($row_left1);
							?>
								<div class="current"> 
							...
							<li>
                            <?php 
							$row_right11=showlegid($row_left1['user_id'],'right');
					...
					<li>
                    	<?php 
						$row_right1=showlegid($user_id,'right');
						//echo "<pre>"; print_r($row_right1); 
						?>
						<div class="current">
						...
						<ul>
							<li>
                            <?php 
							$row_left11=showlegid($row_right1['user_id'],'left'); 
							//echo "<pre>"; print_r($row_left1);
							?>
								<div class="current">
                                <?php if($row_left11['user_id']){?>
							...
							<li>
                            <?php 
							$row_right11=showlegid($row_right1['user_id'],'right');
							//echo "<pre>"; print_r($row_right1); 
							?>
								<div class="current">
                                <?php if($row_right11['user_id']){?>
