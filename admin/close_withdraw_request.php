...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <!-- Page heading -->
    <div class="page-head">
      <h2 class="pull-left">Closed Withdraw Request</h2>
      <div class="clearfix"></div>
      <!-- Breadcrumb -->
      <div class="bread-crumb "> <a href="index.php"><i class="fa fa-home"></i> Home</a> 
        <!-- Divider --> 
        <span class="divider">/</span> <a href="#" class="bread-current">Close Withdraw Request</a> </div>
      <div class="clearfix"></div>
    ...
    <div class="matter">
      ...
      <div class="clearfix"></div>
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Close Withdraw List</div>
            <div class="widget-icons pull-right"> <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> <a href="#" class="wsettings"><i class="fa fa-wrench"></i></a> <a href="#" class="wclose"><i class="fa fa-times"></i></a> </div>
            <div class="clearfix"></div>
          </div>
          <div class="widget-content">
          ...
          <input type="hidden" name="action" value="Close_Withdraw_Bank">
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=44&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=44&'.$search_string;
			}
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=mysql_query("select * from withdraw_fund where status=1 $search_string $con_search order by id desc") ;
			  
			 // $res_products_tol=$obj_query->query("id","withdraw_fund","status=1 $search_string $con_search order by id desc ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);

			  $res_cat=mysql_query("select * from withdraw_fund where status=1 $search_string $con_search order by id desc $limit");
			...
			while($row_cat=$obj_query->get_all_row($res_cat))
			{
			  ?>
                <tr>
                  ...
                  <td><?php echo $row_cat['varify_date']; ?></td>
