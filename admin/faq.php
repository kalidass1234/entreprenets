  ...
  <div class="mainbar">
    ...
    <div class="matter">
      <div class="container">
        ...
        <div> <a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add More FAQ</a>
          <!-- Modal -->
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control placeholder" name="question" id="question" placeholder=" Question" data-bind="value: name" />
                    </div>
                    <div class="form-group">
                      <label for="name">Answer</label>
                      <textarea class="form-control for-height" rows="3" id="editor2"  name="answer"  placeholder="Textarea"><?php echo $url;?></textarea>
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">FAQ Details</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from faq where id='$mid'");
				}
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='admin_main.php?page_number=26&'.$query_string;
				}
				else
				{
					$url='admin_main.php?page_number=26&'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
				if($per_page != "all"){
					...
					$limit = " ";
			  $res_products_tol=$obj_query->query("*","faq","1=1 ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
			  
                $res_prod=$obj_query->query("*","faq","1=1 $limit");
				$sn=1;
                ...
                <tr>
                  ...
                  <td><?php echo $row_prod['answer'];?></td>
                  
                 
                  <td><?php echo $row_prod['ts'];?></td>
                  <td><a href="admin_main.php?page_number=26&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
                  <td><a href="#myModal" onClick="showmaterialform('<?php echo $row_prod['id'];?>');" data-toggle="modal"><button class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i> </button></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showfaqform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
