  ...
  <div class="mainbar">
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a>
        <!-- Divider -->
        <span class="divider">/</span> <a href="#" class="bread-current">News</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends -->
    <!-- Matter -->
    ...
    <div class="matter">
      <div class="container">
        ...
        <div> <a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add News</a>
          <!-- Modal -->
	...
	function change_status(status,id)
	{
		  ...
		  var con=confirm("Do you want to change display status?"); 
		   if(con==true)
			   {
				   var link="admin_main.php?page_number=32&id="+id+"&news_status="+status+"&action1=status";
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                  	    <div class="form-group">
                           ...
                           <input class="form-control for-height" type="text" id="news_title" name="news_title" value="" />
                           <input type="hidden" id="added_date" name="added_date" value="<?=$cur_date;?>" />
                           
                        </div>
                  	    <div class="form-group">
                           <label for="name">Member Name</label>
                           <input class="form-control for-height" type="text" id="member_name" name="member_name" value="" />
                        </div>
                        <div class="form-group">
                           ...
                           <?php
							...
							{?>
                             	<input type="checkbox" id="cat_id[]" name="cat_id[]" value="<?=$records['title']?>" /><?=$records['title']?>
                           <?php } ?>
                        </div>
                        ...
                        <div class="form-group">
                  	    ...
                  	    <div class="form-group">
                           ...
                           <input type="radio" id="news_status2" name="news_status" value="1" checked/>Yes
                           <input type="radio" id="news_status1" name="news_status" value="0" />No
                        </div>
                        
                        <div class="form-group">
                          <label for="name">Content</label>
                          <textarea class="form-control for-height" rows="3" id="editor21" name="news_desc" placeholder="Textarea"><?php echo $news_desc;?></textarea>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from manage_news where id='$mid'");
				}
				...
				if(isset($_GET['action1']) && isset($_GET['id']))
				{
					...
					$sql_change = "UPDATE manage_news set news_status='".$status."' WHERE id='".$_GET['id']."'";
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='admin_main.php?page_number=32&'.$query_string;
				}
				else
				{
					$url='admin_main.php?page_number=32&'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
				if($per_page != "all"){
					...
					$limit = " ";
			  	$res_products_tol=$obj_query->query("*","manage_news","1=1 ");
			  	$total_row=$obj_query->num_row($res_products_tol);
			  	$pages = ceil($total_row/$per_page);
                $res_prod=$obj_query->query("*","manage_news","1=1 $limit");
				$sn=1;
				...
				?>
                    <tr>
                      <td><?php echo $sn;?></td>
                      <td><?php echo $row_prod['news_title'];?></td>
					                        <td><a href="admin_main.php?page_number=196&news_id=<?php echo $row_prod['id'];?>" data-toggle="modal">Manage News Slider</a>
                      </td>
                      <td><?php echo $row_prod['added_date'];?></td>
                      <!--<td><?php echo $row_prod['binary_type1'];?></td>-->
                      <td>	   
					  	<?php if(stripslashes($row_prod["news_status"])=='1'){?>
                      ...
                      <!--<td><a href="admin_main.php?page_number=32&id=<?php echo $row_prod['id'];?>" >Enable Disable</a></td>-->
                      <td><a href="admin_main.php?page_number=32&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showeeditnews";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
