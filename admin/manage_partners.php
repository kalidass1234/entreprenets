  ...
  <div class="mainbar">
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a>
        <!-- Divider -->
        <span class="divider">/</span> <a href="#" class="bread-current">Our Partners</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends -->
    <!-- Matter -->
    ...
    <div class="matter">
      <div class="container">
        ...
        <div> <a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add Partners</a>
          <!-- Modal -->
	...
	function change_status(status,id)
	{
		  ...
		  var con=confirm("Do you want to change display status?"); 
		   if(con==true)
			   {
				   var link="admin_main.php?page_number=35&id="+id+"&display_status="+status+"&action1=status";
         	  ...
         	  <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Partners (For About Us Page)</h4>
                  </div>
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Our Partners List</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from manage_partner where id='$mid'");
				}
				...
				if(isset($_GET['action1']) && isset($_GET['id']))
				{
					...
					$sql_change = "UPDATE manage_partner set display_status='".$status."' WHERE id='".$_GET['id']."'";
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='admin_main.php?page_number=35&'.$query_string;
				}
				else
				{
					$url='admin_main.php?page_number=35&'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
				if($per_page != "all"){
					...
					$limit = " ";
			  	$res_products_tol=$obj_query->query("*","manage_partner","1=1 ");
			  	$total_row=$obj_query->num_row($res_products_tol);
			  	$pages = ceil($total_row/$per_page);
                $res_prod=$obj_query->query("*","manage_partner","1=1 $limit");
				$sn=1;
				...
				?>
                    <tr>
                     ...
                     <!-- <td><?php echo $row_prod['added_date'];?></td>-->
                      ...
                      <!--<td><a href="admin_main.php?page_number=35&id=<?php echo $row_prod['id'];?>" >Enable Disable</a></td>-->
                      <td><a href="admin_main.php?page_number=35&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showeeditpartner";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
