...
<div class="content">
  ...
  <div class="mainbar">
    ...
    <div class="matter">
      <div class="container">
      <?php
      $res_products_tol=$obj_query->query("*","cms_registration","1=1 ");
	  $total_row=$obj_query->num_row($res_products_tol);
	  ?>
        <div> <?php if(!$total_row){?><a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add Registration Term And Condition</a><?php }?>
          <!-- Modal -->
                ...
                <div class="modal-content">
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control for-height" rows="3" id="editor2"  name="content"  placeholder="Textarea"><?php echo $description;?></textarea>
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Registration Term And Condition Details</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from cms_registration where id='$mid'");
				}
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='admin_main.php?page_number=151&'.$query_string;
				}
				else
				{
					$url='admin_main.php?page_number=151&'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
                ...
                $res_prod=$obj_query->query("*","cms_registration","1=1 $limit");
				$sn=1;
				...
				?>
                    <tr>
                      ...
                      <td><?php echo $row_prod['content'];?></td>
                      
                      <td><a href="admin_main.php?page_number=151&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showhomeregtandcform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
