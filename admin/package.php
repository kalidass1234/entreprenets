                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                       <div class="form-group">
                          ...
                          <input class="form-control for-height" type="text" name="package_name" value="" />
                       </div>
                       <div class="form-group">
                          <label for="name">Package Amount</label>
                          <input class="form-control for-height" type="text" id="total_price" name="total_price" value="" onblur ="total_prices();"/>
                       </div>
                       ...
                       <div class="form-group">
                          ...
                          <input class="form-control for-height" type="text" name="first_level_comm" value="" />
                       </div>
                       <div class="form-group">
                          <label for="name">Second Level Commission(%)</label>
                          <input class="form-control for-height" type="text" name="second_level_comm" id="second_level_comm" value=""/>
                       </div>
                   </div>

                    <div class="form-group">
                      <label for="name">Content</label>
                      <textarea class="form-control for-height" rows="3" id="editor2"  name="package_desc"  placeholder="Textarea"><?php echo $description;?></textarea>
