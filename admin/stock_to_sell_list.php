         ...
         <div class="row">
            <div class="col-md-12">
              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="stock_to_sell_list.php" class="validate" method="post" id='form1'>
                      <fieldset>
          ...
          <div class="widget">
                <div class="widget-head">
                  ...
                  <input type="hidden" name="action" value="Add_Stock_To_Sell" />
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						...
						if(isset($_REQUEST['search']))
						{
							...
							$url='member_list.php?'.$query_string;
						}
						else
						{
							$url='member_list.php?1=1'.$search_string;
						}
						//echo $search_string;
						//$url='member_list.php?';
						...
						/*if(isset($_REQUEST['search']))
						{*/
                        $res=$obj_query->query("*","stock_to_sell_mp","status=0 $search_string $limit");
						$res_products_tol=$obj_query->query("id","stock_to_sell_mp","status=0  $search_string $con_search ");
                        ...
                        <tr>
                          ...
                          <td><?php echo $row_user['user_name'];?></td>
                           <td><?php echo $obj_query->get_field_name("product_category","product_name","p_cat_id='$row[product_id]'");?></td>
                          <td><?php if($row['status']){ echo "YES";}else{ echo "NO";}?></td>
                        </tr>
						<?php
						$sno++;
                        }
