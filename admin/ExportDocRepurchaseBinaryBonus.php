...
$heading.="<table border='1'><tr>";
						$heading.="<td>Date</td><td>Member Id</td><td>Left Carry Forword</td><td>Right Carry Forword</td><td>Left Match</td><td>Right Match</td><td>Cycle</td><td>Bonus(BV)</td><td>Bonus($)</td><td>TDS(%)</td><td>TDS Amount</td><td>Miscellaneous(%)</td><td>Miscellaneous Amount</td><td>Final Bonus(USD)</td></tr>";
