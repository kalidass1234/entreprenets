            ...
            <div class="col-md-12">
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=186"  method="post" class="validate" id='form1'>
                      <fieldset>
        ...
        function setLocation(url)
{
	window.location.href=url;
                        ...
                        <img src="../images/excel.png" onClick="setLocation('ExportExcelRepurchaseBinaryBonus.php');" name="getReport" id="getReport" >
                       <img src="../images/word.png" onClick="setLocation('ExportDocRepurchaseBinaryBonus.php');" name="getReport" id="getReport">
   ...
   document.body.innerHTML = originalContents;
          ...
          <div class="widget">
			...
			if(isset($_REQUEST['search']))
			{
				...
				{
                $search_string.=" and m.b_date between '$from_date' and '$to_date'";
                }
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=186&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=186&'.$search_string;
			}
			...
			if($per_page != "all"){
			  ...
			  $res_cat=mysql_query("select * from repurchase_binary_income m inner join registration r on m.user_id=r.user_id where m.user_id!='cmp' $country_search $search_string $con_search order by m.id desc $limit");
