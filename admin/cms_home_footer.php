                  ...
                  <div class="modal-body">
                   <div class="form-group">
                      ...
                      <select name="category" class="form-control placeholder">
						...
						$obj_function->_get_cms_home_footer_category_dropdown();
						?>
                       <!-- <option value="Responsive System">Responsive System</option>
                        <option value="2">A Bigger Vission</option>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from cms_home_footer where id='$mid'");
				}
				...
				if($per_page != "all"){
					...
					$limit = " ";
			  $res_products_tol=$obj_query->query("*","cms_home_footer","1=1 ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
			  
                $res_prod=$obj_query->query("*","cms_home_footer","1=1 $limit");
				$sn=1;
                ...
                <tr>
                  <td><?php echo $sn;?></td>
                  <td><?php echo $obj_function->cms_home_footer_arr[$row_prod['category']];//$category_name;//?></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showcmshomefooterform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
