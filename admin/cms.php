            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				if($per_page != "all"){
					...
					$limit = " ";
			  $res_products_tol=$obj_query->query("*","cms","1=1 ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
			  
                $res_prod=$obj_query->query("*","cms","1=1 $limit");
				$sn=1;
                ...
                <tr>
                  ...
                  <td><a href="cms.php?delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showcmsform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
