...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <?php
	$userid=$_GET['userid'];
    // chekc the 30 products of the stock to sell
	$res_c=$obj_query->query("*","stock_to_sell_mp","user_id='$userid' and status=0 ");
	$count_c=$obj_query->num_row($res_c);
	
	$res_cd=$obj_query->query("*","weekly_adds_mp","user_id='$userid' and status=0");
	$count_cd=$obj_query->num_row($res_cd);
	
	$res_c1=$obj_query->query("*","stock_qualification_mp","user_id='$userid'");
	$count_c1=$obj_query->num_row($res_c1);
	?>    
...
if(catids==''){ alert("Please select 30 products"); return false;}
	var formData="action=show_stock_to_sell&product_id="+catids+"&user_id="+id;
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
...
if(catids==''){ alert("Please select 3 products"); return false;}
	var formData="action=show_qualification&product_id="+catids+"&user_id="+id;
    $.ajax({
        url: 'ajax.php',
        data: formData,
        processData: false,
...
if(catids==''){ alert("Please select 5 products"); return false;}
	var formData="action=show_daily_task&product_id="+catids+"&user_id="+id;
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
