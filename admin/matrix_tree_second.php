...
if(isset($_REQUEST['search']) || $_REQUEST['user_id'])
{
	...
	$quer2="select user_id,user_name,plan_name from registration where nom_id_70='$id' and package_amount = '70.00' order by id";
...
<td align="center" valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
				...
				$sql_Count="select * from registration where nom_id_70='$id' ";
...
$quer22="select user_id,user_name,plan_name from registration where nom_id_70='".$xok['user_id']."' and package_amount = '70.00' order by id";
...
$ro22=@mysql_num_rows($data22);
  ...
  if($i<=$ro22){
$d=$arr22[$i-1][0];
$str22="select * from registration where user_id='$d' and package_amount = '70.00'";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer3="select user_id,user_name,plan_name from registration where nom_id_70='".$arr22[0][0]."' and package_amount = '70.00' order by id";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer4="select user_id,user_name,plan_name from registration where nom_id_70='".$arr22[1][0]."' and package_amount = '70.00' order by id";
...
<!--                    <tr>
			  ...
			  for($i=1;$i<=3;$i++)
			   ...
			   for($i=1;$i<=3;$i++)
			   { 
$quer5="select user_id,user_name,plan_name from registration where nom_id_70='".$arr22[2][0]."' and package_amount = '70.00' order by id";
