  ...
  <div class="mainbar">
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> <a href="index.php"><i class="fa fa-home"></i> Home</a>
        <!-- Divider -->
        <span class="divider">/</span> <a href="#" class="bread-current">News Category</a> </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends -->
    <!-- Matter -->
    ...
    <div class="matter">
      <div class="container">
        ...
        <div> <a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add News Category</a>
          <!-- Modal -->
	...
	function change_status(status,id)
	{
		  ...
		  var con=confirm("Do you want to change display status?"); 
		   if(con==true)
			   {
				   var link="admin_main.php?page_number=195&id="+id+"&display_status="+status+"&action1=status";
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control for-height" rows="3" id="editor21" name="cat_desc" placeholder="Textarea"><?php echo $cat_desc;?></textarea>
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">News Category List</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from manage_category_news where id='$mid'");
				}
				...
				if(isset($_GET['action1']) && isset($_GET['id']))
				{
					...
					$sql_change = "UPDATE manage_category_news set display_status='".$status."' WHERE id='".$_GET['id']."'";
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='admin_main.php?page_number=195&'.$query_string;
				}
				else
				{
					$url='admin_main.php?page_number=195&'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
				if($per_page != "all"){
					...
					$limit = " ";
			  	$res_products_tol=$obj_query->query("*","manage_category_news","1=1 ");
			  	$total_row=$obj_query->num_row($res_products_tol);
			  	$pages = ceil($total_row/$per_page);
                $res_prod=$obj_query->query("*","manage_category_news","1=1 $limit");
				$sn=1;
				...
				?>
                   ...
                   <!--   <td><a href="admin_main.php?page_number=5&cat_id=<?php echo $row_prod['id'];?>" data-toggle="modal">Manage News</a>
                      </td>-->
                      <!--<td><a href="admin_main.php?page_number=196&id=<?php echo $row_prod['id'];?>" data-toggle="modal">Manage News Slider</a>
                      </td>-->
                      ...
                      <!--<td><a href="admin_main.php?page_number=195&id=<?php echo $row_prod['id'];?>" >Enable Disable</a></td>-->
                      <td><a href="admin_main.php?page_number=195&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showeeditcat";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
