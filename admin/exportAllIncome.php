...
header("Content-Disposition: attachment; filename=exportAllIncome.csv");
...
$sql = "select * from level_income where 1 GROUP by income_id order by l_id desc ";
$res = mysql_query($sql);
$totc_unpaid = 0;
$total = 0;
$content = '';
...
while($row=mysql_fetch_assoc($res))
{
	...
	$res_catb=mysql_fetch_array(mysql_query("select SUM(commission) as commissions from level_income where 1 AND income_id!='56789' AND income_id='".$row['income_id']."' "));
