...
<div class="content">
  ...
  <div class="mainbar">
    ...
    <div class="matter">
      <div class="container">
      <?php
      $res_products_tol=$obj_query->query("*","static_page","1=1 ");
	  $total_row=$obj_query->num_row($res_products_tol);
	  ?>
        <div> <?php if(!$total_row){?><a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add Member Remark</a><?php }?>
          <!-- Modal -->
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Member Remark Details</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from static_page where id='$mid'");
				}
                ...
                $res_prod=$obj_query->query("*","static_page","1=1 $limit");
				$sn=1;
				...
				?>
                    <tr>
                      ...
                      <td><a href="admin_main.php?page_number=46&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showmemberremarkform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
