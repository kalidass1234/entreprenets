  ...
  <div class="mainbar">
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb"> 
        ...
        <!-- Divider -->
        <span class="divider">/</span> <a href="#" class="bread-current">Page</a> 
        <span class="divider">/</span> <a href="#" class="bread-current"><?=$getInfoByTableNameAndID['page_name']?></a> 
      </div>
      <div class="clearfix"></div>
    </div>
    <!-- Page heading ends -->
    ...
    <div class="matter">
      <div class="container">
        ...
        <div> <a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add More Sub Page</a>
         	  ...
         	  <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Sub Pages [<?=$getInfoByTableNameAndID['page_name'];?>]</h4>
                  </div>
                  <div class="modal-body">
                       <div class="form-group">
                          <label for="name">Page Title</label>
                          <input class="form-control for-height" type="text" name="page_name" value="" />
                          <input class="form-control for-height" type="hidden" name="page_id" value="<?=$id;?>" />
                       </div>
                       <div class="form-group">
                          <label for="name">Page Url</label>
                          <input class="form-control for-height" type="text" id="page_url" name="page_url" value="" />
                       </div>
                        <div class="form-group">
                          <label for="name">Page Heading Desc</label>
                          <textarea class="form-control for-height" rows="3" id="editor1"  name="page_desc_head"  placeholder="Textarea"><?php echo $page_desc_head;?></textarea>
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Sub Pages List</div>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from manage_content where id='$mid'");
				}
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='admin_main.php?page_number=27&'.$query_string;
				}
				else
				{
					$url='admin_main.php?page_number=27&'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
				if($per_page != "all"){
					...
					$limit = " ";
			  	$res_products_tol=$obj_query->query("*","manage_content","1=1 AND page_id=$id ");
			  	$total_row=$obj_query->num_row($res_products_tol);
			  	$pages = ceil($total_row/$per_page);
                $res_prod=$obj_query->query("*","manage_content","1=1  AND page_id=$id  $limit");
				$sn=1;
				...
				?>
                    <tr>
                      ...
                      <!--<td><a href="admin_main.php?page_number=27&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>-->
                      <td><a href="#myModal" onClick="showmaterialform(<?php echo $row_prod['id'];?>,<?php echo $id;?>);"  data-toggle="modal"><button class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i> </button><!--<img src="images/edit.png">--></a>
                      </td>
...
<script type="text/javascript">
function showformmaterial(id,page_id)
{
	//alert(id);
	document.getElementById('material_id').value=id;
	showmaterialform(id);
}
function showmaterialform(id,page_id) {
	
	var formData="m_id="+id+"&page_id="+page_id+"&action=showeeditsubpage";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
