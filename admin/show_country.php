...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <div class="matter">
          ...
          <div class="col-md-12">
            ...
            <div class="widget">
             <div class="widget-head">
                <div class="pull-left">Country Filters</div>
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        <div class="left-box">
                          ...
                          <input type="text" class="validate[required] form-control placeholder" name="country_name" value="<?php echo $_POST['country_name'];?>" id="category_name" placeholder="Country name" data-bind="value: name" />
                        </div>
                        <div class="left-box">
      ...
      <a href="<?php echo SITE_URL; ?>admin/admin_main.php?page_number=183"> <button class="btn btn-danger side"  type="button" id="button" >Add Country</button></a>
      
           <div class="clearfix"></div>
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Country List</div>
            <div class="widget-icons pull-right"> <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> <a href="#" class="wsettings"><i class="fa fa-wrench"></i></a> <a href="#" class="wclose"><i class="fa fa-times"></i></a> </div>
            <div class="clearfix"></div>
          </div>
          <div class="widget-content">
			...
			{
				$c_id=$_REQUEST['country_id'];
				$obj_query->query_execute("delete from country where id='$c_id'");
			}
			if(isset($_REQUEST['search']))
			{
				...
				{
					$search_string.=" and country_name like '%$country_name%'";
					$query_string.="&country_name='$country_name'";
				}
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=184&'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=184&'.$search_string;
			}
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=$obj_query->query("id","country","1=1 $search_string $con_search order by country_name ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
						 
			  $res_cat=$obj_query->query("*","country"," 1=1 $search_string $con_search order by country_name $limit");
			...
			while($row_cat=$obj_query->get_all_row($res_cat))
			{
			  ?>
                <tr>
                  <td><?php echo $s_no; ?></td>
                  <td><?php echo ucwords($row_cat['country_name']); ?></td>
                  <td><?php echo $row_cat['tds']; ?></td>
                  <td><?php echo $row_cat['miscellaneous']; ?></td>
                  <!--<td><img src="<?php echo SITE_URL."images/".$row_cat['icon']; ?>" /></td>-->
                  <td><?php echo $row_cat['add_date']; ?></td>
                  <!--<td><?php echo $row_cat['last_modify']; ?></td>-->
                  <td>&nbsp;
                  <span><a href="admin_main.php?page_number=183&country_id=<?php echo $row_cat['id'];?>&country_name=<?php echo $row_cat['country_name'];?>" title="Edit"><img src="../images/edit.png" /></a></span>
                  <span style="margin-left:5px;"><a href="admin_main.php?page_number=184&delete=1&country_id=<?php echo $row_cat['id'];?>" onclick="if(confirm('Do You Want To Delete')){ return true;}else{ return false;}" title="Delete"><img src="../images/Trashcan.png" /></a></span>
                  </td>
                </tr>
                <?php 
					$s_no++;
