  	...
  	<div class="mainbar">
        ...
        <div class="container">
         <div class="row">
            ...
            <div class="col-md-12">
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Total Downline Member </div>
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="left-box">
                            ...
                            <input type="text" class="validate[required] form-control placeholder" id="user_id" name="user_id" value="<?php echo $_REQUEST['user_id'];?>" placeholder="User ID/User name" data-bind="value: name" />
          ...
          <div class="widget">
	       <div class="widget-head">
                  <div class="pull-left">Downline Member List</div>
           ...
           <div class="widget-content">
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='downline_member.php?'.$query_string;
			...
			?>
                ...
                ?>                      
                <tr>
                <td><?php echo $dir_count+$i+1;?></td>
                <td><?php echo $ff_dn['user_name'];?></td>
                <td><?php echo $ff_dn['user_id'];?></td>
                <td><?php echo $ff_dn['nom_id'];?></td>
                <td><?php echo $obj_query->get_field_name("registration","user_name","user_id='$ff_dn[nom_id]'"); ?></td>
                <td><?php echo ucwords($ff_dn['ref_id']); ?></td>
                <td><?php echo $obj_query->get_field_name("registration","user_name","user_id='$ff_dn[ref_id]'"); ?></td>
                <td><?php echo $ff_dn['reg_date']; ?></td>
                <td><?php echo $status_d;?></td>
                </tr>
                <?php
                $srl1++;
