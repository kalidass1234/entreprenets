                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						...
						if(isset($_REQUEST['search']))
						{
							...
							$url='admin_main.php?page_number=4&'.$query_string;
						}
						else
						{
							$url='admin_main.php?page_number=4&'.$search_string;
						}
						//echo $search_string;
						//$url='member_list.php?';
						...
						if($per_page != "all"){
							...
							$limit = " ";
						//echo $limit;
                        $res=$obj_query->query("*","subscription","1=1 $search_string $limit");
						$res_products_tol=$obj_query->query("id","subscription","1=1 $search_string $con_search ");
