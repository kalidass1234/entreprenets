            ...
            <div class="col-md-12">
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="admin_main.php?page_number=24"  method="post" class="validate" id='form1'>
                      <fieldset>
        ...
        <div class="row">  <div class="printer"><img src="images/printer_icon.png"></div></div>
          <div class="widget">
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='admin_main.php?page_number=24'.$query_string;
			}
			else
			{
				$url='admin_main.php?page_number=24'.$search_string;
			}
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=$obj_query->query("am_id","amount_detail","status=2 $search_string $con_search order by am_id desc ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
						 
			  $res_cat=$obj_query->query("*","amount_detail"," status=2 $search_string $con_search order by am_id desc $limit");
			  ...
			  while($row_cat=$obj_query->get_all_row($res_cat))
			 {
              ?>
                <tr>
                    ...
                    <td><?php echo $row_cat['shipping'];?></td>
