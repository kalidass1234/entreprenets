                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						...
						if(isset($_REQUEST['search']))
						{
							...
							$url='admin_main.php?page_number=171&'.$query_string;
						}
						else
						{
							$url='admin_main.php?page_number=171&'.$search_string;
						}
						//echo $search_string;
						//$url='member_list.php?';
						...
						if($per_page != "all"){
							...
							$limit = " ";
						//echo $limit;
                        $res=$obj_query->query("*","registration","bonus_request=1 and bonus=0 $search_string order by this_login desc $limit");
						$res_products_tol=$obj_query->query("id","registration","bonus_request=1 and bonus=0 $search_string $con_search ");
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['bonus_request_date'];?></td>
                          <td><a href="activate_member.php?user_id=<?php echo $row['user_id'];?>">Activate</a></td>
