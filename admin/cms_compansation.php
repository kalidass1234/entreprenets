...
<div class="content">
  ...
  <div class="mainbar">
    ...
    <div class="matter">
      <div class="container">
      <?php
      $res_products_tol=$obj_query->query("*","cms_compansation","1=1 ");
	  $total_row=$obj_query->num_row($res_products_tol);
	  ?>
        <div> <?php if(!$total_row){?><a href="#myModal" class="btn btn-info" data-toggle="modal" onClick="showformmaterial('');">Add CMS Compansation</a><?php }?>
          <!-- Modal -->
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from cms_compansation where id='$mid'");
				}
                ...
                $res_prod=$obj_query->query("*","cms_compansation","1=1 $limit");
				$sn=1;
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showhomecompansationform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
