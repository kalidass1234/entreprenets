        ...
        <div class="row">  <div class="printer"><img src="images/printer_icon.png"></div></div>
          <div class="widget">
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=$obj_query->query("l_id","level_income_faststart","1=1 $search_string $con_search order by l_id desc ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
						 
			  $res_cat=$obj_query->query("*","level_income_faststart"," 1=1 $search_string $con_search order by l_id desc $limit");
