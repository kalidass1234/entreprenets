  	...
  	<div class="mainbar">
            ...
            <div class="col-md-12">
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Direct Sell Bonus Detail </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    <form action="residual_commission_report.php"  method="post" class="validate" id='form1'>
                      <fieldset>
        ...
        <div class="row">  <div class="printer"><img src="images/printer_icon.png"></div></div>
          <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Direct Sell Bonus</div>
			...
			if(isset($_REQUEST['search']))
			{
				...
				$url='residual_commission_report.php?'.$query_string;
			}
			else
			{
				$url='residual_commission_report.php?1=1'.$search_string;
			}
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=$obj_query->query("l_id","level_income_bonus","1=1 $search_string $con_search order by l_id desc ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
						 
			  $res_cat=$obj_query->query("*","level_income_bonus"," 1=1 $search_string $con_search order by l_id desc $limit");
			  
			  $s_no = 1+$start;
			  $arr_status=array("Paid","Cancel");
