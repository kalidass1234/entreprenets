...
<div class="content"> 
  ...
  <div class="mainbar"> 
    ...
    <div class="matter">
      ...
      <a  style="float:left" href="<?php echo SITE_URL; ?>admin/admin_main.php?page_number=28"> <button class="btn btn-danger side"  type="button" id="button" >Add Category</button></a>&nbsp;&nbsp;
        ...
        <div class="widget">
          ...
          <div class="widget-content">
			...
			if($per_page != "all"){
			  ...
			  $res_products_tol=$obj_query->query("id","cms_category","1=1 $search_string $con_search order by category_name ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
						 
			  $res_cat=$obj_query->query("*","cms_category"," 1=1 $search_string $con_search order by category_name $limit");
			...
			while($row_cat=$obj_query->get_all_row($res_cat))
			{
			  ?>
                <tr>
                  ...
                  <td>&nbsp;
                  <span><a href="admin_main.php?page_number=28&category_id=<?php echo $row_cat['id'];?>&category_name=<?php echo $row_cat['category_name'];?>" title="Edit"><img src="../images/edit.png" /></a></span>
                  <span style="margin-left:5px;"><a href="admin_main.php?page_number=27&delete=1&category_id=<?php echo $row_cat['id'];?>" onclick="if(confirm('Do You Want To Delete')){ return true;}else{ return false;}" title="Delete"><img src="../images/Trashcan.png" /></a></span>
                  </td>
                </tr>
                <?php 
					$s_no++;
