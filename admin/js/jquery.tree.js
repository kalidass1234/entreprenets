						...
						if(_addthis.closest('form').find('textarea').val() != '') {
							...
							//$.ajax({
								...
								//success: function(data) {
									var html_value = '<li>' + vertical_line_text + horizontal_line_text + '<div id="'+ajax_add_id+'">' + highlight_text + add_action_text + delete_action_text + edit_action_text + _addthis.closest('form').find('textarea').val() + '</div></li>';
