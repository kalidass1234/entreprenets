                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <select name="category" class="form-control placeholder">
                        ...
                        <?php
                        $obj_function->_get_cms_home_category_dropdown();
						?>
                      </select>
          ...
          <div class="widget-content">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
				...
				{
					$mid=$_GET['id'];
					$obj_query->query_execute("delete from cms_home where id='$mid'");
				}
				...
				if(isset($_REQUEST['search']))
				{
					...
					$url='admin_main.php?page_number=30&'.$query_string;
				}
				else
				{
					$url='admin_main.php?page_number=30&'.$search_string;
				}
				//echo $current_page;
				$pageno = $current_page;
				$per_page=10;
				if($per_page != "all"){
					...
					$limit = " ";
			  $res_products_tol=$obj_query->query("*","cms_home","1=1 ");
			  $total_row=$obj_query->num_row($res_products_tol);
			  $pages = ceil($total_row/$per_page);
			  
                $res_prod=$obj_query->query("*","cms_home","1=1 $limit");
				$sn=1;
                ...
                <tr>
                  <td><?php echo $sn;?></td>
                  <td><?php echo $obj_function->cms_home_arr[$row_prod['category']];//$category_name;//?></td>
                  ...
                  <td><a href="admin_main.php?page_number=30&delete=1&id=<?php echo $row_prod['id'];?>" onClick="if(confirm('Do You Want To Delete')){return true;} else { return false;}"><img src="images/intext-close5.png"></a></td>
...
function showmaterialform(id) {
	var formData="m_id="+id+"&action=showcmshomeform";
	//alert(formData);
    $.ajax({
        url: 'ajax.php',
        data: formData,
