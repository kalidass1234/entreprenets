        ...
        <div class="container">
          ...
          <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Member Login List</div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
						...
						if(isset($_REQUEST['search']))
						{
							...
							$url='admin_main.php?page_number=170&'.$query_string;
						}
						else
						{
							$url='admin_main.php?page_number=170&'.$search_string;
						}
						//echo $search_string;
						//$url='member_list.php?';
						...
						if($per_page != "all"){
							...
							$limit = " ";
						//echo $limit;
                        $res=$obj_query->query("*","registration","this_login<>'0000-00-00 00:00:00' and this_login>last_login $search_string $country_search order by this_login desc $limit");
						$res_products_tol=$obj_query->query("id","registration","this_login<>'0000-00-00 00:00:00' and this_login>last_login $search_string $con_search $country_search ");
