...
<div id="titlebar" class="titlebar-hautq cover">
			<div class="container relative">
				<div id="titlebar-text">
											...
											<div class="titlebar-text-content"><?=$getInfoByTableNameAndID['page_head']?>
</div>
									</div>
									<div id="titlebar-breadcrumb"><div id="breadcrumb" class="ui--box-alias centerVertical"><div class="ui-bc ui-breadcrumbs breadcrumbs" itemprop="breadcrumb"><span class="ui-bc-first"><a href="http://envision.wptation.com" title="Envision" rel="home" class="ui-bc-first">Home</a></span> <span class="ui-bc-seperator"> <i class="ui--caret fontawesome-angle-right px18"></i> </span> <span class="ui-bc-last">About Us 2</span></div></div></div>
							</div>
		</div><!-- /#titlebar -->
...
<div  id="section-cr4zq" class="fullwidth-container ui--section clearfix section-cr4zq" style="margin-top: 30px;  margin-bottom: 0px;  padding-top: 40px;  padding-bottom: 22px;"><div class="container"><div class="ui--title ui--animation ui--title-bordered text-left"><div class="ui--title-holder"><h3 class="ui--title-text"> Meet <strong>Our Team</strong>  </h3><div class="ui--title-borders ui--title-border-left"></div><div class="ui--title-borders ui--title-border-right"></div></div></div><div  class="ui--animation-in make--fx--caption-right ui--pass clearfix" data-fx="fx--caption-right" data-delay="250" data-start-delay="0"><div class="portfolio-container-wrapper ui--pass" data-layout="carousel" data-columns="3"><div id="portfolio-n1eei" class="portfolio-container layout--carousel clearfix"><div class="ui--carousel clearfix" data-options="{&quot;effect&quot;:&quot;slide&quot;,&quot;auto_rotate&quot;:&quot;FALSE&quot;,&quot;animation_loop&quot;:&quot;FALSE&quot;,&quot;arrows&quot;:true,&quot;rotate_time&quot;:0,&quot;animate&quot;:true}"><div class="slides">



<div class="ui-row row">
<?php
$getInfoByTableName = getInfoByTableName("manage_team");
foreach($getInfoByTableName as $records)
{
?>
 <div   class="ui-column span4"><div class="ui--block ui--content-item ui--pass"><div  class="ui--content-box ui--box ui-row"><div class="ui--content-box-header"><div class="ui--content-box-media effect--fade type--default clearfix" style="padding-bottom: 56.25%;"><a class="ui--content-box-link" href="#"><div class="ui--content-box-image-default"><img  class="ui--content-box-image" src="admin/team_image/<?=$records['image'];?>" alt="" title=""/></div><div class="ui--content-box-overlay"><div class="ui--content-box-overlay-background"></div><div class="center"><span class="btn btn-grey ui--center-vertical"><span class="ui--content-box-overlay-button-text">Details</span></span></div></div></a></div><a class="ui--content-box-link" href="#"><div class="ui--content-box-title ui--gradient ui--gradient-grey on--hover clearfix text-center"><h5 class="ui--content-box-title-text"><?=$records['member_name'];?></h5></div></a><div class="ui--content-box-content"><div class="ui--content-box-content-text"><?=$records['team_desc'];?>
